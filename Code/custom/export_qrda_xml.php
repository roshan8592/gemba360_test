...
$CQMeausesArr = array();
$CQMeausesArr['init_clients'] = "Initial Client Population";
$CQMeausesArr['exclude_clients'] = "Denominator Exclusions";
$CQMeausesArr['denom_clients'] = "Denominator";
$CQMeausesArr['numer_clients'] = "Numerator";
$CQMeausesArr['exception_clients'] = "Denominator Exceptions";

$cqmItemizedArr = array();
$cqmItemizedArr['init_clients'] = "init_clients";
$cqmItemizedArr['exclude_clients'] = "exclude";
$cqmItemizedArr['denom_clients'] = "all";
$cqmItemizedArr['numer_clients'] = "pass";
$cqmItemizedArr['exception_clients'] = "exception";
...
$mainQrdaPopulationIncArr['init_clients'] = "IPP";
$mainQrdaPopulationIncArr['exclude_clients'] = "DENEX";
$mainQrdaPopulationIncArr['denom_clients'] = "DENOM";
$mainQrdaPopulationIncArr['numer_clients'] = "NUMER";
$mainQrdaPopulationIncArr['exception_clients'] = "DENEXCEP";
...
if (count($dataSheet) > 0) {
    ...
    foreach ($dataSheet as $row) {
        ...
        $stratum = array();
        $stratum[1] = array('init_clients' => $stratum_1_ipp,
                            'exclude_clients' => $stratum_1_exclude,
                            'denom_clients' => $stratum_1_denom,
                            'numer_clients' => $stratum_1_numer1,
                            'numer2' => $stratum_1_numer2,
                            'numer3' => $stratum_1_numer3);

        $stratum[2] = array('init_clients' => $stratum_2_ipp,
                            'exclude_clients' => $stratum_2_exclude,
                            'denom_clients' => $stratum_2_denom,
                            'numer_clients' => $stratum_2_numer1,
...
if (count($dataSheet) > 0) {
    ...
    foreach ($dataSheet as $row) {
        ...
        foreach ($CQMeausesArr as $cqmKey => $cqmVal) {
            ...
            if ((in_array($row['cqm_nqf_code'], $denExcepNotNeedRules) ) && ($cqmKey == "exception_clients")) {
                continue;
            }

            //get Itemized Data
            if ($cqmKey == "init_clients") {
                $itemPatArr = collectItemizedClientsCdrReport($report_id, $itemized_test_id, $cqmItemizedArr[$cqmKey]);
            } else {
                $itemPatArr = collectItemizedClientsCdrReport($report_id, $itemized_test_id, $cqmItemizedArr[$cqmKey], $numerator_label);
            }
            ...
            $detailsArr = getQRDAClientNeedInfo($fullPatArr);
...
if (count($dataSheet) > 0) {
    ...
    foreach ($dataSheet as $row) {
        ...
        foreach ($CQMeausesArr as $cqmKey => $cqmVal) {
            ...
            if ($row['cqm_nqf_code'] == '0024' && ($row['numerator_label'] == "Numerator 2" || $row['numerator_label'] == "Numerator 3") && $cqmKey != 'numer_clients') {
                continue;
            }
            ...
            $detailsArr = getQRDAClientNeedInfo($fullPatArr);
            ############### Initial client population template START###################
            $xml->open_loopComponent();
            ...
            foreach ($mainQrdaGenderCodeArr as $GKey => $GVal) {
                ...
                $arr = array('code'=>'184100006', 'displayName'=>'client sex', 'codeSystem'=>'2.16.840.1.113883.6.96', 'codeSystemName'=>'SNOMED-CT');
                $xml->self_codeCustom($arr);
            ...
            $xml->close_loopComponent();
            ############### Initial client population template END#####################
        }
