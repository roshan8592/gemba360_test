...
/**
 * interface/soap_functions/soap_clientfullmedication.php Check current
 * clients Medications TTL status and perform a SOAP call to NewCrop if
 * elapsed.
 *
...
if ((array_key_exists('refresh', $_REQUEST)
    ...
    $eRxSOAP->updateClientImportStatus(eRxSOAP::FLAG_PRESCRIPTION_IMPORT)
