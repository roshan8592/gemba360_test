<?php
/**
 * This report lists  client immunizations for a given date range.
 *
 * @package   OpenEMR
...
$query .=
  ...
  "from immunizations i, client_data p, codes c ".
...
if ($_POST['form_get_hl7']==='true') {
    ...
    while ($r = sqlFetchArray($res)) {
        ...
        "|" . // 1. Set id
        "|" . // 2. (B)Client id
        $r['clientid']. "^^^MPI&2.16.840.1.113883.19.3.2.1&ISO^MR" . "|". // 3. (R) Client indentifier list. TODO: Hard-coded the OID from NIST test.
        "|" . // 4. (B) Alternate PID
        $r['clientname']."|" . // 5.R. Name
