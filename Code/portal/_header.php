...
<script type="text/javascript">
    ...
    function restoreSession(){
        //dummy functions so the dlgopen function will work in the client portal
        return true;
    }
</script>
                    ...
                    <li class="dropdown user user-menu"><a href="#"
                        ...
                        <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                            ...
                            <?php if ($GLOBALS['allow_portal_chat']) { ?>
                                ...
                                <?php } ?>
                                <a type="client-signature" href="#openSignModal" data-toggle="modal" data-backdrop="true" data-target="#openSignModal"> <i class="fa fa-cog fa-fw pull-right"></i> <?php echo xlt('Settings'); ?></a></li>
        ...
        <aside class="left-side sidebar-offcanvas">
            ...
            <section class="sidebar">
                ...
                <ul class="nav  nav-pills nav-stacked" style='font-color:#fff;'><!-- css class was sidebar-menu -->
                    ...
                    <li><a href="<?php echo $GLOBALS['web_root']; ?>/portal/client/onsitedocuments?pid=<?php echo attr_url($pid); ?>"> <i class="fa fa-gavel"></i>
                            <span><?php echo xlt('Client Documents'); ?></span>
                    </a></li>
                    ...
                    <?php } ?>
                    <li data-toggle="pill"><a type="client-signature" href="#openSignModal" data-toggle="modal" > <i
