 ...
 *
 * @param int   $pid        the ID of the client
 * @param int   $encounter  the encounter ID
 * @param array $diags      a list of diagnoses
 * @param bool  $create     if set issue not already in the client problem list will be created
 */
 ...
 *
 * @param int   $req_pid             the ID of the client
...
/**
 * retrieve the diagnoses from the given client's problem list
 *
...
/**
 * retrieve the details of the specified client's encounters, except for the
