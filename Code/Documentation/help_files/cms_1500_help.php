    ...
    <body>
        <div class="container oe-help-container">
            ...
            <div class= "row">
                ...
                <p><?php echo xlt("It is the basic paper claim form prescribed by many payers for claims submitted by individual doctors & practices, nurses, and professionals, including therapists, chiropractors, and out-client clinics, and in some cases, for ambulance services");?>.

                <p><?php echo xlt("The 1500 Claim Form may also be used to report client encounter data to federal, state, and/or other public health agencies");?>.
                ...
                <p><?php echo xlt("The UB-04 (CMS 1450) is a claim form used by hospitals, nursing facilities, in-client, and other facility providers");?>.
                ...
                <p><?php echo xlt("Client and Insured Informatiom - Boxes 1 - 13 and Physician or Supplier Information - Boxes 14 - 33");?>.
            ...
            <div class= "row" id="select_option">
                ...
                <p><?php echo xlt("Box 10 - This information indicates whether the client’s illness or injury is related to employment, auto accident, or other accident");?>.
                ...
                <p><?php echo xlt("Box 15 - The Other Date identifies additional date information about the client’s condition or treatment. Enter the date in the first box and select a qualifier from the drop-down box");?>.

                <p><?php echo xlt("Box 16 - Dates Client Unable to Work in Current Occupation - is the time span the client is or was unable to work");?>.
                ...
                <p><?php echo xlt("Box 18 - The “Hospitalization Dates Related to Current Services” would refer to an inclient stay and indicates the admission and discharge dates associated with the service(s) on the claim");?>.
