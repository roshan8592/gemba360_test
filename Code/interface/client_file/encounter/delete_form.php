...
if ($_POST['confirm']) {
    ...
    $address = "{$GLOBALS['rootdir']}/client_file/encounter/$returnurl";
...
<form method="post" action="<?php echo $rootdir;?>/client_file/encounter/delete_form.php" name="my_form" id="my_form">
...
$(function (){
    ...
    $("#cancel").on("click", function() { location.href='<?php echo "$rootdir/client_file/encounter/$returnurl";?>'; });
});
