...
$ORDERHASH = array(
  ...
  'client' => 'lower(p.lname), lower(p.fname), fe.date',
...
$form_new_clients = $_POST['form_new_clients'] ? true : false;
...
$query = "SELECT " .
  ...
  "LEFT OUTER JOIN client_data AS p ON p.pid = fe.pid " .
  "LEFT JOIN users AS u ON u.id = fe.provider_id " .
  "$esign_joins" .
  "WHERE f.pid = fe.pid AND f.encounter = fe.encounter AND f.formdir = 'newclient' ";
if ($form_to_date) {
  ...
  <td width='550px'>
    ...
    <tr>
      ...
      <td>
        ...
        <div class="checkbox">
          <label><input type='checkbox' name='form_new_clients' title='<?php echo xla('First-time visits only'); ?>'<?php echo ($form_new_clients) ? ' checked' : ''; ?>>
...
<thead>
  ...
  <th>
   <a href="nojs.php" onclick="return dosort('client')"
