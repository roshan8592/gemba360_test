...
<html lang="en">
    <head>
        ...
        <link href="<?php echo $GLOBALS['web_root']; ?>/portal/client/styles/style.css?v=<?php echo $GLOBALS['v_js_includes']; ?>" rel="stylesheet" />
    ...
    <body class="skin-blue">
        <div class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                    <div class="navbar-header"><a class="navbar-brand" href="<?php echo $GLOBALS['web_root']; ?>/portal/client/provider"><?php echo xlt('Home'); ?></a>
