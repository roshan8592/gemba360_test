        ...
        <div class="container oe-help-container">
            ...
            <div class= "row" id="section3">
                <div class="col-sm-12">
                    ...
                    <p><?php echo ("Wait cliently as the script has to create the database, write the tables, create and authenticate the initial user");?>.
            ...
            <div class= "row" id="section7">
                <div class="col-sm-12">
                    ...
                    <p><?php echo ("It will ask you to secure three directories containing client information");?>.
            ...
            <div class= "row" id="section11">
                <div class="col-sm-12">
                    ...
                    <p><strong><?php echo ("Step 4");?></strong> - <?php echo ("The following directory contains client information should however be copied from the old version to the new version"); ?>:
                        <ul>
                ...
                <div class="col-sm-12">
                    ...
                    <p><?php echo ("A brief recap some pertinent facts about OpenEMR"); ?>:
                        ...
                        <ul>
                            ...
                            <li><?php echo ("For Apache/PHP to be able to read and write data to the directories containing client information in the webserver openemr document root directory, the webserver needs permission to read and write to those directories"); ?></li>
                    ...
                    <p><?php echo ("This directory will contain a directory that will hold unique site-specific client information, 'documents', as well as the site-specific files 'config.php' and 'sqlconf.php'"); ?>.

                    <p><?php echo ("In addition it will contain other directories - 'images' and 'LBF', and files - faxtitle.eps , referral_template.html, clickoptions.txt, faxcover.txt and statement.inc.php which will not contain client information but can be customized as per the site requirement"); ?>.
                    ...
                    <p><?php echo ("Its relevance will be apparent in the following scenario - A 'default' site is created and two additional sites are created using the 'default' as the source site. All three sites are functional. Say after two months you want to add another site, if you choose the 'default' or any of the other two sites as the source site you will in effect be copying the non-database client data from that instance located in the 'sites' directory to the sub-directory of the new instance"); ?>.
                    ...
                    <p><?php echo ("If you want to retain the ability to add more sites at a later time using the multisite module it is suggested to create the 'default' site and keep it without client data and always use it as the source site to allow you can to create multiple sites without compromising client data"); ?>.

                    <p><?php echo ("Great care needs to be exercised when using the multisite module to prevent inadvertent cross-site transfer of client data"); ?>.
