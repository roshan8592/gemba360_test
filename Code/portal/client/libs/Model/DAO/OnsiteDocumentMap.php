...
class OnsiteDocumentMap implements IDaoMap, IDaoMap2
{
    ...
    public static function GetFieldMaps()
    {
        if (self::$FM == null) {
            ...
            self::$FM["ClientSignedStatus"] = new FieldMap("ClientSignedStatus", "onsite_documents", "client_signed_status", false, FM_TYPE_SMALLINT, 5, null, false);
            self::$FM["ClientSignedTime"] = new FieldMap("ClientSignedTime", "onsite_documents", "client_signed_time", false, FM_TYPE_DATETIME, null, null, false);
            ...
            self::$FM["ClientSignature"] = new FieldMap("ClientSignature", "onsite_documents", "client_signature", false, FM_TYPE_TEXT, null, null, false);
