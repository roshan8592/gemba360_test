...
<script type="text/javascript" src="js/client_data_view_model.js?v=<?php echo $v_js_includes; ?>"></script>
...
var xl_strings_tabs_view_model = <?php echo json_encode(array(
    ...
    'must_select_client'  => $GLOBALS['enable_group_therapy'] ? xla('You must first select or add a client or therapy group.') : xla('You must first select or add a client.'),
...
<?php require_once("templates/client_data_template.php"); ?>
...
<script>
    ...
    $(function () {
        ...
        goRepeaterServices();
        $('#client_caret').click(function() {
           $('#attendantData').slideToggle();
            $('#client_caret').toggleClass('fa-caret-down').toggleClass('fa-caret-up');
        });
    });
</script>
<script>
