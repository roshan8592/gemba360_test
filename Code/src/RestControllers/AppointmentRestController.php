...
class AppointmentRestController
{
    ...
    {
        $serviceResult = $this->appointmentService->getAppointmentsForClient(null);
        return RestControllerHelper::responseHandler($serviceResult, null, 200);
    }

    public function getAllForClient($pid)
    {
        $serviceResult = $this->appointmentService->getAppointmentsForClient($pid);
        return RestControllerHelper::responseHandler($serviceResult, null, 200);
    }
