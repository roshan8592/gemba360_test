...
class ImmunizationTable extends AbstractTableGateway
{
    ...
    */
    ...
    /**
    * function immunized client details
    * @param type $form_data
    * @return type
    */
    public function immunizedClientDetails($form_data, $getCount = null)
    {
        $query_data = array();
        ...
        if ($form_get_hl7==='true') {
            $query .=
                ...
                "i.manufacturer AS manufacturer, ".
                                ...
                                "CONCAT(IF(p.lname IS NULL,'',p.lname), '^', p.fname , '^', IF(p.mname IS NULL,'',p.mname)) AS clientname, ".
                                "f.id,".
                                "f.name AS fac_name, ".
                "f.facility_code,".
            ...
            $query .= "CONCAT(IF(p.fname IS NULL,'',p.fname),' ',IF(p.mname IS NULL,'',p.mname),' ',IF(p.lname IS NULL,'',p.lname)) AS  clientname, ".
        ...
        $query .=
            ...
            "FROM (immunizations AS i, client_data AS p, codes AS c) ".
        ...
        $query_pids .
        "i.cvx_code = c.code ORDER BY i.client_id, i.id";
