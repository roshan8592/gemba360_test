...
<html>
    ...
    <body>
        <div class="container oe-help-container">
            ...
            <div class= "row">
                <div class="col-sm-12">
                    <p><?php echo xlt("A place to document and display the client's past medical history, family history, personal history");?>.
                    ...
                    <p><?php echo xlt("Family history - Documents the client's family history, an ICD10 diagnosis can be linked to the medical conditions");?>.

                    <p><?php echo xlt("Relatives - lists the client relatives having various medical conditions like Cancer, Diabetes, Hypertension etc");?>.

                    <p><?php echo xlt("Lifestyle - lists the client's use of Tobacco, Coffee, Alcohol, Recreational Drugs etc");?>.
