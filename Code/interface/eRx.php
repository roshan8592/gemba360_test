...
$eRxPage->setAuthUserId(array_key_exists_default('authUserID', $_SESSION))
    ...
    ->setClientId(array_key_exists_default('pid', $GLOBALS))
    ...
    if (count($messages['demographics']) > 0) {
        ...
        <script type="text/javascript">
            window.setTimeout(function() {
                window.location = "<?php echo $GLOBALS['webroot']; ?>/interface/client_file/summary/demographics_full.php";
