<?php
/**
 * library/ccr_import_ajax.php Functions related to client CCR/CCD/CCDA parsing.
 *
...
require_once(dirname(__FILE__) . "/../parse_client_xml.php");
...
if ($_REQUEST["ccr_ajax"] == "yes") {
  ...
  //level 2 key can be 'table name:#some value' for checking whether a particular tag exits in the XML section
    ...
    '//Medications/Medication' => array(
      ...
      'prescriptions:note' => 'ClientInstructions/Instruction/Text',
    ...
    '//Actors/Actor' => array(
      'client_data:fname' => 'Person/Name/CurrentName/Given',
      'client_data:lname' => 'Person/Name/CurrentName/Family',
      'client_data:DOB' => 'Person/DateOfBirth/ExactDateTime',
      'client_data:sex' => 'Person/Gender/Text',
      'client_data:abname' => 'InformationSystem/Name',
      'client_data:#Type' => 'InformationSystem/Type',
      'client_data:pubpid' => 'IDs/ID',
      'client_data:street' => 'Address/Line1',
      'client_data:city' => 'Address/City',
      'client_data:state' => 'Address/State',
      'client_data:postal_code' => 'Address/PostalCode',
      'client_data:phone_contact' => 'Telephone/Value',
    ),
    );
    if (!empty($content)) {
        $var = array();
        ...
        echo xlt('Successfully Imported the details. Please approve the client from the Pending Approval Screen').'.';
    } else {
