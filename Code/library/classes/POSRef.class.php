...
class POSRef
{
    ...
    {
        $pos = array();
        $pos[] = array ("code" => "01","title" => xl("Pharmacy") . " **", "description" => "A facility or location where drugs and other medically related items and services are sold, dispensed, or otherwise provided directly to clients.");
        ...
        $pos[] = array ("code" => "06","title" => xl("Indian Health Service Provider-based Facility"), "description" => "A facility or location, owned and operated by the Indian Health Service, which provides diagnostic, therapeutic (surgical and non-surgical), and rehabilitation services rendered by, or under the supervision of, physicians to American Indians and Alaska Natives admitted as inclients or outclients.");
        ...
        $pos[] = array ("code" => "12","title" => xl("Home"), "description" => "Location, other than a hospital or other facility, where the client receives care in a private residence.");
        ...
        $pos[] = array ("code" => "16","title" => xl("Temporary Lodging"), "description" => "A short term accommodation such as a hotel, camp ground, hostel, cruise ship or resort where the client receives care, and which is not identified by any other POS code.");
        ...
        $pos[] = array ("code" => "18","title" => xl("Place of Employment-Worksite"), "description" => "A location, not described by any other POS code, owned or operated by a public or private entity where the client is employed, and where a health professional provides on-going or episodic occupational medical, therapeutic or rehabilitative services to the individual");
        $pos[] = array ("code" => "19","title" => xl("Off Campus-Outclient Hospital"), "description" => "A portion of an off-campus hospital provider based department which provides diagnostic, therapeutic (both surgical and nonsurgical), and rehabilitation services to sick or injured persons who do not require hospitalization or institutionalization");
        $pos[] = array ("code" => "20","title" => xl("Urgent Care Facility"), "description" => "Location, distinct from a hospital emergency room, an office, or a clinic, whose purpose is to diagnose and treat illness or injury for unscheduled, ambulatory clients seeking immediate medical attention.");
        $pos[] = array ("code" => "21","title" => xl("Inclient Hospital"), "description" => "A facility, other than psychiatric, which primarily provides diagnostic, therapeutic (both surgical and nonsurgical), and rehabilitation services by, or under, the supervision of physicians to clients admitted for a variety of medical conditions.");
        $pos[] = array ("code" => "22","title" => xl("Outclient Hospital"), "description" => "A portion of a hospital which provides diagnostic, therapeutic (both surgical and nonsurgical), and rehabilitation services to sick or injured persons who do not require hospitalization or institutionalization.");
        ...
        $pos[] = array ("code" => "31","title" => xl("Skilled Nursing Facility"), "description" => "A facility which primarily provides inclient skilled nursing care and related services to clients who require medical, nursing, or rehabilitative services but does not provide the level of care or treatment available in a hospital.");
        ...
        $pos[] = array ("code" => "34","title" => xl("Hospice"), "description" => "A facility, other than a client's home, in which palliative and supportive care for terminally ill clients and their families are provided.");
        ...
        $pos[] = array ("code" => "49","title" => xl("Independent Clinic"), "description" => "A location, not part of a hospital and not described by any other Place of Service code, that is organized and operated to provide preventive, diagnostic, therapeutic, rehabilitative, or palliative services to outclients only.  (effective 10/1/03)");
        ...
        $pos[] = array ("code" => "51","title" => xl("Inclient Psychiatric Facility"), "description" => "A facility that provides inclient psychiatric services for the diagnosis and treatment of mental illness on a 24-hour basis, by or under the supervision of a physician.");
        $pos[] = array ("code" => "52","title" => xl("Psychiatric Facility-Partial Hospitalization"), "description" => "A facility for the diagnosis and treatment of mental illness that provides a planned therapeutic program for clients who do not require full time hospitalization, but who need broader programs than are possible from outclient visits to a hospital-based or hospital-affiliated facility.");
        $pos[] = array ("code" => "53","title" => xl("Community Mental Health Center"), "description" => "A facility that provides the following services: outclient services, including specialized outclient services for children, the elderly, individuals who are chronically ill, and residents of the CMHC's mental health services area who have been discharged from inclient treatment at a mental health facility; 24 hour a day emergency care services; day treatment, other partial hospitalization services, or psychosocial rehabilitation services; screening for clients being considered for admission to State mental health facilities to determine the appropriateness of such admission; and consultation and education services.");
        ...
        $pos[] = array ("code" => "61","title" => xl("Comprehensive Inclient Rehabilitation Facility"), "description" => "A facility that provides comprehensive rehabilitation services under the supervision of a physician to inclients with physical disabilities. Services include physical therapy, occupational therapy, speech pathology, social or psychological services, and orthotics and prosthetics services.");
        $pos[] = array ("code" => "62","title" => xl("Comprehensive Outclient Rehabilitation Facility"), "description" => "A facility that provides comprehensive rehabilitation services under the supervision of a physician to outclients with physical disabilities. Services include physical therapy, occupational therapy, and speech pathology services.");
        $pos[] = array ("code" => "63","title" => xl("Unassigned"), "description" => "N/A");
        $pos[] = array ("code" => "64","title" => xl("Unassigned"), "description" => "N/A");
        $pos[] = array ("code" => "65","title" => xl("End-Stage Renal Disease Treatment Facility"), "description" => "A facility other than a hospital, which provides dialysis treatment, maintenance, and/or training to clients or caregivers on an ambulatory or home-care basis.");
