...
#IfMissingColumn client_data billing_note
...
INSERT INTO `layout_options` (`form_id`, `field_id`, `group_name`, `title`, `seq`, `data_type`, `uor`, `fld_length`, `max_length`, `list_id`, `titlecols`, `datacols`, `default_value`, `edit_options`, `description`) VALUES ('DEM', 'billing_note', IFNULL(@group_name,@backup_group_name), 'Billing Note', @seq+1, 2, 1, 60, 0, '', 1, 3, '', '', 'Client Level Billing Note (Collections)' ) ;
ALTER TABLE client_data ADD COLUMN billing_note text NOT NULL default '';
UPDATE `client_data` SET `billing_note` = `genericval2` WHERE `genericname2` = 'Billing';
UPDATE `client_data` SET `genericval2` = '', `genericname2` = '' WHERE `genericname2` = 'Billing';
#EndIf
