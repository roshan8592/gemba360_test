 ...
 */
    $this->assign('title', xlt("Client Portal") . " | " . xlt("Onsite Portal Activities"));
    ...
    <script type="text/template" id="onsitePortalActivityCollectionTemplate">
        ...
        <thead>
            <tr>
                ...
                <th id="header_ClientId"><?php echo xlt('Client Id'); ?><% if (page.orderBy == 'ClientId') { %> <i class='icon-arrow-<%= page.orderDesc ? 'up' : 'down' %>' /><% } %></th>
    ...
    <script type="text/template" id="onsitePortalActivityModelTemplate">
        <form class="form-inline" onsubmit="return false;">
            <fieldset>
                ...
                <div class="form-group inline" id="clientIdInputContainer">
                    <label class="control-label" for="clientId"><?php echo xlt('Client Id'); ?></label>
                    <div class="controls inline-inputs">
                        <input type="text" class="form-control" id="clientId" placeholder="<?php echo xla('Client Id'); ?>" value="<%= _.escape(item.get('clientId') || '') %>">
                        <span class="help-inline"></span>
                    </div>
                </div>
