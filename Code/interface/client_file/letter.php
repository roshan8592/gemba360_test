...
if ($_POST['formaction']=="generate") {
    ...
    <div class='paddingdiv'>
        <?php echo $cpstring; ?>
        <div class="navigate">
    <a href='<?php echo $GLOBALS['rootdir'] . '/client_file/letter.php?template=autosaved&csrf_token_form=' . attr_url(CsrfUtils::collectCsrfToken()); ?>' onclick='top.restoreSession()'>(<?php echo xlt('Back'); ?>)</a>
    </div>
...
<?php echo $optto; ?>
 ...
 <tr>
  <td colspan='4'>
    ...
    <option value="<?php echo '{'.attr($FIELD_TAG['PT_FNAME']).'}'; ?>"><?php echo xlt('CLIENT'); ?> - <?php echo xlt('First name'); ?></option>
    <option value="<?php echo '{'.attr($FIELD_TAG['PT_MNAME']).'}'; ?>"><?php echo xlt('CLIENT'); ?> - <?php echo xlt('Middle name'); ?></option>
    <option value="<?php echo '{'.attr($FIELD_TAG['PT_LNAME']).'}'; ?>"><?php echo xlt('CLIENT'); ?> - <?php echo xlt('Last name'); ?></option>
    <option value="<?php echo '{'.attr($FIELD_TAG['PT_STREET']).'}'; ?>"><?php echo xlt('CLIENT'); ?> - <?php echo xlt('Street'); ?></option>
    <option value="<?php echo '{'.attr($FIELD_TAG['PT_CITY']).'}'; ?>"><?php echo xlt('CLIENT'); ?> - <?php echo xlt('City'); ?></option>
    <option value="<?php echo '{'.attr($FIELD_TAG['PT_STATE']).'}'; ?>"><?php echo xlt('CLIENT'); ?> - <?php echo xlt('State'); ?></option>
    <option value="<?php echo '{'.attr($FIELD_TAG['PT_POSTAL']).'}'; ?>"><?php echo xlt('CLIENT'); ?> - <?php echo xlt('Postal Code'); ?></option>
    <option value="<?php echo '{'.attr($FIELD_TAG['PT_PHONE_HOME']).'}'; ?>"><?php echo xlt('CLIENT'); ?> - <?php echo xlt('Phone Home'); ?></option>
    <option value="<?php echo '{'.attr($FIELD_TAG['PT_PHONE_CELL']).'}'; ?>"><?php echo xlt('CLIENT'); ?> - <?php echo xlt('Phone Cell'); ?></option>
    <option value="<?php echo '{'.attr($FIELD_TAG['PT_SSN']).'}'; ?>"><?php echo xlt('CLIENT'); ?> - <?php echo xlt('SSN'); ?></option>
    <option value="<?php echo '{'.attr($FIELD_TAG['PT_DOB']).'}'; ?>"><?php echo xlt('CLIENT'); ?> - <?php echo xlt('Date of birth'); ?></option>
    </select>
    </div>
