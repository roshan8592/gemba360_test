                ...
                <div class="col-sm-12">
                    ...
                    <p><?php echo xlt("The Procedure Order page lists the following procedure types"); ?>:
                        <ul>
                            ...
                            <li><?php echo xlt("Client Characteristics"); ?></li>
                    ...
                    <p><?php echo xlt("Integrating lab results into a client's chart in openEMR can be done manually i.e. both ordering tests and uploading the received results or electronically");?>.
                    ...
                    <p><?php echo xlt("A third alternative is to scan the results and save it as a document - TIFF, JPEG or PDF in the client's chart under documents");?>.

                    <p><?php echo xlt("The advantage of integrating the results with the client's chart as structured data is the ability to manipulate it to see trends in one convenient location, to plot graphs with the data and use it in data analysis");?>.

                    <p><?php echo xlt("The advantage of scanning the results into the chart is simplicity - no setup is required other than defining a directory/folder in the client's chart under Documents where the result will be stored. Being unstructured data it does not have the above advantages and will not fulfill Meaningful Use criteria for Computerized Provider Order Entry (CPOE)");?>.

                    <p><?php echo xlt("If you choose to integrate lab results with the client's record then some preliminary setup has to be performed");?>.
                    ...
                    <p><?php echo xlt("These three steps are essential before orders can be placed and received results linked to a client's chart");?>.
