...
class OnsiteDocumentController extends AppBaseController
{
    ...
    public function Query()
    {
        try {
            ...
            if ($filter) {
                $criteria->AddFilter(
                    new CriteriaFilter('Id,Pid,Facility,Provider,Encounter,CreateDate,DocType,ClientSignedStatus,ClientSignedTime,AuthorizeSignedTime,
						AcceptSignedStatus,AuthorizingSignator,ReviewDate,DenialReason,AuthorizedSignature,ClientSignature,FullDocument,FileName,FilePath', '%'.$filter.'%')
                );
            }
    ...
    public function Create()
    {
        try {
            ...
            $onsitedocument->ClientSignedStatus = $this->SafeGetVal($json, 'clientSignedStatus');
            $onsitedocument->ClientSignedTime = date('Y-m-d H:i:s', strtotime($this->SafeGetVal($json, 'clientSignedTime')));
            ...
            $onsitedocument->ClientSignature = $this->SafeGetVal($json, 'clientSignature');
    ...
    public function Update()
    {
        try {
            ...
            $onsitedocument->ClientSignedStatus = $this->SafeGetVal($json, 'clientSignedStatus', $onsitedocument->ClientSignedStatus);
            $onsitedocument->ClientSignedTime = date('Y-m-d H:i:s', strtotime($this->SafeGetVal($json, 'clientSignedTime', $onsitedocument->ClientSignedTime)));
            ...
            $onsitedocument->ClientSignature = $this->SafeGetVal($json, 'clientSignature', $onsitedocument->ClientSignature);
