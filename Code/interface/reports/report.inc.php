    ...
    echo '<table width="140" border="0" cellspacing="0" cellpadding="0">'.
      '<tr>'.
        ...
        'onfocus="hide_frame_to_hide();appendOptionTextCriteria('.attr_js($ThisPageSearchCriteriaDisplay[$ThisPageSearchCriteriaIndex]).','.
                                    ...
                                    'document.getElementById(\'type_code\').value,document.getElementById(\'div_insurance_or_client\').innerHTML,'.
                                    '\' = \','.
      ...
      '<tr>'.
        '<td><div  name="div_insurance_or_client" id="div_insurance_or_client" class="text"  style="border:1px solid black; padding-left:5px; width:50px; height:17px;">'.attr($_POST['hidden_type_code']).'</div><input type="hidden" name="description"  id="description" /></td>'.
