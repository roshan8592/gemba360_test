                        ...
                        <div class="row">
                            <div class="col-xs-12 ">
                                ...
                                <div id="dbname_info" class="collapse">
									...
									<p>This database will contain client data as well as data pertaining to the OpenEMR installation.
                                </div>
								</div>
                            </div>
                        </div>
...
STP5TOP;
                        ...
                        $step5_table = <<<STP5TAB
                            ...
                            <li>In order to take full advantage of the client documents capability you must make sure that settings in php.ini file include "file_uploads = On", that "upload_max_filesize" is appropriate for your use and that "upload_tmp_dir" is set to a correct value that will work on your system.
                            </li>
STP5TAB;
                        echo $step5_table . "\r\n";
...
STP5BOT;
                    ...
                    case 6:
                        ...
                        echo "The <strong>\"".preg_replace("/${site_id}/", "*", realpath($docsDirectory))."\"</strong> directory contain client information, and
