...
//It opens the corresponding pages.
    ...
    if(rawdata=='')
    ...
    else if(rawdata=='New Encounter')
     {
        if( parent.left_nav.active_gid == 0){
            // for client
            top.window.parent.left_nav.loadFrame2('nen1','RBot','forms/newclient/new.php?autoloaded=1&calenc=');
        } else {
            //for therapy group
     ...
     {
        top.window.parent.left_nav.loadFrame2('pel1','RBot','client_file/history/encounters.php')
        return true;
     }
    ...
    top.frames[frame].location.href  = '../client_file/encounter/encounter_top.php?set_encounter=' + encodeURIComponent(enc);
}
...
<tr><td style="vertical-align:text-bottom;">
        ...
        <span><?php echo xlt('NEW CLIENT'); ?></span></a>
    </td>
    <td style="vertical-align:text-bottom;">
            ...
            <span><?php echo xlt('CLEAR ACTIVE CLIENT'); ?></span></a>
    </td>
    <td style="vertical-align:text-bottom;">
...
<?php } //end of acl_check('clients','demo','',array('write','addonly') if ?>
...
<td style="margin:3px 0px 3px 0px;vertical-align:middle;">
        <div style='margin-left:10px; float:left; display:none' id="current_client_block">
            <span class='text'><?php echo xlt('Client'); ?>:&nbsp;</span><span class='title_bar_top' id="current_client"><b><?php echo xlt('None'); ?></b></span>
        </div>
</td>
