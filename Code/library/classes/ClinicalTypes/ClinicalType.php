...
require_once(dirname(__FILE__) . "/../rulesets/library/RsClient.php");
...
abstract class ClinicalType
{
    ...
    /*
     * Check if this clinical type applies to this client.
     *
     * @param (RsClient) $client
     * @param (date) $beginMeasurement
     * @param (date) $endMeasurement
     *
     * @return true if type applies, false ow
     */
    abstract public function doClientCheck(RsClient $client, $beginDate = null, $endDate = null, $options = null);
