 ...
 */
    ...
    $this->assign('title', xlt('Client Portal') . ' | ' . xlt('Onsite Activity Views'));
...
<script type="text/javascript">
    $LAB.script("<?php echo $GLOBALS['web_root']; ?>/portal/client/scripts/app/onsiteactivityviews.js?v=<?php echo $GLOBALS['v_js_includes']; ?>").wait(function(){
        $(function(){
            actpage.init();
        });
        setTimeout(function(){
...
<h3>
    <i class="icon-th-list"></i><?php echo xlt('Onsite Client Activities')?>
    ...
    <script type="text/template" id="onsiteActivityViewCollectionTemplate">
        ...
        <thead>
            <tr>
                ...
                <th id="header_ClientId"><?php echo xlt('Client Id')?><% if (actpage.orderBy == 'ClientId') { %> <i class='icon-arrow-<%= actpage.orderDesc ? 'up' : 'down' %>' /><% } %></th>
