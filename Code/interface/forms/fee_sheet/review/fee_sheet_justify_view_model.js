...
var source_order={current:1,client:2,common:3,search:4}
...
function setup_justify(model,current,client,common)
{
    model.added_keys={};
    ...
    for(idx=0;idx<client.length;idx++)
    {
        cur_entry=client[idx];
...
function fee_sheet_justify_view_model(billing_id,enc_id,pat_id,current_justify)
{
    ...
    $.post(justify_ajax,{
            ...
            mode: mode,
                ...
                setup_justify(vm,data.current,data.client,data.common);
