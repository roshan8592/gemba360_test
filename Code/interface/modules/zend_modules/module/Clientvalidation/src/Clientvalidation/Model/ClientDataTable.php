...
namespace Clientvalidation\Model;
...
class ClientDataTable
{
    ...
    public function getClients(array $parameters)
    {
        ...
        //$sql="SELECT * FROM client_data WHERE fname like ".$parameters['fname']." OR lname like ".$parameters['lname'] ." OR DOB like ".$parameters['DOB'];


        $obj    = new ApplicationTable;
        $sql    = " SELECT * FROM client_data WHERE fname like  ? OR lname like ? OR DOB like ?  OR pubpid = ?";
