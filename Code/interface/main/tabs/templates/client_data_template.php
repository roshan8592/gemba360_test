...
<?php
   ...
   $search_any_type = $GLOBALS['search_any_client'];
...
?>
<script type="text/html" id="client-data-template">
    <div>
        <span class="clientDataColumn">
            <div class="clientInfo float-element">
              <!-- ko if: client -->
                  <div data-bind="with: client" class="clientPicture">
                      <img data-bind="attr: {src: client_picture}"
                           class="img-thumbnail"
                           onError="this.src = '<?php echo $GLOBALS['images_static_relative']; ?>/client-picture-default.png'" />
                  </div>
              <!-- /ko -->
            </div>
            <div class="clientInfo">
                <?php echo xlt("Client"); ?>:
                <!-- ko if: client -->
                    <a class="ptName" data-bind="click:refreshClient,with: client" href="#">
                        <span data-bind="text: pname()"></span>
                        (<span data-bind="text: pubpid"></span>)
                    </a>
                <!-- /ko -->
                <!-- ko ifnot: client -->
                    <?php echo xlt("None{{Client}}");?>
                <!-- /ko -->
                <!-- ko if: client -->
                    <a class="btn btn-xs btn-link" href="#" data-bind="click:clearClient" title="<?php echo xla("Clear") ?>">
            ...
            <div class="clientInfo">
            <!-- ko if: client -->
                <span data-bind="text:client().str_dob()"></span>
                <!-- /ko -->
        ...
        <!-- ko with: client -->
            ...
            <div class="clientCurrentEncounter">
