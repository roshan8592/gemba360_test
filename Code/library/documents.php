 ...
 * @param  string         $client_id_or_simple_directory  Client id or simple directory for storage when client id not known (such as '00' or 'direct')
 ...
 */
function addNewDocument($name, $type, $tmp_name, $error, $size, $owner = '', $client_id_or_simple_directory = "00", $category_id = '1', $higher_level_path = '', $path_depth = '1')
{
    ...
    $_GET['client_id']=$client_id_or_simple_directory;
    $_POST['destination']='';
    $_POST['submit']='Upload';
    $_POST['path_depth']=$path_depth;
    $_POST['client_id']=(is_numeric($client_id_or_simple_directory) && $client_id_or_simple_directory>0) ? $client_id_or_simple_directory : "00";
...
/**
 * Function used in the documents request for client portal..
 *
