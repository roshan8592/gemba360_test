...
// kick out if client not authenticated
...
$auth_med      = true; //acl_check('clients'  , 'med');
$auth_demo     = true; //acl_check('clients'  , 'demo');
...
if ($printable) {
  ...
  *******************************************************************/
  ...
  /******************************************************************/
    ...
    echo '<page_header style="text-align:right;"> ' . xlt("CLIENT") . ':' . text($titleres['lname']) . ', ' . text($titleres['fname']) . ' - ' . text($titleres['DOB_TS']) . '</page_header>    ';
