<?php /* Smarty version 2.6.31, created on 2019-09-24 07:11:58
         compiled from C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_upload.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'xlt', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_upload.html', 16, false),array('function', 'xla', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_upload.html', 32, false),array('function', 'xl', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_upload.html', 39, false),array('modifier', 'text', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_upload.html', 28, false),array('modifier', 'attr', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_upload.html', 39, false),array('modifier', 'attr_url', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_upload.html', 51, false),)), $this); ?>

<form method=post enctype="multipart/form-data" action="<?php echo $this->_tpl_vars['FORM_ACTION']; ?>
" onsubmit="return top.restoreSession()">
<input type="hidden" name="MAX_FILE_SIZE" value="64000000" />

<?php if (( ! ( $this->_tpl_vars['client_id'] > 0 ) )): ?>
  <div class="text" style="color:red;">
    <?php echo smarty_function_xlt(array('t' => "IMPORTANT: This upload tool is only for uploading documents on clients that are not yet entered into the system. To upload files for clients whom already have been entered into the system, please use the upload tool linked within the Client Summary screen."), $this);?>
...
<div class="text">
    <?php echo smarty_function_xlt(array('t' => "NOTE: Uploading files with duplicate names will cause the files to be automatically renamed (for example, file.jpg will become file.1.jpg). Filenames are considered unique per client, not per category."), $this);?>
...
<input type="hidden" name="client_id" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['client_id'])) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
" />
...
/library/ajax/upload.php?client_id=<?php echo ((is_array($_tmp=$this->_tpl_vars['client_id'])) ? $this->_run_mod_handler('attr_url', true, $_tmp) : attr_url($_tmp)); ?>
...
<form method='post' action='interface/client_file/download_template.php' onsubmit='return top.restoreSession()'>
...
' />
<p class='text bold'>
 <?php echo smarty_function_xlt(array('t' => 'Download document template for this client and visit'), $this);?>
...
<br>
			<?php echo smarty_function_xlt(array('t' => 'Client'), $this);?>
