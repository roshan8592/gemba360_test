...
<script type="text/javascript" src="<?php echo $GLOBALS['web_root']; ?>/portal/client/scripts/app.js?v=<?php echo $GLOBALS['v_js_includes']; ?>"></script>
<script type="text/javascript" src="<?php echo $GLOBALS['web_root']; ?>/portal/client/scripts/model.js?v=<?php echo $GLOBALS['v_js_includes']; ?>"></script>
<script type="text/javascript" src="<?php echo $GLOBALS['web_root']; ?>/portal/client/scripts/view.js?v=<?php echo $GLOBALS['v_js_includes']; ?>"></script>
