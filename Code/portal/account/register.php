...
<html>
<head>
<title><?php echo xlt('New Client'); ?> | <?php echo xlt('Register'); ?></title>
    ...
    allNextBtn.click(function () {
        ...
        if (isValid) {
            if (curStepBtn == 'step-1') { // leaving step 1 setup profile frame. Prob not nec but in case
                ...
                profile.find('input[name=allowClientPortal]').val(['YES']);
...
function callServer(action, value, value2, last, first) {
    ...
    $.ajax({
        ...
        if (action == "cleanup") {
            ...
            let message = <?php echo xlj("Your new credentials have been sent. Check your email inbox and also possibly your spam folder. Once you log into your client portal feel free to make an appointment or send us a secure message. We look forward to seeing you soon."); ?>;
                    ...
                    <fieldset>
                        ...
                        <div class="well">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="../client/clientdata?pid=0&register=true" id="profileFrame" name="demo"></iframe>
                            </div>
                        </div>
            ...
            <div class="col-xs-6 col-md-offset-3 text-center">
                <div class="col-md-12">
                    <fieldset>
                        ...
                        <button class="btn btn-primary prevBtn btn-sm pull-left" type="button"><?php echo xlt('Previous') ?></button>
                        <hr>
                        <button class="btn btn-success btn-sm pull-right" type="button" id="submitClient"><?php echo xlt('Send Request') ?></button>
                    </fieldset>
                </div>
            </div>
        </div>
