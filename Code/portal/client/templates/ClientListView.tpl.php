 ...
 */
    ...
    $this->assign('title', xlt("Client Portal") . " | " . xlt("Client Data"));
    $this->assign('nav', 'clientdata');
    /*
...
<script type="text/javascript">
    ...
    $LAB.script("scripts/app/clientdata.js?v=<?php echo $GLOBALS['v_js_includes']; ?>").wait(function(){
        $(function(){
            page.init();
        });
...
<script type="text/template" id="clientCollectionTemplate"></script>
    <!-- Could add/manage table list here -->
<script type="text/template" id="clientModelTemplate"> <!-- -->
...
<?php echo xlt('Change any item available and when ready click Send for review. The changes will be flagged and staff notified to review changes before commiting them to chart. During the time period before changes are reviewed the Revised button will show Pending and profile data is still available for changes. When accessing profile in pending state all previous edits will appear in Blue and current chart values in Red. You may revert any edit to chart value by clicking that red item (or vica versa) but remember that when you click Send for Review then items that populate the field items are the ones that are sent. Revert Edits button changes everything back to chart values and you may make changes from there. So to recap: Items in BLUE are client edits with items in RED being original values before any edits.'); ?>
        ...
        <form class="form-inline" onsubmit="return false;">
            ...
            <!-- <div class="form-group inline" id="financialInputContainer">
                ...
                <div class="form-group inline" id="pubpidInputContainer">
                    <label class="control-label" for="pubpid"><?php echo xlt('Public Client Id')?></label>
                    <div class="controls inline-inputs">
           ...
           <div class="form-group inline" id="ethnicityInputContainer">
            ...
            <div class="form-group inline dynhide" id="familySizeInputContainer">
                ...
                <div class="form-group inline" id="allowClientPortalInputContainer">
                    <label class="control-label" for="allowClientPortal"><?php echo xlt('Allow Client Portal')?></label>
                    <div class="controls inline-inputs">
                            <label class="btn btn-default btn-gradient btn-sm"><input disabled id="allowClientPortal0" name="allowClientPortal" type="radio" value="NO"<% if (item.get('allowClientPortal')=="NO") { %> checked="checked"<% } %>><?php echo xlt('NO'); ?></label>
                            <label class="btn btn-default btn-gradient btn-sm"><input disabled id="allowClientPortal1" name="allowClientPortal" type="radio" value="YES"<% if (item.get('allowClientPortal')=="YES") { %> checked="checked"<% } %>><?php echo xlt('YES'); ?></label>
                            <label class="btn btn-default btn-gradient btn-sm"><input disabled id="allowClientPortal2" name="allowClientPortal" type="radio" value=""<% if (item.get('allowClientPortal')=="") { %> checked="checked"<% } %>><?php echo xlt('Unassigned'); ?></label>
                        <span class="help-inline"></span>
                    </div>
                </div>
    ...
    <div id="clientCollectionContainer" class="collectionContainer"></div><!--  -->
    <div id="clientModelContainer" class="modelContainer"></div>
</div> <!-- /container -->
<?php //$this->display('_Footer.tpl.php');?>
            ...
            <!--<div class="form-group inline" id="referrerInputContainer">
               ...
               <!-- <div class="form-group inline" id="allowClientPortalInputContainer">
                    <label class="control-label" for="allowClientPortal"><?php //echo xlt('Allow Client Portal')?></label>
                    <div class="controls inline-inputs">
                            <label class="btn btn-default btn-gradient btn-sm"><input id="allowClientPortal0" name="allowClientPortal" type="radio" value="NO"<% if (item.get('allowClientPortal')=="NO") { %> checked="checked"<% } %>><?php //echo xlt('NO'); ?></label>
                            <label class="btn btn-default btn-gradient btn-sm"><input id="allowClientPortal1" name="allowClientPortal" type="radio" value="YES"<% if (item.get('allowClientPortal')=="YES") { %> checked="checked"<% } %>><?php //echo xlt('YES'); ?></label>
                            <label class="btn btn-default btn-gradient btn-sm"><input id="allowClientPortal2" name="allowClientPortal" type="radio" value=""<% if (item.get('allowClientPortal')=="") { %> checked="checked"<% } %>><?php //echo xlt('Unassigned'); ?></label>
                        <span class="help-inline"></span>
                    </div>
                </div>
