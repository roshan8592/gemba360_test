...
/*=============================================================
 * Client Reports
 * seen in the client reports screens
 *============================================================*/
#client_reports {
  width: 100%;
}
#client_reports .issues {
  padding-right: 30px;
}
#client_reports .issues table {
  margin: 10px 0px 10px 0px;
}
#client_reports .issues td {
  padding: 2px;
}
#client_reports .encounters td {
  padding: 2px;
}
#client_reports .encounter_forms {
...
/*=============================================================
 * Report - Custom
 * seen as the client report (portal_custom_report.php)
 *============================================================*/
#report_custom {
  width: 100%;
}
...
<span class='panel-heading'><?php echo xlt('Client Report'); ?></span>&nbsp;&nbsp;
