...
function refreshClient(data,evt)
{
    loadCurrentClient();
}
...
{
    var url=webroot_url+'/interface/client_file/encounter/encounter_top.php?set_encounter=' + encId;
...
{
    var url=webroot_url+'/interface/client_file/encounter/forms.php?review_id=' + encId;
...
{
    var url=webroot_url+'/interface/forms/newclient/new.php?autoloaded=1&calenc='
    navigateTab(url, "enc", function () {
        activateTabByName("enc",true);
    });
...
{
    var url=webroot_url+'/interface/client_file/history/encounters.php'
    navigateTab(url, "enc", function () {
        activateTabByName("enc",true);
    });
}
...
{
    var url=webroot_url+'/interface/client_file/summary/demographics.php'
...
{
    var url=webroot_url+'/interface/client_file/encounter/encounter_top.php';
    navigateTab(url, "enc", function () {
        activateTabByName("enc",true);
    });
}
...
function menuActionClick(data,evt)
{
    ...
    if(data.enabled())
    {
        ...
        if (matches) {
          ...
          dataurl = '/interface/client_file/encounter/encounter_top.php?formname=' +
    ...
    else
    {
        ...
        {
            alert(xl_strings_tabs_view_model.must_select_client);
        }
