    ...
    foreach ($all4 as $iter) {
        ...
        if ($totals_only != 1) {
            if ($old_pid != $iter{'pid'} and ($iter{'code_type'} != 'payment_info')) {
               // $name has client information
                $name = getClientData($iter{"pid"});
               ...
               //
                ...
                if ($iter{'code_type'} === 'COPAY' || $iter{'code_type'} === 'Client Payment' || $iter{'code_type'} === 'Insurance Payment') {
            ...
            if ($iter{'code_type'} != 'payment_info') {
                if ($iter{'code_type'} === 'COPAY' || $iter{'code_type'} === 'Client Payment' || $iter{'code_type'} === 'Insurance Payment') {
                    ...
                    if (($iter{'code_type'}) != "Client Payment" and ($iter{'code_type'}) != 'Insurance Payment') {
                        print  "</span></td><td width=100><span class=text><center>" . text("(". $iter{"code"}.")"). "</center>";
                    }

                    if (($iter{'pat_adjust_dollar'}) != 0 and ($iter{'code_type'}) === 'Client Payment') {
                        print  "</span></td><td width=100><span class=text><center>" . text("(". $iter{'pat_adjust_dollar'}.")"). "</center>";
                    }

                    if (($iter{'pat_code'}) != 0 and ($iter{'code_type'}) === 'Client Payment') {
                    ...
                    if (($iter{'pat_adjust_dollar'}) != 0 and ($iter{'code_type'}) === 'Client Payment') {
                           print  "</span></td><td width=250><span class=text><center>" . xlt('Client Adjustment'). "</center>";
                    }
                    ...
                    if (($iter{'pat_code'}) > 0 and ($iter{'code_type'}) === 'Client Payment' and $iter{'paytype'} != 'PCP') {
                           print  "</span></td><td width=250><span class=text><center>" . xlt('Client Payment'). "</center>";
                    }
                    ...
                    if (($iter{'pat_code'}) < 0 and ($iter{'code_type'}) === 'Client Payment' and $iter{'paytype'} != 'PCP') {
                           print  "</span></td><td width=250><span class=text><center>" . xlt('Client Credit'). "</center>";
                    }
                    ...
                    if (($iter{'code_type'}) != 'Insurance Payment' and ($iter{'code_type'}) != 'Client Payment' and $iter{'paytype'} != 'PCP') {
...
for ($i=1; $i<$k;) {
    ...
    Printf("<td width=140><span class=text><b><center>". xlt("Client Adj").'. '."</center></b><center>"."%1\$.2f", text($user_info[patadj][$i])). "</center>";
    Printf("<td width=140><span class=text><b><center>". xlt("Client Payments"). ' ' ."</center></b><center>"."%1\$.2f", text($user_info[patpay][$i])). "</center>";
...
Printf("<td width=140><span class=text><b><center>". xlt("Client Adj").'. '."</center></b><center>"."%1\$.2f", text($gtotal_patadj)). "</center>";
Printf("<td width=140><span class=text><b><center>". xlt("Client Payments"). ' ' . "</center></b><center>"."%1\$.2f", text($gtotal_patpay)). "</center>";
