...
-- Grant ALL for each table individually
	...
	GRANT ALL ON openemr.client_access_offsite to 'openemr'@'localhost';
	GRANT ALL ON openemr.client_access_onsite to 'openemr'@'localhost';
	GRANT ALL ON openemr.client_data to 'openemr'@'localhost';
	GRANT ALL ON openemr.client_reminders to 'openemr'@'localhost';
	...
	GRANT ALL ON openemr.rule_client_data to 'openemr'@'localhost';
