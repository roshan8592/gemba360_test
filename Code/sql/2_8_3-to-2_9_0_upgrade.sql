...
#IfMissingColumn client_data usertext1
...
INSERT INTO list_options VALUES ('superbill','newpt','New Client'        ,1,0,0);
INSERT INTO list_options VALUES ('superbill','estpt','Established Client',2,0,0);
#EndIf

#IfMissingColumn client_data userlist3
ALTER TABLE client_data
...
INSERT INTO list_options VALUES ('refsource','Client'      ,'Client'      , 1,0,0);
...
ALTER TABLE client_data ADD `contrastart` date DEFAULT NULL COMMENT 'Date contraceptives initially used';
...
#IfMissingColumn client_data hipaa_allowsms
ALTER TABLE client_data
...
#IfMissingColumn client_data usertext3
ALTER TABLE client_data
