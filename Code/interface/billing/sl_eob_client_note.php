<?php
/**
 * This allows entry and editing of a "billing note" for the client.
 *
 * @package   OpenEMR
...
<title><?php echo xlt('EOB Posting - Client Note'); ?></title>
</head>
<body>
<?php
...
if ($_POST['form_save']) {
    ...
    "billing_note = ? " .
    "WHERE pid = ? ", array($thevalue, $client_id));
  ...
  $row = sqlQuery("select fname, lname, billing_note " .
    "from client_data where pid = ? limit 1", array($client_id));
    ?>
<div class="container">
    <div class = "row">
    ...
    <div class = "row">
        <form method='post' action='sl_eob_client_note.php?client_id=<?php echo attr_url($client_id); ?>'>
