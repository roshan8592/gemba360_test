...
$clientDetails = getClientData($pid, "fname,lname");
$clientName = $clientDetails['lname'] . ", " . $clientDetails['fname'];
...
<body class="body_top">
    <span class='title'><?php echo xlt("Amendments for") . " " . text($clientName); ?></span>
    <p></p>
