...
class Therapy_groups_participants
{
    ...
    public function updateParticipant(array $participant, $clientId, $groupId)
    {

        if (empty($participant['group_client_end'])) {
            $participant['group_client_end'] = null;
        }
        ...
        $data = array_merge($participant, array($clientId, $groupId));
...
//        $count = sqlFetchArray($result);
    ...
    public function saveParticipant($participantData)
    {
        ...
        $data[] = $participantData['group_client_status'];
        $data[] = $participantData['group_client_start'];
        $data[] = $participantData['group_client_end'];
        $data[] = $participantData['group_client_comment'];
