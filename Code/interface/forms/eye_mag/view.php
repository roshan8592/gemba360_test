  ...
  <div id="tabs_left" class="tabs ui-tabs ui-widget ui-widget-content ui-corner-all nodisplay">
    ...
    <div id="page-wrapper" data-role="page">
      ...
      <div id="Layer3" name="Layer3" class="container-fluid">
        ...
        //define if this is a new or est clients for coding auto-suggestions
                            ...
                            <div id="tabs_content_container" class="borderShadow">
                                ...
                                <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td class="pad10" colspan="2">
                                      <div class="kb kb_left">CC</div><b><span title="<?php echo xla('In the client\'s words'); ?>"><?php echo xlt('Chief Complaint'); ?> 1:
                                      </span>  </b>
                                      <br />
                                  ...
                                  <table class="CC_table" border="0" width="100%" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td class="top pad10" colspan="2">
                                        <b><span title="<?php echo xla('In the client\'s words'); ?>"><?php echo xlt('Chief Complaint'); ?> 2:
                                        </span>  </b>
                                        <br />
                              ...
                              <div id="tab3_CC_text" class="tab_content">
                                  <table class="CC_table" border="0" width="100%" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td class="top pad10" colspan="2">
                                        <b><span title="<?php echo xla('In the client\'s words'); ?>"><?php echo xlt('Chief Complaint'); ?> 3:
                                        </span>  </b>
                                        <br />
                  ...
                  <div class="top_right">
                          <span id="tabs">
                              <ul>
                                  ...
                                  <li id="LayerVision_W_lightswitch" class="<?php echo attr($button_W); ?>" value="Current" title="<?php echo xla("Display the client's current glasses"); ?>"><?php echo xlt('W{{Current Rx - wearing}}'); ?></li> |
                                  ...
                                  <li id="LayerVision_VAX_lightswitch" class="<?php echo attr($button_VAX); ?>" value="Visual Acuities" title="<?php echo xla("Summary of Acuities for this client"); ?>"><?php echo xlt('Va{{Visual Acuities}}'); ?></li>
                              </ul>
                          </span>
                  </div>
              ...
              <div class="sections" name="mid_menu" id="mid_menu">
                ...
                <span id="EXAM_DRAW" name="EXAM_DRAW" value="DRAW" class="btn btn-default">
                  ...
                  // $output = priors_select("ALL",$id,$id,$pid);
                    ($output_priors =='') ? ($title = "There are no prior visits documented to display for this client.") : ($title="Display old exam findings and copy forward if desired");?>
...
<br />
                ...
                <div class="size50 clear_both" id="IMPPLAN_1">
                  <div id="IMPPLAN_left" name="IMPPLAN_left" class="clear_both exam_section_left borderShadow">
                      ...
                      <a class="closeButton_5 fa fa-file-pdf-o" title="<?php echo xla('Once completed, view and store this encounter as a PDF file'); ?>" target="_report" href="<?php echo $GLOBALS['webroot']; ?>/interface/client_file/report/custom_report.php?printable=1&pdf=1&<?php echo $form_folder."_".$form_id."=".$encounter; ?>&"></a>
                                              ...
                                              <td style="padding-left:15px;vertical-align:text-top;text-left">
                                                  <div class="widget text-center">
                                                      ...
                                                      <button id="open_fee_sheet"
                                                              onclick="openNewForm('<?php echo $GLOBALS['webroot']; ?>/interface/client_file/encounter/load_form.php?formname=fee_sheet', 'Fee Sheet')" href="JavaScript:void(0);"
                                              ...
                                              <td class="bold">
                                                  <span id="pcp_fax">
                                                    ...
                                                    if ($pcp_data['fax'] > '') {
                                                        ...
                                                        $query    = "SELECT * FROM form_taskman WHERE TO_ID=? and CLIENT_ID=? and ENC_ID=?";
                                                        ...
                                                        if ($FAX_PCP['ID']) { //it is here already, make them print and manually fax it.  Show icon
                                                            echo text($pcp_data['fax'])."</span>&nbsp;&nbsp;
                                                                <span id='status_Fax_pcp'>
                                                                    <a href='".$webroot."/controller.php?document&view&client_id=".$pid."&doc_id=".$FAX_PCP['DOC_ID']."'
                                                        ...
                                                        if ($FAX_REF['ID']) { //it is here already, make them print and manually fax it.  Show icon
                                                            echo text($ref_data['fax'])."&nbsp;&nbsp;
                                                              <span id='status_Fax_ref'>
                                                                  <a href='".$webroot."/controller.php?document&view&client_id=".$pid."&doc_id=".$FAX_REF['DOC_ID']."'
    ...
    <script language="JavaScript">
        function openNewForm(sel, label) {
            ...
            if(FormNameValueArray[1] == 'newclient' )
            {
        ...
        function dopclick(id) {
            ...
            dlgopen('../../client_file/summary/a_issue.php?issue=0&thistype=' + encodeURIComponent(id), '_blank', 550, 400,  '', <?php echo xlj('Issues'); ?> );
            <?php else : ?>
            ...
            dlgopen('../../forms/eye_mag/SpectacleRx.php?dispensed=1&pid='+encodeURIComponent(pid), '_blank', 560, 590, '', <?php echo xlj('Rx History'); ?>);
                    ...
                    function sel_diagnosis(target,term) {
                        ...
                        if ($irow['type'] == 'PMH') { //or POH
                            ?>
            dlgopen('<?php echo $rootdir ?>/client_file/encounter/find_code_popup.php?codetype=<?php echo attr(collect_codetypes("medical_problem", "csv")) ?>&search_term='+encodeURI(term), '_blank', 600, 400,'', <?php echo xlj('Code Search'); ?>);
                            <?php
                        } else {
                            ?>
                        dlgopen('<?php echo $rootdir ?>/client_file/encounter/find_code_popup.php?codetype=<?php echo attr(collect_codetypes("diagnosis", "csv")) ?>&search_term='+encodeURI(term), '_blank', 600, 400, '', <?php echo xlj('Code Search'); ?>);
                            <?php
                        }
                        ?>
        }
    ...
    <div id="right-panel" name="right-panel" class="panel_side">
      ...
      <div id="right_panel_refresh" data-role="panel" name="right_panel_refresh">
        <?php
        // We are building the panel bar with the client medical info
