...
class OemrUI
{
    ...
    * int|bool 'include_client_name', int|bool 'expandable', array 'expandable_files', string 'action', string 'action_title',
    ...
    */
    public function __construct($arrOeUiSettings = array())
    {
        ...
        $this->heading = ($arrOeUiSettings['include_client_name'] && !empty($arrOeUiSettings['heading_title']))? $arrOeUiSettings['heading_title'] . " - " . getClientNameFirstLast($_SESSION['pid']):$arrOeUiSettings['heading_title'];
