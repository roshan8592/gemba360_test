...
<head>
    ...
    if ($_POST['form_yesno']) {
        ...
        sqlQuery("UPDATE client_data SET completed_ad = ?, ad_reviewed = ? where pid = ?", array($form_yesno,$form_adreviewed,$pid));
    ...
    $sql = "select completed_ad, ad_reviewed from client_data where pid = ?";
                ...
                if ($myrow2) {
                    ...
                    while ($myrows3 = sqlFetchArray($resNew1)) {
                        ...
                        while ($myrows4 = sqlFetchArray($resNew2)) {
                            ...
                            ?>
                            <br>
                            <a href='<?php echo $web_root; ?>/controller.php?document&retrieve&client_id=<?php echo attr_url($pid); ?>&document_id=<?php echo attr_url($idDoc); ?>&as_file=true'>
