<p>NOTICE OF PRIVACY PRACTICES CLIENT ACKNOWLEDGEMENT AND CONSENT TO MEDICAL TREATMENT
Client Name: <em>{ClientName}</em>
...
Relationship to client (if signed by a personal representative): {TextInput}
