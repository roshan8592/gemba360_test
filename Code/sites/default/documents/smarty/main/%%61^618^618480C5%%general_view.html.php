<?php /* Smarty version 2.6.31, created on 2019-09-24 07:16:58
         compiled from C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_view.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'js_url', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_view.html', 24, false),array('modifier', 'js_escape', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_view.html', 31, false),array('modifier', 'text', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_view.html', 137, false),array('modifier', 'attr', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_view.html', 145, false),array('modifier', 'attr_js', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_view.html', 146, false),array('modifier', 'attr_url', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_view.html', 233, false),array('function', 'xlj', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_view.html', 38, false),array('function', 'xlt', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_view.html', 139, false),array('function', 'xla', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_view.html', 143, false),array('function', 'user_info', 'C:/xampp/htdocs/openemr-5.0.2/templates/documents/general_view.html', 319, false),)), $this); ?>
...
<script language="JavaScript">
 ...
 function deleteme(docid) <?php echo '{'; ?>
  ...
  dlgopen('interface/client_file/deleter.php?document=' + encodeURIComponent(docid) + '&csrf_token_form=' + <?php echo ((is_array($_tmp=$this->_tpl_vars['csrf_token_form'])) ? $this->_run_mod_handler('js_url', true, $_tmp) : js_url($_tmp)); ?>
, '_blank', 500, 450);
  return false;
 <?php echo '}'; ?>
...
;
 ...
 // Called to show client notes related to this document in the "other" frame.
...
<?php echo ';
     let url = top.webroot_url + \'/interface/client_file/summary/pnotes.php?docid=\' + encodeURIComponent(docid);
 ...
 '; ?>
  ...
  parent.left_nav.loadFrame('pno1', othername, 'client_file/summary/pnotes.php?docid=' + encodeURIComponent(docid));
  return false;
 <?php echo '}'; ?>
...
" onsubmit="return top.restoreSession()">
                ...
                <div>
                        ...
                        <?php echo smarty_function_xlt(array('t' => 'Move to Client'), $this);?>
 # <input type="text" name="new_client_id" size="4" />
                        <a href="javascript:<?php echo '{}'; ?>
"
                         onclick="top.restoreSession();var URL='controller.php?client_finder&find&form_id=<?php echo ((is_array($_tmp="document_move['new_client_id']")) ? $this->_run_mod_handler('attr_url', true, $_tmp) : attr_url($_tmp)); ?>
&form_name=<?php echo ((is_array($_tmp="document_move['new_client_name']")) ? $this->_run_mod_handler('attr_url', true, $_tmp) : attr_url($_tmp)); ?>
...
/stock_search-16.png" border="0" /></a>
                        <input type="hidden" name="new_client_name" value="" />
                </div>
                </form>
            </div>
