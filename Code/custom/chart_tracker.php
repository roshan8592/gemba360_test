...
if ($form_newloc || $form_newuser) {
    ...
    $chartTrackerService->trackClientLocation($tracker);
    ...
    <div class="row">
        <div class="col-sm-6 well">
            <div class="form-group">
                <label for="form_pat_id" class='control-label col-sm-3'><?php echo xlt('Client ID') . ":"; ?></label>
                <div class='col-sm-9'>
...
?>
    <div class="row">
        <div class="col-sm-6 well">
            <div class="form-group">
                <label for='form_newid' class='control-label col-sm-3'><?php echo xlt('New Client ID') . ":"; ?></label>
                <div class='col-sm-9'>
                   <input type='text' name='form_newid' id='form_newid' class='form-control' title='<?php echo xla('Type or scan the client identifier here'); ?>'>
                </div>
            </div>
            <div class="form-group">
            <div class='col-sm-offset-3 col-sm-9'>
