...
//
    function __construct($component_separator, $repetition_separator)
    {
        ...
        '64'=>'Invalid/Missing client ID',
        '65'=>'Invalid/Missing client name',
        '66'=>'Invalid/Missing client gender code',
        '67'=>'Client not found',
        '69'=>'Inconsistent with client age.',
        '70'=>'Inconsistent with client gender.',
        '71'=>'Client birth date does not match that for the client in the database',
        ...
        'AO'=>'Additional client condition information required.',
        'CI'=>'Certification information does not match client.',
        ...
        "1W" => "Member ID Number",
        "1S" => "Ambulatory Client Group (APG) Number",
        ...
        '5X'=>'Ultrasound Unit',
        '5Y'=>'Rehabilitation Inclient Unit',
        '5Z'=>'Rehabilitation Outclient Services',
        '36'=>'Employer',
        '40'=>'Receiver',
        '41'=>'Submitter',
        ...
        "46" => "Respite Care",
        "47" => "Hospitalization",
        "48" => "Hospital - Inclient",
        "49" => "Hospital - Room and Board",
        "50" => "Hospital - Outclient",
        "54" => "Long Term Care",
        "55" => "Major Medical",
        ...
        "A4" => "Psychiatric",
        "A6" => "Psychotherapy",
        "A7" => "Psychiatric - Inclient",
        "A8" => "Psychiatric - Outclient",
        "A9" => "Rehabilitation",
        "AB" => "Rehabilitation - Inclient",
        "AC" => "Rehabilitation - Outclient",
        ...
        "CM" => "Mammogram, High Risk Client",
        "CN" => "Mammogram, Low Risk Client",
        "CO" => "Flu Vaccination",
        ...
        '21'=>'Inclient Hospital',
        '22'=>'Outclient Hospital',
        ...
        '51'=>'Inclient Psychiatric Facility',
        ...
        '61'=>'Comprehensive Inclient Rehabilitation Facility',
        '62'=>'Comprehensive Outclient Rehabilitation Facility',
        ...
        '27'=>'Client in Health Insurance Exchange premium payment grace period -- first month.',
        '28'=>'Client in Health Insurance Exchange premium payment grace period -- second month.',
        '29'=>'Client in Health Insurance Exchange premium payment grace period -- third month.',
        );
        ...
        '6'=>'Outclient Services to Another Institution',
        ...
        '20'=>'Admitted as an Inclient to this Hospital',
        '30'=>'Expired (or Did Not Recover-Christian Science Client)',
        ...
        '62'=>'Discharged/transferred to an inclient rehabilitation facility including distinct part units of a hospital',
        ...
        '81'=>'Discharged to home or self-care with a planned acute care hospital inclient readmission',
        '82'=>'Discharged/transferred to a short term general hospital for inclient care with a planned acute care hospital inclient readmission',
        '83'=>'Discharged/transferred to a skilled nursing facility (SNF) with Medicare certification with a planned acute care hospital inclient readmission',
        '84'=>'Discharged/transferred to a facility that provides custodial or supportive care with a planned acute care hospital inclient readmission',
        '85'=>'Discharged/transferred to a designated cancer center or children\'s hospital with a planned acute care hospital inclient readmission',
        '86'=>'Discharged/transferred to home under care of organized home health service organization with a planned acute care hospital inclient readmission',
        '87'=>'Discharged/transferred to court/law enforcement with a planned acute care hospital inclient readmission',
        '88'=>'Discharged/transferred to a federal health care facility with a planned acute care hospital inclient readmission',
        '89'=>'Discharged/transferred to a hospital-based Medicare approved swing bed with a planned acute care hospital inclient readmission',
        '90'=>'Discharged/transferred to an inclient rehabilitation facility (IRF) including rehabilitation distinct part units of a hospital with a planned acute care hospital inclient readmission',
        '91'=>'Discharged/transferred to a Medicare certified long term care hospital (LTCH) with a planned acute care hospital inclient readmission',
        '92'=>'Discharged/transferred to a nursing facility certified under Medicaid but not certified under Medicare with a planned acute care hospital inclient readmission',
        '93'=>'Discharged/transferred to a psychiatric distinct part unit of a hospital with a planned acute care hospital inclient readmission',
        '94'=>'Discharged/transferred to a critical access hospital (CAH) with a planned acute care hospital inclient readmission',
        '95'=>'Discharged/transferred to another type of health care institution not defined elsewhere in this code list with a planned acute care hospital inclient readmission'
        );
        ...
        'P4'=>'Pathology Report',
        'P5'=>'Client Medical History Document',
        ...
        '1'=>'Client was admitted to a hospital',
        '2'=>'Client was bed confined before the ambulance service',
        '3'=>'Client was bed confined after the ambulance service',
        '4'=>'Client was moved by stretcher',
        '5'=>'Client was unconscious or in shock',
        '6'=>'Client was transported in an emergency situation',
        '7'=>'Client had to be physically restrained',
        '8'=>'Client had visible hemorrhaging',
        '9'=>'Ambulance service was medically necessary',
        '10'=>'Client is ambulatory',
        '11'=>'Ambulation is Impaired and Walking Aid is Used for Therapy or Mobility',
        '12'=>'Client is confined to a bed or chair',
        '13'=>'Client is Confined to a Room or an Area Without Bathroom Facilities',
        '14'=>'Ambulation is Impaired and Walking Aid is Used for Mobility',
        '15'=>'Client Condition Requires Positioning of the Body or Attachments Which Would Not be Feasible With the Use of an Ordinary Bed',
        '16'=>'Client needs a trapeze bar to sit up due to respiratory condition or change body positions for other medical reasons',
        '17'=>'Client\'s Ability to Breathe is Severely Impaired',
        '18'=>'Client condition requires frequent and/or immediate changes in body positions',
        '19'=>'Client can operate controls',
        '20'=>'Siderails Are to be Attached to a Hospital Bed Owned by the Beneficiary',
        '21'=>'Client owns equipment',
        '22'=>'Mattress or Siderails are Being Used with Prescribed Medically Necessary Hospital Bed Owned by the Beneficiary',
        '23'=>'Client Needs Lift to Get In or Out of Bed or to Assist in Transfer from Bed to Wheelchair',
        '24'=>'Client has an orthopedic impairment requiring traction equipment which prevents ambulation during period of use',
        '25'=>'Item has been prescribed as part of a planned regimen of treatment in client home',
        '26'=>'Client is highly susceptible to decubitus ulcers',
        '27'=>'Client or a care-giver has been instructed in use of equipment',
        '29'=>'A 6-7 hour nocturnal study documents 30 episodes of apnea each lasting more than 10 seconds',
        '30'=>'Without the equipment, the client would require surgery',
        '31'=>'Client has had a total knee replacement',
        '32'=>'Client has intractable lymphedema of the extremities',
        '33'=>'Client is in a nursing home',
        '35'=>'This Feeding is the Only Form of Nutritional Intake for This Client',
        '37'=>'Oxygen delivery equipment is stationary',
        '38'=>'Certification signed by the physician is on file at the supplier\'s office',
        '40'=>'Client or Caregiver is Capable of Using the Equipment Without Technical or Professional Supervision',
        '41'=>'Client or Caregiver is Unable to Propel or Lift a Standard Weight Wheelchair',
        '42'=>'Client Requires Leg Elevation for Edema or Body Alignment',
        '43'=>'Client Weight or Usage Needs Necessitate a Heavy Duty Wheelchair',
        '44'=>'Client Requires Reclining Function of a Wheelchair',
        '45'=>'Client is Unable to Operate a Wheelchair Manually',
        '46'=>'Client or Caregiver Requires Side Transfer into Wheelchair, Commode or Other',
        ...
        '9D'=>'Lack of Appropriate Facility within Reasonable Distance to Treat Client in the Event of Complications',
        '9H'=>'Client Requires Intensive IV Therapy',
        '9J'=>'Client Requires Protective Isolation',
        '9K'=>'Client Requires Frequent Monitoring',
        ...
        'P4' => 'Pending/Client Requested Information - The claim or encounter is waiting for information that has already been requested from the client.',
        ...
        "86" => "Diagnosis and client gender mismatch.",
        ...
        "97" => "Client eligibility not found with entity.",
        ...
        "104" => "Processed according to plan provisions (Plan refers to provisions that exist between the Health Plan and the Consumer or Client)",
        ...
        "155" => "Entity's relationship to client.",
        "156" => "Client relationship to subscriber",
        "157" => "Entity's Gender.",
        ...
        "211" => "Date(s) of dialysis training provided to client.",
        ...
        "267" => "Number of miles client was transported.",
        ...
        "333" => "Client release of information authorization.",
        ...
        "387" => "Date client last examined by entity.",
        ...
        "414" => "Necessity for concurrent care (more than one physician treating the client)",
        ...
        "431" => "Client's condition/functional status at time of service.",
        "432" => "Date benefits exhausted",
        "433" => "Copy of client revocation of hospice benefits",
        ...
        "474" => "Procedure code and client gender mismatch",
        "475" => "Procedure code not valid for client age",
        ...
        "610" => "Client Discharge Facility Type Code",
        ...
        "634" => "Remark Code",
        "635" => "Repriced Ambulatory Client Group Code",
        ...
        "678" => "Revenue code and client gender mismatch",
        ...
        "707" => "Repriced Approved Ambulatory Client Group Amount",
        ...
        "713" => "Client Condition Description",
