...
class AMC_304b_2_STG2_Numerator implements AmcFilterIF
{
    ...
    public function test(AmcClient $client, $beginDate, $endDate)
    {
        ...
        $eprescribe = amcCollect('e_prescribe_amc', $client->id, 'prescriptions', $client->object['id']);
        $checkformulary = amcCollect('e_prescribe_chk_formulary_amc', $client->id, 'prescriptions', $client->object['id']);
