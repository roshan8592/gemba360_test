 ...
 *
 * TO_DO Some type of "find in files" search would be helpful for locating all references to a claim, client, etc.
 *    [ grep -nHIrF 'findtext']
 *
...
/**
 * Search the 'claims' csv table for the client control and find the associated file name
 *
 * Searchtype
 ...
 * @param string                     client control-- pid-encounter, encounter, or pid
...
{
    // evaluate the client account field
    //
