        ...
        if (new_validate !== 1) {
            ...
            **/
            function getErrorMessage(message){
                ...
                // console.log(message);
                switch (message){
                    case 'Client Name Required':
                        return <?php echo xlj('Client Name Required');?>;
                    ...
                    case 'Please choose a client':
                        return <?php echo xlj('Please choose a client');?>;
