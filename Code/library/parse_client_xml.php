<?php
/**
 * library/parse_client_xml.php Functions related to client CCR/CCD/CCDA parsing.
 *
 * Functions related to client CCR/CCD/CCDA parsing and insert/update to corresponding tables.
 *
...
function insert_client($audit_master_id)
{
    ...
    while ($row = sqlFetchArray($res)) {
        ...
        if ($table == 'client_data') {
            ...
            sqlStatement("INSERT INTO prescriptions(".
                "client_id,date_added,active,drug,size,form,quantity".
                ") VALUES (".
                "'".add_escape_custom($pid)."',".
            ...
            sqlStatement("INSERT INTO immunizations(".
                "client_id,administered_date,note".
                ") VALUES (".
                "'".add_escape_custom($pid)."',".
              ...
              //sqlQuery($query,array($_REQUEST['procedure_result-date'][$i],$active,$_REQUEST['procedure_result-abnormal'][$i]));
                ...
                if (substr($key, 0, 12) == 'client_data') {
                    if ($val == 'update') {
                        ...
                        array_push($client_data_values, $_REQUEST[$var_name]);
                    }
                }
            }
        }
