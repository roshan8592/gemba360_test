...
UPDATE `list_options` SET `notes`='{"form_client":{"presence": {"message": "Client Name Required"}}}' WHERE `list_id`='page_validation' AND `option_id`='add_edit_event#theform';
...
UPDATE `list_options` SET `notes`='{"participant_name":{"presence": true}, "group_client_start":{"presence": true}}' WHERE `list_id`='page_validation' AND `option_id`='tg_add#add-participant-form';
...
UPDATE `list_options` SET `notes`='{"form_datetime":{"futureDate":{"message": "Must be future date"}}, "reply_to":{"presence": {"message": "Please choose a client"}}}' WHERE `list_id`='page_validation' AND `option_id`='messages#new_note';
...
ALTER TABLE `amendments`
    MODIFY `pid` bigint(20) NOT NULL COMMENT 'Client ID from client_data';
#EndIf
...
#IfNotColumnType client_access_onsite pid bigint(20)
ALTER TABLE `client_access_onsite`
    MODIFY `pid` bigint(20);
#EndIf

#IfNotColumnType client_access_offsite pid bigint(20)
ALTER TABLE `client_access_offsite`
    MODIFY `pid` bigint(20) NOT NULL;
#EndIf
...
#IfNotColumnType batchcom client_id bigint(20)
ALTER TABLE `batchcom`
    MODIFY `client_id` bigint(20) NOT NULL default '0';
#EndIf

#IfNotColumnType claims client_id bigint(20)
ALTER TABLE `claims`
    MODIFY `client_id` bigint(20) NOT NULL;
#EndIf

#IfNotColumnType immunizations client_id bigint(20)
ALTER TABLE `immunizations`
    MODIFY `client_id` bigint(20) default NULL;
#EndIf

#IfNotColumnType prescriptions client_id bigint(20)
ALTER TABLE `prescriptions`
    MODIFY `client_id` bigint(20) default NULL;
#EndIf

#IfNotColumnType ar_session client_id bigint(20)
