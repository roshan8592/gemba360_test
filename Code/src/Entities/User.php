...
class User
{
    ...
    /**
     * @Column(name="client_menu_role", type="string")
     */
    private $clientMenuRole;
    ...
    public function getClientMenuRole()
    {
        return $this->clientMenuRole;
    }

    public function setClientMenuRole($value)
    {
        $this->clientMenuRole = $value;
    }
    ...
    public function __toString()
    {
        return "id: '" . $this->getId() . "' " .
               ...
               "clientMenuRole: '" . $this->getClientMenuRole() . "' " .
