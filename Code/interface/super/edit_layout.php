...
function writeFieldLine($linedata)
{
    ...
    echo "<input type='text' name='fld[" . attr($fld_line_no) . "][id]' value='" .
        attr($linedata['field_id']) . "' size='15'  " .
    ...
    echo "<input type='text' id='fld[" . attr($fld_line_no) . "][title]' name='fld[" . attr($fld_line_no) . "][title]' value='" .
        attr($linedata['title']) . "' size='15'  class='optin' style='width:100%' />";
    echo "</td>\n";
...
function extAddCondition(lino, btnelem) {
  ...
  newtrelem.innerHTML =
    ...
    "</td>" +
    "<td align='left'>" +
    "<input type='text' name='fld[" + lino + "][condition_value][" + i + "]' value='' size='15'  />" +
    "</td>" +
    "<td align='right'>" +
...
while ($row = sqlFetchArray($res)) {
    ...
    //Creating an array in order to hide sections like Misc, Guardian, Insurance
        //$hidden_sections = array("Misc", "Guardian", "Insurance");

        //if(in_array($grparr[$group_id]['grp_title'], $hidden_sections)){
          //  continue;
        //}else{
  ...
  <tbody>
    ...
    writeFieldLine($row);
    $prevgroup = $group_id;
   // }// end hidden_sections check loop
} // end while loop
...
<input type="text" size="20" maxlength="50" name="renamegroupname" id="renamegroupname" />
&nbsp;&nbsp;
<?php echo xlt('Parent'); ?>:
...
<span class='bold'>
<?php echo xlt('Group Name'); ?>:
<input type="text" size="20" maxlength="50" name="newgroupname" id="newgroupname" />
&nbsp;&nbsp;
<?php echo xlt('Parent'); ?>:
...
<td><input type="text" name="gnewtitle" id="gnewtitle" value="" size="20" > </td>
<td>
...
?>
   ...
   <td ><input type="text" name="newid" id="newid" value="" size="10" maxlength="20"
         onclick='FieldIDClicked(this)'> </td>
   <td><input type="text" name="newtitle" id="newtitle" value="" size="20" > </td>
   <td>
...
$(function(){
    ...
    ******************************************************************/
    ...
    var ShowLists = function(btnObj) {
        ...
        dlgopen('../client_file/encounter/find_code_dynamic.php?what=lists',"_blank", 850, 750, "", title);
    ...
    var ShowGroups = function(btnObj) {
        ...
        dlgopen('../client_file/encounter/find_code_dynamic.php?what=groups&layout_id=' + <?php echo js_url($layout_id); ?>,
...
function layoutLook(){
    ...
    var url = "../client_file/encounter/view_form.php?isShow&id=0&formname=" + encodeURIComponent(form);
...
<?php if (substr($layout_id, 0, 3) == 'LBF') { ?>
  ...
  dlgopen('../client_file/encounter/find_code_dynamic.php?what=fields&source='
