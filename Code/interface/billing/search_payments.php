                    ...
                    <fieldset>
                        ...
                        <div class="col-xs-12 oe-custom-line">
                            ...
                            <div class="forms col-xs-2">
                                ...
                                <div class="form-control" id="div_insurance_or_client"><?php echo attr($_POST['hidden_type_code']);?></div>
                    ...
                    <td class="left top"><?php echo xlt('ID'); ?></td>
                        ...
                        <td class="left top right" ><?php echo xlt('Undistributed'); ?></td>
                            ...
                            while ($RowSearch = sqlFetchArray($ResultSearch)) {
                                ...
                                if ($RowSearch['payer_id']*1 >0) {
                                   //-------------------
                                    ...
                                    $Payer=$row['name'];
                              //-------------------
                                } elseif ($RowSearch['client_id']*1 >0) {
                                   //-------------------
                                    $res = sqlStatement("SELECT fname,lname,mname FROM client_data
                                                    where pid =?", [$RowSearch['client_id']]);
                                    $row = sqlFetchArray($res);
                                    $fname=$row['fname'];
                                    $lname=$row['lname'];
                                    $mname=$row['mname'];
                            ...
                            <td class="<?php echo attr($StringClass); ?>">
                                ...
                                } elseif ($RowSearch['payment_type']=='client' || $RowSearch['client_id']*1 >0) {
                                    $PaymentType='client';
                                } elseif (($RowSearch['payer_id']*1 == 0 && $RowSearch['client_id']*1 == 0)) {
                                    $PaymentType='';
                                }
