    ...
    <body>
        <div class="container oe-help-container">
                ...
                <div id="aco_list" class='hideaway' style='display: none;'>
                    <ul>
                        ...
                        <li><strong><?php echo xlt('Administration (admin)');?></strong></li>
                            <ul>
                                <li><?php echo xlt('Superuser - can delete clients, encounters, issues (super)');?></li>
                        ...
                        <li><strong><?php echo xlt('Groups (groups)');?></strong> <i class="fa fa-exclamation-circle  oe-text-green" aria-hidden="true"></i>&nbsp;<strong><?php echo xlt("New in ACL Ver 5"); ?></strong></li>
                            <ul>
                                ...
                                <li><?php echo xlt('Group detailed log of appointment in client record (gdlog)');?> <i class="fa fa-exclamation-circle  oe-text-green" aria-hidden="true"></i>&nbsp;<strong><?php echo xlt("New in ACL Ver 5"); ?></strong></li>
                        ...
                        <li><strong><?php echo xlt('Client Portal (clientportal)');?></strong></li>
                            <ul>
                                <li><?php echo xlt('Client Portal (portal)');?></li>
                            </ul>
                        <li><strong><?php echo xlt('Clients (clients)');?></strong></li>
                            <ul>
                                ...
                                <li><?php echo xlt('Client Notes (write,addonly optional) (notes)');?></li>
                                <li><?php echo xlt('Client Reminders (write,addonly optional) (reminder)');?> <i class="fa fa-exclamation-circle oe-text-orange" aria-hidden="true"></i>&nbsp;<strong><?php echo xlt("New in ACL Ver 4"); ?></strong></li>
            ...
            <div class= "row" id="groups_section">
                ...
                <p><i class="fa fa-exclamation-circle oe-text-orange" aria-hidden="true"></i> <strong><?php echo xlt("This section DOES NOT let you create new ACOs."); ?></strong>
            ...
            <div class= "row" id="advanced_acl">
                ...
                <p><?php echo xlt("Click on the the following link to learn more about what is involved."); ?> <strong><a href="http://www.open-emr.org/wiki/index.php/ACL_Fine_Granular_Control" rel="noopener" target="_blank"><?php echo xlt("ACL Fine Granular Control"); ?></a></strong>
