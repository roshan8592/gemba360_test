<?php
/**
 * This report lists clients that were seen within a given date
 * range, or all clients if no date range is entered.
 *
 * @package   OpenEMR
...
<title><?php echo xlt('Client List'); ?></title>
...
<span class='title'><?php echo xlt('Report'); ?> - <?php echo xlt('Client List'); ?></span>
...
<form name='theform' id='theform' method='post' action='client_list.php' onsubmit='return top.restoreSession()'>
...
if ($_POST['form_refresh'] || $_POST['form_csvexport']) {
 ...
 <tbody>
   ...
   <tr class="report_totals">
    <td colspan='9'>
        <?php echo xlt('Total Number of Clients'); ?>
   :
