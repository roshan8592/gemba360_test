...
// For RTL languages we substitute the theme name with the name of RTL-adapted CSS file.
    ...
    if (isset($_SESSION['language_direction'])) {
        ...
        //this will support the onsite client portal which will have a language choice but not yet a set language direction
...
// Currently it is applicable only to the "Search or Add Client" form.
...
//This is crucial for therapy groups and clients mechanisms to work together properly
