...
<form name="re_identification" enctype="Re_identification_ip_single_code"
    action="re_identification_op_single_client.php" method="POST" onsubmit="return form_validate();">
        ...
        *  2 - The Re Identification process completed and xls file is ready to download
        ...
        type='text' size='50' name='re_id_code' id='re_id_code'
           ...
           <Input type="Submit" Name="Submit" Value=<?php echo xla("submit");?>></center>
            ...
            if ($no_of_items <= 1) {
                //start new search - no client record fount
         ...
         <tr valign="top">
             <td>&nbsp;</td>
             <td rowspan="3"><br>
                <?php echo xlt('No Client record found for the given Re Identification code');
                echo "</br></br>";
