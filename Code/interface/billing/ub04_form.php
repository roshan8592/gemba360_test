...
$(function() {
    ...
    $( function() {
        ...
        $( "[title*='STATUS']" ).autocomplete({
          ...
          source: function( request, response ) {
            var term = request.term;
            request.code_group = "client_status_code";
            if ( term in cache ) {
              response( cache[ term ] );
              return;
            }
...
<input type="text"   maxlength="20"  id="ub04id3" value=""  title="3a. CLIENT CONTROL NUMBER"  name="ub04Block_8"/>
...
<input type="text"   maxlength="19"  id="ub04id16" value="" title="8a. CLIENT IDENTIFIER"  name="ub04Block_15"/>
<input type="text"   maxlength="40"  id="ub04id17" value="" title="9a. CLIENT STREET ADDRESS"  name="ub04Block_17"/>
<input type="text"   maxlength="29"  id="ub04id18" value="" title="8b. CLIENT NAME"  name="ub04Block_16"/>
<input type="text"   maxlength="30"  id="ub04id19" value="" title="9b. CLIENT CITY"  name="ub04Block_18"/>
<input type="text"   maxlength="2"  id="ub04id20" value=""  title="9c. CLIENT STATE"  name="ub04Block_19"/>
<input type="text"   maxlength="9"  id="ub04id21" value=""  title="9d. CLIENT ZIP CODE"  name="ub04Block_20"/>
<input type="text"   maxlength="2"  id="ub04id22" value=""  title="9e. CLIENT COUNTRY CODE"  name="ub04Block_21"/>
<input type="text"   maxlength="8"  id="ub04id23" value=""  title="10. CLIENT BIRTH DATE (MMDDYYYY)"  name="ub04Block_22"/>
<input type="text"   maxlength="1"  id="ub04id24" value=""  title="11. CLIENT SEX"  name="ub04Block_23"/>
<input type="text" data-dp   maxlength="10"  id="ub04id25" value=""  title="12. CLIENT ADMISSION/START OF CARE DATE (MMDDYY)"  name="ub04Block_24"/>
<input type="text"   maxlength="2"  id="ub04id26" value=""  title="13. CLIENT ADMISSION HOUR"  name="ub04Block_25"/>
<input type="text"   maxlength="1"  id="ub04id27" value=""  title="14. CLIENT PRIORITY (TYPE) OF VISIT"  name="ub04Block_26"/>
<input type="text"   maxlength="1"  id="ub04id28" value=""  title="15. CLIENT POINT OF ORIGIN FOR ADMISSION OR VISIT"  name="ub04Block_27"/>
<input type="text"   maxlength="2"  id="ub04id29" value=""  title="16. CLIENT DISCHARGE HOUR"  name="ub04Block_28"/>
<input type="text"   maxlength="2"  id="ub04id30" value=""  title="17. CLIENT DISCHARGE STATUS"  name="ub04Block_29"/>
...
<input type="text"   maxlength="2"  id="ub04id305" value="" title="59a. CLIENT'S RELATIONSHIP TO INSURED - PRIMARY PLAN"  name="ub04Block_304"/>
...
<input type="text"   maxlength="2"  id="ub04id310" value="" title="59b. CLIENT'S RELATIONSHIP TO INSURED - SECONDARY PLAN"  name="ub04Block_309"/>
...
<input type="text"   maxlength="2"  id="ub04id315" value="" title="59c. CLIENT'S RELATIONSHIP TO INSURED - TERTIARY PLAN"  name="ub04Block_314"/>
...
<input type="text"   maxlength="7"  id="ub04id368" value="" title="70a. CLIENT'S REASON FOR VISIT"  name="ub04Block_367"/>
<input type="text"   maxlength="7"  id="ub04id369" value="" title="70b. CLIENT'S REASON FOR VISIT"  name="ub04Block_368"/>
<input type="text"   maxlength="7"  id="ub04id370" value="" title="70c. CLIENT'S REASON FOR VISIT"  name="ub04Block_369"/>
