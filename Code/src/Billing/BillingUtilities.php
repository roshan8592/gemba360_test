...
class BillingUtilities
{
    ...
    const claim_adjustment_reason_codes = array(
        ...
        '6' => 'The procedure/revenue code is inconsistent with the client\'s age. Usage: Refer to the 835 Healthcare Policy Identification Segment (loop 2110 Service Payment Information REF), if present.',
        '7' => 'The procedure/revenue code is inconsistent with the client\'s gender. Usage: Refer to the 835 Healthcare Policy Identification Segment (loop 2110 Service Payment Information REF), if present.',
        ...
        '9' => 'The diagnosis is inconsistent with the client\'s age. Usage: Refer to the 835 Healthcare Policy Identification Segment (loop 2110 Service Payment Information REF), if present.',
        '10' => 'The diagnosis is inconsistent with the client\'s gender. Usage: Refer to the 835 Healthcare Policy Identification Segment (loop 2110 Service Payment Information REF), if present.',
        ...
        '31' => 'Client cannot be identified as our insured.',
        '32' => 'Our records indicate the client is not an eligible dependent.',
        ...
        '60' => 'Charges for outclient services are not covered when performed within a period of time prior to or after inclient services.',
        ...
        '85' => 'Client Interest Adjustment (Use Only Group code PR)',
        ...
        '100' => 'Payment made to client/insured/responsible party.',
        ...
        '105' => 'Tax withholding.',
        '106' => 'Client payment option/election not in effect.',
        ...
        '112' => 'Service not furnished directly to the client and/or not documented.',
        '114' => 'Procedure/product not approved by the Food and Drug Administration.',
        '115' => 'Procedure postponed, canceled, or delayed.',
        '116' => 'The advance indemnification notice signed by the client did not comply with requirements.',
        ...
        '140' => 'Client/Insured health identification number and name do not match.',
        '142' => 'Monthly Medicaid client liability amount.',
        ...
        '155' => 'Client refused the service/procedure.',
        ...
        '177' => 'Client has not met the required eligibility requirements.',
        '178' => 'Client has not met the required spend down requirements.',
        '179' => 'Client has not met the required waiting requirements. Usage: Refer to the 835 Healthcare Policy Identification Segment (loop 2110 Service Payment Information REF), if present.',
        '180' => 'Client has not met the required residency requirements.',
        ...
        '201' => 'Client is responsible for amount of this claim/service through \'set aside arrangement\' or other agreement. (Use only with Group Code PR) At least one Remark Code must be provided (may be comprised of either the NCPDP Reject Reason Code, or Remittance Advice Remark Code that is not an ALERT.)',
        '202' => 'Non-covered personal comfort or convenience services.',
        '203' => 'Discontinued or reduced service.',
        '204' => 'This service/equipment/drug is not covered under the clients dental plan for further consideration.',
        ...
        '209' => 'Per regulatory or other agreement. The provider cannot collect this amount from the client. However, this amount may be billed to subsequent payer. Refund to client if collected. (Use only with Group code OA)',
        ...
        '222' => 'Exceeds the contracted maximum number of hours/days/units by this provider for this period. This is not client specific.',
        ...
        '224' => 'Client identification compromised by identity theft. Identity verification required for processing this and future claims.',
        ...
        '227' => 'Information requested from the client/insured/responsible party was not provided or was insufficient/incomplete. At least one Remark Code must be provided (may be comprised of either the NCPDP Reject Reason Code, or Remittance Advice Remark Code that is not an ALERT.)',
        ...
        '232' => 'Institutional Transfer Amount. Note - Applies to institutional claims only and explains the DRG amount difference when the client care crosses multiple institutions.',
        ...
        '240' => 'The diagnosis is inconsistent with the client\'s birth weight.',
        ...
        '254' => 'Claim received by the dental plan, but benefits not available under this plan. Submit these services to the client\'s medical plan for further consideration.',
        ...
        '258' => 'Claim/service not covered when client is in custody/incarcerated. Applicable federal, state or local authority may cover the claim/service.',
        '259' => 'Additional payment for Dental/Vision service utilization.',
        '260' => 'Processed under Medicaid ACA Enhanced Fee Schedule',
        '261' => 'The procedure or service is inconsistent with the client\'s history.',
        ...
        '270' => 'Claim received by the medical plan, but benefits not available under this plan. Submit these services to the client’s dental plan for further consideration.',
        ...
        '274' => 'Fee/Service not payable per client Care Coordination arrangement.',
        '275' => 'Prior payer\'s (or payers\') client responsibility (deductible, coinsurance, co-payment) not covered. (Use only with Group Code PR)',
        ...
        '280' => 'Claim received by the medical plan, but benefits not available under this plan. Submit these services to the client\'s Pharmacy plan for further consideration.',
        ...
        '290' => 'Claim received by the dental plan, but benefits not available under this plan. Claim has been forwarded to the client\'s medical plan for further consideration.',
        '291' => 'Claim received by the medical plan, but benefits not available under this plan. Claim has been forwarded to the client\'s dental plan for further consideration.',
        '292' => 'Claim received by the medical plan, but benefits not available under this plan. Claim has been forwarded to the client\'s pharmacy plan for further consideration.',
        ...
        'B9' => 'Client is enrolled in a Hospice.',
        ...
        'B12' => 'Services not documented in client\'s medical records.',
        ...
        'B16' => '\'New Client\' qualifications were not met.',
        ...
        'P3' => 'Workers\' Compensation case settled. Client is responsible for amount of this claim/service through WC \'Medicare set aside arrangement\' or other agreement. To be used for Workers\' Compensation only. (Use only with Group Code PR)',
        ...
        'P20' => 'Service not paid under jurisdiction allowed outclient facility fee schedule. To be used for Property and Casualty only.',
    ...
    const remittance_advice_remark_codes = array(
        ...
        'M2' => 'Not paid separately when the client is an inclient.',
        ...
        'M8' => 'We do not accept blood gas tests results when the test was conducted by a medical supplier or taken while the client is on oxygen.',
        'M9' => 'Alert: This is the tenth rental month. You must offer the client the choice of changing the rental to a purchase agreement.',
        'M10' => 'Equipment purchases are limited to the first or the tenth month of medical necessity.',
        'M11' => 'DME, orthotics and prosthetics must be billed to the DME carrier who services the client\'s zip code.',
        ...
        'M14' => 'No separate payment for an injection administered during an office visit, and no payment for a full office visit if the client only received an injection.',
        ...
        'M17' => 'Alert: Payment approved as you did not know, and could not reasonably have been expected to know, that this would not normally have been covered for this client. In the future, you will be liable for charges for the same service(s) under the same or similar conditions.',
        'M18' => 'Certain services may be approved for home use. Neither a hospital nor a Skilled Nursing Facility (SNF) is considered to be a client\'s home.',
        ...
        'M25' => 'The information furnished does not substantiate the need for this level of service. If you believe the service should have been fully covered as billed, or if you did not know and could not reasonably have been expected to know that we would not pay for this level of service, or if you notified the client in writing in advance that we would not pay for this level of service and he/she agreed in writing to pay, ask us to review your claim within 120 days of the date of this notice. If you do not request an appeal, we will, upon application from the client, reimburse him/her for the amount you have collected from him/her in excess of any deductible and coinsurance amounts. We will recover the reimbursement from you as an overpayment.',
        'M26' => 'The information furnished does not substantiate the need for this level of service. If you have collected any amount from the client for this level of service/any amount that exceeds the limiting charge for the less extensive service, the law requires you to refund that amount to the client within 30 days of receiving this notice. The requirements for refund are in 1824(I) of the Social Security Act and 42CFR411.408. The section specifies that physicians who knowingly and willfully fail to make appropriate refunds may be subject to civil monetary penalties and/or exclusion from the program. If you have any questions about this notice, please contact this office.',
        'M27' => 'Alert: The client has been relieved of liability of payment of these items and services under the limitation of liability provision of the law. The provider is ultimately liable for the client\'s waived charges, including any charges for coinsurance, since the items or services were not reasonable and necessary or constituted custodial care, and you knew or could reasonably have been expected to know, that they were not covered. You may appeal this determination. You may ask for an appeal regarding both the coverage determination and the issue of whether you exercised due care. The appeal request must be filed within 120 days of the date you receive this notice. You must make the request through this office.',
        ...
        'M32' => 'Alert: This is a conditional payment made pending a decision on this service by the client\'s primary payer. This payment may be subject to refund upon your receipt of any additional payment for this service from another payer. You must contact this office immediately upon receipt of an additional payment for this service.',
        'M36' => 'This is the 11th rental month. We cannot pay for this until you indicate that the client has been given the option of changing the rental to a purchase.',
        'M37' => 'Not covered when the client is under age 35.',
        'M38' => 'Alert: The client is liable for the charges for this service as they were informed in writing before the service was furnished that we would not pay for it and the client agreed to be responsible for the charges.',
        'M39' => 'Alert: The client is not liable for payment of this service as the advance notice of non-coverage you provided the client did not comply with program requirements.',
        'M40' => 'Claim must be assigned and must be filed by the practitioner\'s employer.',
        'M41' => 'We do not pay for this as the client has no legal obligation to pay for this.',
        ...
        'M80' => 'Not covered when performed during the same session/date as a previously processed service for the client.',
        'M81' => 'You are required to code to the highest level of specificity.',
        'M82' => 'Service is not covered when client is under age 50.',
        'M83' => 'Service is not covered unless the client is classified as at high risk.',
        ...
        'M96' => 'The technical component of a service furnished to an inclient may only be billed by that inclient facility. You must contact the inclient facility for technical component reimbursement. If not already billed, you should bill us for the professional component only.',
        'M97' => 'Not paid to practitioner when provided to client in this place of service. Payment included in the reimbursement issued the facility.',
        ...
        'M103' => 'Information supplied supports a break in therapy. However, the medical information we have for this client does not support the need for this item as billed. We have approved payment for this item at a reduced level, and a new capped rental period will begin with the delivery of this equipment.',
        ...
        'M105' => 'Information supplied does not support a break in therapy. The medical information we have for this client does not support the need for this item as billed. We have approved payment for this item at a reduced level, and a new capped rental period will not begin.',
        'M107' => 'Payment reduced as 90-day rolling average hematocrit for ESRD client exceeded 36.5%.',
        ...
        'M111' => 'We do not pay for chiropractic manipulative treatment when the client refuses to have an x-ray taken.',
        'M112' => 'Reimbursement for this item is based on the single payment amount required under the DMEPOS Competitive Bidding Program for the area where the client resides.',
        'M113' => 'Our records indicate that this client began using this item/service prior to the current contract period for the DMEPOS Competitive Bidding Program.',
        ...
        'M115' => 'This item is denied when provided to this client by a non-contract or non-demonstration supplier.',
        ...
        'M124' => 'Missing indication of whether the client owns the equipment that requires the part or supply.',
        ...
        'M127' => 'Missing client medical record for this service.',
        ...
        'M138' => 'Client identified as a demonstration participant but the client was not enrolled in the demonstration at the time services were rendered. Coverage is limited to demonstration participants.',
        ...
        'MA10' => 'Alert: The client\'s payment was in excess of the amount owed. You must refund the overpayment to the client.',
        ...
        'MA13' => 'Alert: You may be subject to penalties if you bill the client for amounts not reported with the PR (client responsibility) group code.',
        'MA14' => 'Alert: The client is a member of an employer-sponsored prepaid health plan. Services from outside that health plan are not covered. However, as you were not previously notified of this, we are paying this time. In the future, we will not pay you for non-plan services.',
        ...
        'MA16' => 'The client is covered by the Black Lung Program. Send this claim to the Department of Labor, Federal Black Lung Program, P.O. Box 828, Lanham-Seabrook MD 20703.',
        'MA17' => 'We are the primary payer and have paid at the primary rate. You must contact the client\'s other insurer to refund any excess it may have paid due to its erroneous primary payment.',
        'MA18' => 'Alert: The claim information is also being forwarded to the client\'s supplemental insurer. Send any questions regarding supplemental benefits to them.',
        ...
        'MA25' => 'A client may not elect to change a hospice provider more than once in a benefit period.',
        ...
        'MA36' => 'Missing/incomplete/invalid client name.',
        'MA37' => 'Missing/incomplete/invalid client\'s address.',
        ...
        'MA43' => 'Missing/incomplete/invalid client status.',
        ...
        'MA47' => 'Our records show you have opted out of Medicare, agreeing with the client not to bill Medicare for services/tests/supplies furnished. As result, we cannot pay this claim. The client is responsible for payment.',
        ...
        'MA55' => 'Not covered as client received medical health care services, automatically revoking his/her election to receive religious non-medical health care services.',
        'MA56' => 'Our records show you have opted out of Medicare, agreeing with the client not to bill Medicare for services/tests/supplies furnished. As result, we cannot pay this claim. The client is responsible for payment, but under Federal law, you cannot charge the client more than the limiting charge amount.',
        'MA57' => 'Client submitted written request to revoke his/her election for religious non-medical health care services.',
        'MA58' => 'Missing/incomplete/invalid release of information indicator.',
        'MA59' => 'Alert: The client overpaid you for these services. You must issue the client a refund within 30 days for the difference between his/her payment and the total amount shown as client responsibility on this notice.',
        'MA60' => 'Missing/incomplete/invalid client relationship to insured.',
        ...
        'MA72' => 'Alert: The client overpaid you for these assigned services. You must issue the client a refund within 30 days for the difference between his/her payment to you and the total of the amount shown as client responsibility and as paid to the client on this notice.',
        'MA73' => 'Informational remittance associated with a Medicare demonstration. No payment issued under fee-for-service Medicare as client has elected managed care.',
        'MA74' => 'Alert: This payment replaces an earlier payment for this claim that was either lost, damaged or returned.',
        'MA75' => 'Missing/incomplete/invalid client or authorized representative signature.',
        ...
        'MA77' => 'Alert: The client overpaid you. You must issue the client a refund within 30 days for the difference between the client’s payment less the total of our and other payer payments and the amount shown as client responsibility on this notice.',
        ...
        'MA84' => 'Client identified as participating in the National Emphysema Treatment Trial but our records indicate that this client is either not a participant, or has not yet been approved for this phase of the study. Contact Johns Hopkins University, the study coordinator, to resolve if there was a discrepancy.',
        'MA88' => 'Missing/incomplete/invalid insured\'s address and/or telephone number for the primary payer.',
        'MA89' => 'Missing/incomplete/invalid client\'s relationship to the insured for the primary payer.',
        ...
        'MA96' => 'Claim rejected. Coded as a Medicare Managed Care Demonstration but client is not enrolled in a Medicare managed care plan.',
        ...
        'MA113' => 'Incomplete/invalid taxpayer identification number (TIN) submitted by you per the Internal Revenue Service. Your claims cannot be processed without your correct TIN, and you may not bill the client pending correction of your TIN. There are no appeal rights for unprocessable claims, but you may resubmit this claim after you have notified this office of your correct TIN.',
        ...
        'MA133' => 'Claim overlaps inclient stay. Rebill only those services rendered outside the inclient stay.',
        'MA134' => 'Missing/incomplete/invalid provider number of the facility where the client resides.',
        ...
        'N6' => 'Under FEHB law (U.S.C. 8904(b)), we cannot pay more for covered care than the amount Medicare would have allowed if the client were enrolled in Medicare Part A and/or Medicare Part B.',
        ...
        'N23' => 'Alert: Client liability may be affected due to coordination of benefits with other carriers and/or maximum benefit provisions.',
        ...
        'N47' => 'Claim conflicts with another inclient stay.',
        ...
        'N52' => 'Client not enrolled in the billing provider\'s managed care plan on the date of service.',
        ...
        'N58' => 'Missing/incomplete/invalid client liability amount.',
        ...
        'N79' => 'Service billed is not compatible with client location information.',
        ...
        'N88' => 'Alert: This payment is being made conditionally. An HHA episode of care notice has been filed for this client. When a client is treated under a HHA episode of care, consolidated billing requires that certain therapy services and supplies, such as this, be included in the HHA\'s payment. This payment will need to be recouped from you if we establish that the client is concurrently receiving treatment under a HHA episode of care.',
        ...
        'N96' => 'Client must be refractory to conventional therapy (documented behavioral, pharmacologic and/or surgical corrective therapy) and be an appropriate surgical candidate such that implantation with anesthesia can occur.',
        'N97' => 'Clients with stress incontinence, urinary obstruction, and specific neurologic diseases (e.g., diabetes with peripheral nerve involvement) which are associated with secondary manifestations of the above three indications are excluded.',
        'N98' => 'Client must have had a successful test stimulation in order to support subsequent implantation. Before a client is eligible for permanent implantation, he/she must demonstrate a 50 percent or greater improvement through test stimulation. Improvement is measured through voiding diaries.',
        'N99' => 'Client must be able to demonstrate adequate ability to record voiding diary data such that clinical results of the implant procedure can be properly evaluated.',
        'N103' => 'Records indicate this client was a prisoner or in custody of a Federal, State, or local authority when the service was rendered. This payer does not cover items and services furnished to an individual while he or she is in custody under a penal statute or rule, unless under State or local law, the individual is personally liable for the cost of his or her health care while in custody and the State or local government pursues the collection of such debt in the same way and with the same vigor as the collection of its other debts. The provider can collect from the Federal/State/ Local Authority as appropriate.',
        ...
        'N106' => 'Payment for services furnished to Skilled Nursing Facility (SNF) inclients (except for excluded services) can only be made to the SNF. You must request payment from the SNF rather than the client for this service.',
        'N107' => 'Services furnished to Skilled Nursing Facility (SNF) inclients must be billed on the inclient claim. They cannot be billed separately as outclient services.',
        ...
        'N116' => 'Alert: This payment is being made conditionally because the service was provided in the home, and it is possible that the client is under a home health episode of care. When a client is treated under a home health episode of care, consolidated billing requires that certain therapy services and supplies, such as this, be included in the home health agency’s (HHA’s) payment. This payment will need to be recouped from you if we establish that the client is concurrently receiving treatment under an HHA episode of care.',
        'N117' => 'This service is paid only once in a client’s lifetime.',
        'N118' => 'This service is not paid if billed more than once every 28 days.',
        'N119' => 'This service is not paid if billed once every 28 days, and the client has spent 5 or more consecutive days in any inclient or Skilled /nursing Facility (SNF) within those 28 days.',
        'N120' => 'Payment is subject to home health prospective payment system partial episode payment adjustment. Client was transferred/discharged/readmitted during payment episode.',
        ...
        'N129' => 'Not eligible due to the client\'s age.',
        ...
        'N135' => 'Record fees are the client\'s responsibility and limited to the specified co-payment.',
        ...
        'N141' => 'The client was not residing in a long-term care facility during all or part of the service dates billed.',
        'N142' => 'The original claim was denied. Resubmit a new claim, not a replacement claim.',
        'N143' => 'The client was not in a hospice program during all or part of the service dates billed.',
        'N144' => 'The rate changed during the dates of service billed.',
        'N146' => 'Missing screening document.',
        'N147' => 'Long term care case mix or per diem rate cannot be determined because the client ID number is missing, incomplete, or invalid on the assignment request.',
        ...
        'N156' => 'Alert: The client is responsible for the difference between the approved treatment and the elective treatment.',
        ...
        'N159' => 'Payment denied/reduced because mileage is not covered when the client is not in the ambulance.',
        'N160' => 'The client must choose an option before a payment can be made for this procedure/ equipment/ supply/ service.',
        ...
        'N172' => 'The client is not liable for the denied/adjusted charge(s) for receiving any updated service/item.',
        'N173' => 'No qualifying hospital stay dates were provided for this episode of care.',
        'N174' => 'This is not a covered service/procedure/ equipment/bed, however client liability is limited to amounts shown in the adjustments under group \'PR\'.',
        ...
        'N177' => 'Alert: We did not send this claim to client’s other insurer. They have indicated no additional payment can be made.',
        ...
        'N192' => 'Client is a Medicaid/Qualified Medicare Beneficiary.',
        ...
        'N196' => 'Alert: Client eligible to apply for other coverage which may be primary.',
        ...
        'N216' => 'We do not offer coverage for this type of service or the client is not enrolled in this portion of our benefit package.',
        'N217' => 'We pay only one site of service per provider per claim.',
        'N218' => 'You must furnish and service this item for as long as the client continues to need it. We can pay for maintenance and/or servicing for the time period specified in the contract or coverage manual.',
        ...
        'N223' => 'Missing documentation of benefit to the client during initial treatment period.',
        'N224' => 'Incomplete/invalid documentation of benefit to the client during initial treatment period.',
        ...
        'N230' => 'Incomplete/invalid indication of whether the client owns the equipment that requires the part or supply.',
        ...
        'N237' => 'Incomplete/invalid client medical record for this service.',
        ...
        'N246' => 'State regulated client payment limitations apply to this service.',
        ...
        'N329' => 'Missing/incomplete/invalid client birth date.',
        'N330' => 'Missing/incomplete/invalid client death date.',
        ...
        'N352' => 'Alert: There are no scheduled payments for this service. Submit a claim for each client visit.',
        ...
        'N355' => 'Alert: The law permits exceptions to the refund requirement in two cases: - If you did not know, and could not have reasonably been expected to know, that we would not pay for this service; or - If you notified the client in writing before providing the service that you believed that we were likely to deny the service, and the client signed a statement agreeing to pay for the service. If you come within either exception, or if you believe the carrier was wrong in its determination that we do not pay for this service, you should request appeal of this determination within 30 days of the date of this notice. Your request for review should include any additional information necessary to support your position. If you request an appeal within 30 days of receiving this notice, you may delay refunding the amount to the client until you receive the results of the review. If the review decision is favorable to you, you do not need to make any refund. If, however, the review is unfavorable, the law specifies that you must make the refund within 15 days of receiving the unfavorable review decision. The law also permits you to request an appeal at any time within 120 days of the date you receive this notice. However, an appeal request that is received more than 30 days after the date of this notice, does not permit you to delay making the refund. Regardless of when a review is requested, the client will be notified that you have requested one, and will receive a copy of the determination. The client has received a separate notice of this denial decision. The notice advises that he/she may be entitled to a refund of any amounts paid, if you should have known that we would not pay and did not tell him/her. It also instructs the client to contact our office if he/she does not hear anything about a refund within 30 days',
        ...
        'N371' => 'Alert: title of this equipment must be transferred to the client.',
        ...
        'N376' => 'Subscriber/client is assigned to active military duty, therefore primary coverage may be TRICARE.',
        ...
        'N382' => 'Missing/incomplete/invalid client identifier.',
        ...
        'N387' => 'Alert: Submit this claim to the client\'s other insurer for potential payment of supplemental benefits. We did not forward the claim information.',
        ...
        'N424' => 'Client does not reside in the geographic area required for this type of payment.',
        ...
        'N528' => 'Client is entitled to benefits for Institutional Services only.',
        'N529' => 'Client is entitled to benefits for Professional Services only.',
        ...
        'N536' => 'We are not changing the prior payer\'s determination of client responsibility, which you may collect, as this service is not covered by us.',
        'N537' => 'We have examined claims history and no records of the services have been found.',
        'N538' => 'A facility is responsible for payment to outside providers who furnish these services/supplies/drugs to its clients/residents.',
        ...
        'N548' => 'Alert: Client\'s calendar year deductible has been met.',
        'N549' => 'Alert: Client\'s calendar year out-of-pocket maximum has been met.',
        ...
        'N563' => 'Alert: Missing required provider/supplier issuance of advance client notice of non-coverage. The client is not liable for payment for this service.',
        'N564' => 'Client did not meet the inclusion criteria for the demonstration project or pilot program.',
        ...
        'N582' => 'Benefits suspended pending the client\'s cooperation.',
        'N583' => 'Client was not an occupant of our insured vehicle and therefore, is not an eligible injured person.',
        ...
        'N588' => 'The client has instructed that medical claims/bills are not to be paid.',
        ...
        'N605' => 'This fee was calculated based upon New York All Clients Refined Diagnosis Related Groups (APR-DRG), pursuant to Regulation 68.',
        ...
        'N626' => 'New or established client E/M codes are not payable with chiropractic care codes.',
        'N628' => 'Out-client follow up visits on the same date of service as a scheduled test or treatment is disallowed.',
        ...
        'N639' => 'Reimbursement has been made according to the inclient rehabilitation facilities fee schedule.',
        ...
        'N673' => 'Reimbursement has been calculated based on an outclient per diem or an outclient factor and/or fee schedule amount.',
        ...
        'N676' => 'Service does not qualify for payment under the Outclient Facility Fee Schedule.',
        ...
        'N691' => 'Alert: This reversal is due to a client submitted appeal.',
        ...
        'N695' => 'Alert: This reversal is due to incorrect client financial responsibility information on the initial adjudication.',
        ...
        'N720' => 'Alert: The client overpaid you. You may need to issue the client a refund for the difference between the client’s payment and the amount shown as client responsibility on this notice.',
        'N721' => 'This service is only covered when performed as part of a clinical trial.',
        'N722' => 'Client must use Workers\' Compensation Set-Aside (WCSA) funds to pay for the medical service or item.',
        'N723' => 'Client must use Liability set-aside (LSA) funds to pay for the medical service or item.',
        'N724' => 'Client must use No-Fault set-aside (NFSA) funds to pay for the medical service or item.',
        ...
        'N729' => 'Missing client medical/dental record for this service.',
        'N730' => 'Incomplete/invalid client medical/dental record for this service.',
        ...
        'N734' => 'The client is eligible for these medical services only when unable to work or perform normal activities due to an illness or injury.',
        ...
        'N747' => 'This is a misdirected claim/service. Submit the claim to the payer/plan where the client resides.',
        ...
        'N751' => 'Adjusted because the client is covered under a Medicare Part D plan.',
        ...
        'N781' => 'Alert: Client is a Medicaid/ Qualified Medicare Beneficiary. Review your records for any wrongfully collected deductible. This amount may be billed to a subsequent payer.',
        'N782' => 'Alert: Client is a Medicaid/ Qualified Medicare Beneficiary. Review your records for any wrongfully collected coinsurance. This amount may be billed to a subsequent payer.',
        'N783' => 'Alert: Client is a Medicaid/ Qualified Medicare Beneficiary. Review your records for any wrongfully collected copayment. This amount may be billed to a subsequent payer.',
        ...
        'N787' => 'Alert: Under 42 CFR 410.43, an eligible Partial Hospitalization Program (PHP) client/beneficiary requires a minimum of 20 hours of PHP services per week, as evidenced in the plan of care. PHP services must be furnished in accordance with the plan of care.',
        ...
        'N804' => 'Alert: The claim/service was processed through the Outclient Code Editor (OCE).',
    ...
    //
    // Currently on the billing page the user can select any of the client's
    ...
    public static function updateClaim(
        ...
        $sqlBindArray = array();
        if (!$newversion) {
            $sql = "SELECT * FROM claims WHERE client_id = ? AND " .
                "encounter_id = ? AND status > 0 AND status < 4 ";
            array_push($sqlBindArray, $client_id, $encounter_id);
            if ($payer_id >= 0) {
                $sql .= "AND payer_id = ? ";
        ...
        if ($billset) {
            ...
            array_push($sqlBindArray, $encounter_id, $client_id);
        ...
        if ($newversion) {
             ...
             ****/
            sqlBeginTrans();
            $version = sqlQuery("SELECT IFNULL(MAX(version),0) + 1 AS increment FROM claims WHERE client_id = ? AND encounter_id = ?", array($client_id, $encounter_id));
            ...
            array_push($sqlBindArray, $client_id, $encounter_id, $row['version']);
            $claimset = substr($claimset, 2);
            sqlStatement("UPDATE claims SET $claimset WHERE " .
                "client_id = ? AND encounter_id = ? AND " .
        ...
        if ($status == 2) {
            if ($payer_type > 0) {
                sqlStatement("UPDATE form_encounter SET " .
                    ...
                    "pid = ? AND encounter = ?", array($payer_type, $client_id, $encounter_id));
            }
        }
    ...
    //
    public static function getCopay($client_id, $encdate)
    {
        $tmp = sqlQuery("SELECT provider, copay FROM insurance_data " .
            "WHERE pid = ? AND type = 'primary' " .
            "AND date <= ? ORDER BY date DESC LIMIT 1", array($client_id, $encdate));
        if ($tmp['provider']) {
    ...
    // Get the total co-pay amount paid by the client for an encounter
    public static function getClientCopay($client_id, $encounter)
    {
        $resMoneyGot = sqlStatement(
            "SELECT sum(pay_amount) as ClientPay FROM ar_activity where " .
            "pid = ? and encounter = ? and payer_type=0 and account_code='PCP'",
            array($client_id, $encounter)
        );
        //new fees screen copay gives account_code='PCP'
        $rowMoneyGot = sqlFetchArray($resMoneyGot);
        $Copay = $rowMoneyGot['ClientPay'];
        return $Copay * -1;
    }
    ...
    //
    public static function doVoid($client_id, $encounter_id, $purge = false, $time = '')
    {
        ...
        if (!$time) {
            ...
            $corow = sqlQuery(
                ...
                array($client_id, $encounter_id, $client_id, $encounter_id)
            );
        ...
        if ($date_original) {
            $row = sqlQuery(
                ...
                array($client_id, $encounter_id, $date_original)
            );
            $adjustments = empty($row['adjustments']) ? 0 : $row['adjustments'];
            $payments = empty($row['payments']) ? 0 : $row['payments'];
        }
        ...
        if ($purge || $usingirnpools) {
            $query = "INSERT INTO voids SET " .
                ...
                "amount2 = ?, " .
                "other_info = ?";
            $sqlarr = array($client_id, $encounter_id, $what_voided, $_SESSION['authUserID'], $adjustments,
        ...
        if ($purge) {
            ...
            sqlStatement(
                ...
                "SET invoice_refno = ? " .
                "WHERE pid = ? AND encounter = ?",
                array($new_invoice_refno, $client_id, $encounter_id)
            );
        }
    }
}
