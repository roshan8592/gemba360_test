...
<head>
    ...
    <script language="JavaScript">
        ...
        function show_referral(transid) {
            dlgopen('../client_file/transaction/print_referral.php?transid=' + encodeURIComponent(transid),
...
<tbody>
    ...
    if ($_POST['form_refresh']) {
        ...
        "LEFT JOIN client_data AS p ON p.pid = t.pid " .
