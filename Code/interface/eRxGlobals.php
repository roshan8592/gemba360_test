...
class eRxGlobals
{
     ...
     * @return array URLs for NewCrop eRx services: index [ 0 = Update, 1 = Client ]
     */
    ...
    /**
     * Return NewCrop eRx default client country code
     * @return string NewCrop eRx default client country code
     */
    public function getDefaultClientCountry()
    {
        return $this->getGlobalValue('erx_default_client_country');
    }
