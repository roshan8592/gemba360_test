 ...
 *       ADD  portal    Client Portal     (Administrators, Emergency Login)
 *   4.1.1
 ...
 *   5.0.1
 *     Section "clients" (Clients):
 *       ADD  reminder    Client Reminders         (Physicians,Clinicians(addonly))
 ...
 *       ADD  gdlog       Group detailed log of appointment in client record (Administrators)
 *       ADD  gm          Send message from the permanent group therapist to the personal therapist (Administrators)
 *   5.0.2
 *     Section "clients" (Clients):
 *       ADD  pat_rep     Client Report            (Administrators)
 * </pre>
 *
 * @package   OpenEMR
...
if ($acl_version < $upgrade_acl) {
    ...
    //Add 'Client Portal' object section (added in 4.1.0)
    addObjectSectionAcl('clientportal', 'Client Portal');
    ...
    addObjectAcl('clients', 'Clients', 'sign', 'Sign Lab Results (write,addonly optional)');
    //Add 'nationnotes' object (added in 4.1.0)
    addObjectAcl('nationnotes', 'Nation Notes', 'nn_configure', 'Nation Notes Configure');
    //Add 'clientportal' object (added in 4.1.0)
    addObjectAcl('clientportal', 'Client Portal', 'portal', 'Client Portal');
    ...
    //Insert the 'appt' object from the 'clients' section into the Emergency Login group write ACL (added in 3.3.0)
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'appt', 'Appointments (write,wsome optional)', 'write');
    //Insert the 'demo' object from the 'clients' section into the Emergency Login group write ACL (added in 3.3.0)
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'demo', 'Demographics (write,addonly optional)', 'write');
    //Insert the 'med' object from the 'clients' section into the Emergency Login group write ACL (added in 3.3.0)
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'med', 'Medical/History (write,addonly optional)', 'write');
    //Insert the 'trans' object from the 'clients' section into the Emergency Login group write ACL (added in 3.3.0)
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'trans', 'Transactions (write optional)', 'write');
    //Insert the 'docs' object from the 'clients' section into the Emergency Login group write ACL (added in 3.3.0)
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'docs', 'Documents (write,addonly optional)', 'write');
    //Insert the 'notes' object from the 'clients' section into the Emergency Login group write ACL (added in 3.3.0)
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'notes', 'Client Notes (write,addonly optional)', 'write');
    ...
    //Insert the 'sign' object from the 'clients' section into the Physicians group write ACL (added in 3.3.0)
    updateAcl($doc_write, 'Physicians', 'clients', 'Clients', 'sign', 'Sign Lab Results (write,addonly optional)', 'write');
    ...
    //Insert the 'clientportal' object from the 'clientportal' section into the Administrators group write ACL (added in 4.1.0)
    updateAcl($admin_write, 'Administrators', 'clientportal', 'Client Portal', 'portal', 'Client Portal', 'write');
    //Insert the 'clientportal' object from the 'clientportal' section into the Emergency Login group write ACL (added in 4.1.0)
    updateAcl($emergency_write, 'Emergency Login', 'clientportal', 'Client Portal', 'portal', 'Client Portal', 'write');
...
if ($acl_version < $upgrade_acl) {
    ...
    //Add new Objects
    echo "<BR/><B>Adding new objects</B><BR/>";
    // Add 'Client Reminders (write,addonly optional)' object (added in 5.0.1)
    addObjectAcl('clients', 'Clients', 'reminder', 'Client Reminders (write,addonly optional)');
    // Add 'Clinical Reminders/Alerts (write,addonly optional)' object (added in 5.0.1)
    addObjectAcl('clients', 'Clients', 'alert', 'Clinical Reminders/Alerts (write,addonly optional)');
    // Add 'Disclosures (write,addonly optional)' object (added in 5.0.1)
    addObjectAcl('clients', 'Clients', 'disclosure', 'Disclosures (write,addonly optional)');
    // Add 'Prescriptions (write,addonly optional)' object (added in 5.0.1)
    addObjectAcl('clients', 'Clients', 'rx', 'Prescriptions (write,addonly optional)');
    // Add 'Amendments (write,addonly optional)' object (added in 5.0.1)
    addObjectAcl('clients', 'Clients', 'amendment', 'Amendments (write,addonly optional)');
    // Add 'Lab Results (write,addonly optional)' object (added in 5.0.1)
    addObjectAcl('clients', 'Clients', 'lab', 'Lab Results (write,addonly optional)');
    ...
    //Update the ACLs
    echo "<BR/><B>Updating the ACLs(Access Control Lists)</B><BR/>";
    //Insert the 'reminder' object from the 'clients' section into the Physicians group write ACL (added in 5.0.1)
    updateAcl($doc_write, 'Physicians', 'clients', 'Clients', 'reminder', 'Client Reminders (write,addonly optional)', 'write');
    //Insert the 'alert' object from the 'clients' section into the Physicians group write ACL (added in 5.0.1)
    updateAcl($doc_write, 'Physicians', 'clients', 'Clients', 'alert', 'Clinical Reminders/Alerts (write,addonly optional)', 'write');
    //Insert the 'disclosure' object from the 'clients' section into the Physicians group write ACL (added in 5.0.1)
    updateAcl($doc_write, 'Physicians', 'clients', 'Clients', 'disclosure', 'Disclosures (write,addonly optional)', 'write');
    //Insert the 'rx' object from the 'clients' section into the Physicians group write ACL (added in 5.0.1)
    updateAcl($doc_write, 'Physicians', 'clients', 'Clients', 'rx', 'Prescriptions (write,addonly optional)', 'write');
    //Insert the 'amendment' object from the 'clients' section into the Physicians group write ACL (added in 5.0.1)
    updateAcl($doc_write, 'Physicians', 'clients', 'Clients', 'amendment', 'Amendments (write,addonly optional)', 'write');
    //Insert the 'lab' object from the 'clients' section into the Physicians group write ACL (added in 5.0.1)
    updateAcl($doc_write, 'Physicians', 'clients', 'Clients', 'lab', 'Lab Results (write,addonly optional)', 'write');
    //DONE with upgrading to this version
    $acl_version = $upgrade_acl;
}
...
if ($acl_version < $upgrade_acl) {
    ...
    addObjectAcl('groups', 'Groups', 'gdlog', 'Group detailed log of appointment in client record');
    ...
    updateAcl($admin_write, 'Administrators', 'groups', 'Groups', 'gdlog', 'Group detailed log of appointment in client record', 'write');
...
if ($acl_version < $upgrade_acl) {
    ...
    updateAcl($admin_write, 'Administrators', 'clients', 'Clients', 'sign', 'Sign Lab Results (write,addonly optional)', 'write');
    updateAcl($admin_write, 'Administrators', 'clients', 'Clients', 'reminder', 'Client Reminders (write,addonly optional)', 'write');
    updateAcl($admin_write, 'Administrators', 'clients', 'Clients', 'alert', 'Clinical Reminders/Alerts (write,addonly optional)', 'write');
    updateAcl($admin_write, 'Administrators', 'clients', 'Clients', 'disclosure', 'Disclosures (write,addonly optional)', 'write');
    updateAcl($admin_write, 'Administrators', 'clients', 'Clients', 'rx', 'Prescriptions (write,addonly optional)', 'write');
    updateAcl($admin_write, 'Administrators', 'clients', 'Clients', 'amendment', 'Amendments (write,addonly optional)', 'write');
    updateAcl($admin_write, 'Administrators', 'clients', 'Clients', 'lab', 'Lab Results (write,addonly optional)', 'write');
    ...
    updateAcl($clin_addonly, 'Clinicians', 'clients', 'Clients', 'trans', 'Transactions (write optional)', 'addonly');
    updateAcl($clin_addonly, 'Clinicians', 'clients', 'Clients', 'reminder', 'Client Reminders (write,addonly optional)', 'addonly');
    updateAcl($clin_addonly, 'Clinicians', 'clients', 'Clients', 'alert', 'Clinical Reminders/Alerts (write,addonly optional)', 'addonly');
    updateAcl($clin_addonly, 'Clinicians', 'clients', 'Clients', 'disclosure', 'Disclosures (write,addonly optional)', 'addonly');
    updateAcl($clin_addonly, 'Clinicians', 'clients', 'Clients', 'rx', 'Prescriptions (write,addonly optional)', 'addonly');
    updateAcl($clin_addonly, 'Clinicians', 'clients', 'Clients', 'amendment', 'Amendments (write,addonly optional)', 'addonly');
    updateAcl($clin_addonly, 'Clinicians', 'clients', 'Clients', 'lab', 'Lab Results (write,addonly optional)', 'addonly');
    ...
    updateAcl($front_view, 'Front Office', 'clients', 'Clients', 'alert', 'Clinical Reminders/Alerts (write,addonly optional)', 'view');

    updateAcl($front_write, 'Front Office', 'groups', 'Groups', 'gcalendar', 'View/Create/Update groups appointment in calendar', 'write');

    updateAcl($back_view, 'Accounting', 'clients', 'Clients', 'alert', 'Clinical Reminders/Alerts (write,addonly optional)', 'view');
    ...
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'sign', 'Sign Lab Results (write,addonly optional)', 'write');
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'reminder', 'Client Reminders (write,addonly optional)', 'write');
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'alert', 'Clinical Reminders/Alerts (write,addonly optional)', 'write');
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'disclosure', 'Disclosures (write,addonly optional)', 'write');
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'rx', 'Prescriptions (write,addonly optional)', 'write');
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'amendment', 'Amendments (write,addonly optional)', 'write');
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'lab', 'Lab Results (write,addonly optional)', 'write');
    ...
    updateAcl($emergency_write, 'Emergency Login', 'groups', 'Groups', 'gdlog', 'Group detailed log of appointment in client record', 'write');
...
if ($acl_version < $upgrade_acl) {
    ...
    //Add new object Sections
    echo "<BR/><B>Adding new object sections</B><BR/>";
    addObjectAcl('clients', 'Clients', 'docs_rm', 'Documents Delete');
    ...
    // (will also place in the appropriate group and CREATE a new group if needed)
    echo "<BR/><B>Adding ACLs(Access Control Lists) and groups</B><BR/>";
    updateAcl($admin_write, 'Administrators', 'clients', 'Clients', 'docs_rm', 'Documents Delete', 'write');
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'docs_rm', 'Documents Delete', 'write');
...
if ($acl_version < $upgrade_acl) {
    ...
    //Add new Objects
    echo "<BR/><B>Adding new objects</B><BR/>";
    addObjectAcl('clients', 'Clients', 'pat_rep', 'Client Report');
    ...
    // (will also place in the appropriate group and CREATE a new group if needed)
    echo "<BR/><B>Adding ACLs(Access Control Lists) and groups</B><BR/>";
    updateAcl($admin_write, 'Administrators', 'clients', 'Clients', 'pat_rep', 'Client Report', 'write');
    updateAcl($accounting_view, 'Accounting', 'clients', 'Clients', 'pat_rep', 'Client Report', 'view');
    updateAcl($clinicians_view, 'Clinicians', 'clients', 'Clients', 'pat_rep', 'Client Report', 'view');
    updateAcl($emergency_write, 'Emergency Login', 'clients', 'Clients', 'pat_rep', 'Client Report', 'write');
    updateAcl($frontoffice_view, 'Front Office', 'clients', 'Clients', 'pat_rep', 'Client Report', 'view');
    updateAcl($physicians_view, 'Physicians', 'clients', 'Clients', 'pat_rep', 'Client Report', 'view');
