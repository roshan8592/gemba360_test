...
//
    function __construct($component_separator = '', $repetition_separator = '')
    {
        ...
        "6"=>"The procedure/revenue code is inconsistent with the client's age.",
        "7"=>"The procedure/revenue code is inconsistent with the client's gender.",
        "8"=>"The procedure code is inconsistent with the provider type/specialty (taxonomy).",
        "9"=>"The diagnosis is inconsistent with the client's age.",
        "10"=>"The diagnosis is inconsistent with the client's gender.",
        ...
        "100"=>"Payment made to client/insured/responsible party/employer.",
        ...
        "168"=>"Service(s) have been considered under the client's medical plan. Benefits are not available under this dental plan.",
        ...
        "179"=>"Client has not met the required waiting requirements.",
        ...
        "204"=>"This service/equipment/drug is not covered under the client’s current benefit plan",
        ...
        "B12"=>"Services not documented in clients' medical records.",
        ...
        "N116"=>"This payment is being made conditionally because the service was provided in the home, and it is possible that the client is under a home health episode of care. When a client is treated under a home health episode of care, consolidated billing requires that certain therapy services and supplies, such as this, be included in the home health agency’s (HHA’s) payment. This payment will need to be recouped from you if we establish that the client is concurrently receiving treatment under an HHA episode of care.",
        ...
        "N355"=>"Alert: The law permits exceptions to the refund requirement in two cases: - If you did not know, and could not have reasonably been expected to know, that we would not pay for this service; or - If you notified the client in writing before providing the service that you believed that we were likely to deny the service, and the client signed a statement agreeing to pay for the service. 
...
If you request an appeal within 30 days of receiving this notice, you may delay refunding the amount to the client until you receive the results of the review. If the review decision is favorable to you, you do not need to make any refund. If, however, the review is unfavorable, the law specifies that you must make the refund within 15 days of receiving the unfavorable review decision.
The law also permits you to request an appeal at any time within 120 days of the date you receive this notice. However, an appeal request that is received more than 30 days after the date of this notice, does not permit you to delay making the refund. Regardless of when a review is requested, the client will be notified that you have requested one, and will receive a copy of the determination.
The client has received a separate notice of this denial decision. The notice advises that he/she may be entitled to a refund of any amounts paid, if you should have known that we would not pay and did not tell him/her. It also instructs the client to contact our office if he/she does not hear anything about a refund within 30 days",
