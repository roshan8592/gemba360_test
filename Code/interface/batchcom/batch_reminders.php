...
<head>
    ...
    <title><?php echo xlt('Client Reminder Batch Job') ?></title>
</head>
<body class="body_top container">
    <header class="row">
        ...
        <h1 class="col-md-12">
            ...
            <small><?php echo xlt('Client Reminder Batch Job'); ?></small>
        </h1>
    </header>
    <?php
        ...
        <div class="col-md-12">
            ...
            <tr>
              <td class='text' align='left' colspan="3"><br>
                ...
                <span class="text"><?php echo xlt('The client reminders have been updated') . ":"?></span><br>
                ...
                <br><span class="text"><?php echo xlt('The client reminders have been sent') . ":"?></span><br>
