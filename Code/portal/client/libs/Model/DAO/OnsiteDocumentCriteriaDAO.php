...
class OnsiteDocumentCriteriaDAO extends Criteria
{
    ...
    public $ClientSignedStatus_Equals;
    public $ClientSignedStatus_NotEquals;
    public $ClientSignedStatus_IsLike;
    public $ClientSignedStatus_IsNotLike;
    public $ClientSignedStatus_BeginsWith;
    public $ClientSignedStatus_EndsWith;
    public $ClientSignedStatus_GreaterThan;
    public $ClientSignedStatus_GreaterThanOrEqual;
    public $ClientSignedStatus_LessThan;
    public $ClientSignedStatus_LessThanOrEqual;
    public $ClientSignedStatus_In;
    public $ClientSignedStatus_IsNotEmpty;
    public $ClientSignedStatus_IsEmpty;
    public $ClientSignedStatus_BitwiseOr;
    public $ClientSignedStatus_BitwiseAnd;
    public $ClientSignedTime_Equals;
    public $ClientSignedTime_NotEquals;
    public $ClientSignedTime_IsLike;
    public $ClientSignedTime_IsNotLike;
    public $ClientSignedTime_BeginsWith;
    public $ClientSignedTime_EndsWith;
    public $ClientSignedTime_GreaterThan;
    public $ClientSignedTime_GreaterThanOrEqual;
    public $ClientSignedTime_LessThan;
    public $ClientSignedTime_LessThanOrEqual;
    public $ClientSignedTime_In;
    public $ClientSignedTime_IsNotEmpty;
    public $ClientSignedTime_IsEmpty;
    public $ClientSignedTime_BitwiseOr;
    public $ClientSignedTime_BitwiseAnd;
    ...
    public $ClientSignature_Equals;
    public $ClientSignature_NotEquals;
    public $ClientSignature_IsLike;
    public $ClientSignature_IsNotLike;
    public $ClientSignature_BeginsWith;
    public $ClientSignature_EndsWith;
    public $ClientSignature_GreaterThan;
    public $ClientSignature_GreaterThanOrEqual;
    public $ClientSignature_LessThan;
    public $ClientSignature_LessThanOrEqual;
    public $ClientSignature_In;
    public $ClientSignature_IsNotEmpty;
    public $ClientSignature_IsEmpty;
    public $ClientSignature_BitwiseOr;
    public $ClientSignature_BitwiseAnd;
