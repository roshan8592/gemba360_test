        ...
        <div class="col-sm-8 offset-sm-2" style="margin:5;text-align:center;width:560px;">
            <table>
                ...
                if (sqlNumRows($dispensed) == 0) {
                    echo "<tr><td colspan='2' style='font-size:1.2em;text-align:middle;padding:25px;'>" . xlt('There are no Glasses or Contact Lens Presciptions on file for this client') . "</td></tr>";
                }
                ?>
            </table>
            <?php
