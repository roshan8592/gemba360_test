...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n1="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
   ...
   <xsl:template name="recordTarget">
      <table class="header_table">
         <tbody>
            <xsl:for-each select="/n1:ClinicalDocument/n1:recordTarget/n1:clientRole">
               <xsl:if test="not(n1:id/@nullFlavor)">
                  <tr>
                     ...
                     <td colspan="3">
                        <xsl:call-template name="show-name">
                           <xsl:with-param name="name" select="n1:client/n1:name"/>
                        </xsl:call-template>
                     </td>
                  </tr>
                  <tr>
                     ...
                     <td width="30%">
                        <xsl:call-template name="show-time">
                           <xsl:with-param name="datetime" select="n1:client/n1:birthTime"/>
                        </xsl:call-template>
                     </td>
                     <td width="15%" bgcolor="#3399ff">
                        <span class="td_label">
                     ...
                     <td>
                        <xsl:for-each select="n1:client/n1:administrativeGenderCode">
                           <xsl:call-template name="show-gender"/>
                        </xsl:for-each>
                     </td>
                  </tr>
                  <xsl:if test="n1:client/n1:raceCode | (n1:client/n1:ethnicGroupCode)">
                     <tr>
                        <td width="20%" bgcolor="#3399ff">
                           <span class="td_label">
                        ...
                        <td width="30%">
                           <xsl:choose>
                              <xsl:when test="n1:client/n1:raceCode">
                                 <xsl:for-each select="n1:client/n1:raceCode">
                        ...
                        <td>
                           <xsl:choose>
                              <xsl:when test="n1:client/n1:ethnicGroupCode">
                                 <xsl:for-each select="n1:client/n1:ethnicGroupCode">
                                    <xsl:call-template name="show-race-ethnicity"/>
                                 </xsl:for-each>
                              </xsl:when>
                              <xsl:otherwise>
