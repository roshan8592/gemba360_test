...
class OnsitePortalActivityController extends AppBaseController
{
    ...
    public function Create()
    {
        try {
            ...
            $onsiteportalactivity->ClientId = $this->SafeGetVal($json, 'clientId');
    ...
    public function Update()
    {
        try {
            ...
            $onsiteportalactivity->ClientId = $this->SafeGetVal($json, 'clientId', $onsiteportalactivity->ClientId);
