 ...
 */
    ...
    $this->assign('title', xlt("Client Portal Secure"));
...
<div class="container">
    ...
    <?php if ($this->page == 'login') { ?>
        <div class="hero-unit">
            ...
            <p>
                <a href="secureuser" class="btn btn-primary btn-large"><?php echo xlt('Client Access'); ?></a>
    ...
    <?php } else { ?>
        <div class="hero-unit">
            <h1>Secure <?php $this->eprint($this->page == 'userpage' ? 'Client' : 'Provider'); ?> Page</h1>
            <p>This page is accessible only to <?php $this->eprint($this->page == 'userpage' ? 'authenticated clients' : 'administrators'); ?>.
            <?php echo xlt('You are currently logged in as'); ?> '<strong><?php $this->eprint($this->currentUser->Username); ?></strong>'</p>
            <p>
                <a href="secureuser" class="btn btn-primary btn-large"><?php echo xlt('Visit Client Home Page'); ?></a>
