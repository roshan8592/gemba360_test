...
class NQF_0059_InitialClientPopulation implements CqmFilterIF
{
    ...
    public function test(CqmClient $client, $beginDate, $endDate)
    {
        ...
        if ($age >= 18 && $age < 75 && Helper::check(ClinicalType::ENCOUNTER, Encounter::ENC_OFF_VIS, $client, $beginDate, $endDate)) {
            ...
            $sql = sqlQuery($query, array($client->id,$beginDate,$endDate,$beginDate,$beginDate,$endDate,$endDate));
            if ($sql['cnt'] > 0) {
                return true;
            }
