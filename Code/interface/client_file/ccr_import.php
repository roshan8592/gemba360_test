<?php
/**
 * interface/client_file/ccr_import.php Upload screen and parser for the CCR XML.
 *
  ...
  <main class="container">
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        ...
        <ol class="list-group">
          <li class="list-group-item"><?php echo xlt('For an existing client, go to Client Summary->Documents. For a new client, go to Miscellanous->New Documents').'.'; ?></li>
          ...
          <li class="list-group-item"><?php echo xlt('Approve the client from Client/Client->Import->Pending Approval').'.'; ?></li>
        </ol>
      </div>
    </div>
  </main>
