            ...
            if ($iter{'code_type'} != 'payment_info') {
                if ($iter{'code_type'} === 'COPAY' || $iter{'code_type'} === 'Client Payment' || $iter{'code_type'} === 'Insurance Payment') {
                    ...
                    if (($iter{'pat_adjust_dollar'}) != 0 and ($iter{'code_type'}) === 'Client Payment') {
                        print  "</span></td><td width=180><span class=text><center>" . xlt('Client Adjustment'). "</center>";
                    }
                    ...
                    if (($iter{'pat_code'}) > 0 and ($iter{'code_type'}) === 'Client Payment' and $iter{'paytype'} != 'PCP') {
                        print  "</span></td><td width=180><span class=text><center>" . xlt('Client Payment'). "</center>";
                    }
                    ...
                    if (($iter{'pat_code'}) < 0 and ($iter{'code_type'}) === 'Client Payment' and $iter{'paytype'} != 'PCP') {
                        print  "</span></td><td width=180><span class=text><center>" . xlt('Client Credit'). "</center>";
                    }
                ...
                if ($iter{'code_type'} === 'COPAY' || $iter{'code_type'} === 'Client Payment' || $iter{'code_type'} === 'Insurance Payment' || $iter{'fee'} != 0) {
                     $res_count++;
                }
