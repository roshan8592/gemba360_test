...
##### CouchDB
In OpenEMR, CouchDB is an option for the clients document storage. For this reason, a CouchDB
...
You can configure OpenEMR to use this CouchDB docker for client document storage in OpenEMR
