...
//Need to unwrap data to ensure user/client is authorized
...
// this script is used by both the client portal and main openemr; below does authorization.
if ($type == 'client-signature') {
    // authorize via client portal
