...
INSERT INTO `form_CAMOS_item` VALUES (692,NULL,NULL,NULL,NULL,NULL,NULL,'safety','The client was counseled on safety regarding opioid and anxiolytic controlled medications.  Specifically, never give any prescribed medication to another person for any reason.  Take prescribed medication only as directed and only for the reason for which it has been prescribed.  For medication that has been prescribed to be taken as needed for symptomatic relief, take the least amount possible as directed to obtain adequate relief without significant side effects.  Report leftover medication to the physician at the next visit so adjustments can be made.  Keep medication in a safe place, out of the reach of other people, especially children.  A locked box or safe is ideal.  Always report possible side effects, particularly with controlled medication, the possibility of developing psychological dependence.',170);
