        ...
        foreach ($trans[$i] as $seg) {
            ...
            if (strncmp($seg, 'HL'.$de, 3) === 0) {
                ...
                if ($sar[3] == '20') {                      // level code
                    ...
                    $loopid = '2000E';                      // client event
                    $cls = 'evt';
                    $evt_html .= "<tr class='" . attr($cls) . "'><td colspan=4><b>Client Event</b></td></tr>".PHP_EOL;
                } elseif ($sar[3] == 'SS') {
            ...
            if (strncmp('CL1'.$de, $seg, 4) === 0) {
                ...
                $elem03 = (isset($sar[3]) && $sar[3]) ? $cd27x->get_271_code('CL103', $sar[3]) : '';    // client status code
                //
            ...
            if (strncmp('CR6'.$de, $seg, 4) === 0) {
                ...
                $sar = explode($de, $seg);
                //
                $elem01 = (isset($sar[1]) && $sar[1]) ? $cd27x->get_271_code('UM07', $sar[1]) : ""; // client condition code
