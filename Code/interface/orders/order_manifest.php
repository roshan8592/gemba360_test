...
function generate_order_summary($orderid)
{
  ...
  // If requested, save checkbox selections as to which procedures are not sendable.
    ...
    $orow = sqlQuery(
        "SELECT " .
        "po.procedure_order_id, po.client_id, po.date_ordered, po.order_status, " .
    ...
    $client_id = intval($orow['client_id']);
...
<table width='100%' cellpadding='2' cellspacing='0'>
 <tr bgcolor='#cccccc'>
  <td nowrap><?php echo xlt('Client Name'); ?></td>
 ...
 <tr bgcolor='#cccccc'>
  ...
  <td width='45%'><?php echo myCellText($client_id); ?></td>
