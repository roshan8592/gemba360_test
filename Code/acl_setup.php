...
// xl('Lists')
$gacl->add_object_section('Clients', 'clients', 10, 0, 'ACO');
// xl('Clients')
...
// xl('Nation Notes')
$gacl->add_object_section('Client Portal', 'clientportal', 10, 0, 'ACO');
// xl('Client Portal')
...
// Create ACOs for clientportal.
//
$gacl->add_object('clientportal', 'Client Portal', 'portal', 10, 0, 'ACO');
// xl('Client Portal')
...
// Create ACOs for clients.
//
$gacl->add_object('clients', 'Appointments (write,wsome optional)', 'appt', 10, 0, 'ACO');
// xl('Appointments (write,wsome optional)')
$gacl->add_object('clients', 'Demographics (write,addonly optional)', 'demo', 10, 0, 'ACO');
// xl('Demographics (write,addonly optional)')
$gacl->add_object('clients', 'Medical/History (write,addonly optional)', 'med', 10, 0, 'ACO');
// xl('Medical/History (write,addonly optional)')
$gacl->add_object('clients', 'Transactions (write optional)', 'trans', 10, 0, 'ACO');
// xl('Transactions (write optional)')
$gacl->add_object('clients', 'Documents (write,addonly optional)', 'docs', 10, 0, 'ACO');
// xl('Documents (write,addonly optional)')
$gacl->add_object('clients', 'Documents Delete', 'docs_rm', 10, 0, 'ACO');
// xl('Documents Delete')
$gacl->add_object('clients', 'Client Notes (write,addonly optional)', 'notes', 10, 0, 'ACO');
// xl('Client Notes (write,addonly optional)')
$gacl->add_object('clients', 'Sign Lab Results (write,addonly optional)', 'sign', 10, 0, 'ACO');
// xl('Sign Lab Results (write,addonly optional)')
$gacl->add_object('clients', 'Client Reminders (write,addonly optional)', 'reminder', 10, 0, 'ACO');
// xl('Client Reminders (write,addonly optional)')
$gacl->add_object('clients', 'Clinical Reminders/Alerts (write,addonly optional)', 'alert', 10, 0, 'ACO');
// xl('Clinical Reminders/Alerts (write,addonly optional)')
$gacl->add_object('clients', 'Disclosures (write,addonly optional)', 'disclosure', 10, 0, 'ACO');
// xl('Disclosures (write,addonly optional)')
$gacl->add_object('clients', 'Prescriptions (write,addonly optional)', 'rx', 10, 0, 'ACO');
// xl('Prescriptions (write,addonly optional)')
$gacl->add_object('clients', 'Amendments (write,addonly optional)', 'amendment', 10, 0, 'ACO');
// xl('Amendments (write,addonly optional)')
$gacl->add_object('clients', 'Lab Results (write,addonly optional)', 'lab', 10, 0, 'ACO');
// xl('Lab Results (write,addonly optional)')
$gacl->add_object('clients', 'Client Report', 'pat_rep', 10, 0, 'ACO');
// xl('Client Report')
...
$gacl->add_object('groups', 'Group detailed log of appointment in client record', 'gdlog', 10, 0, 'ACO');
// xl('Group detailed log of appointment in client record')
...
$gacl->add_acl(
    array(
        ...
        'clients'=>array('appt', 'demo', 'med', 'trans', 'docs', 'notes', 'sign', 'reminder', 'alert', 'disclosure', 'rx', 'amendment', 'lab', 'docs_rm','pat_rep'),
        'sensitivities'=>array('normal', 'high'),
        'nationnotes'=>array('nn_configure'),
        'clientportal'=>array('portal'),
        'menus'=>array('modle'),
...
$gacl->add_acl(
    array(
        ...
        'admin'=>array('drugs'),
        'encounters'=>array('auth_a', 'auth', 'coding_a', 'coding', 'notes_a', 'notes', 'date_a', 'relaxed'),
        'clients' => array('appt', 'demo', 'med', 'trans', 'docs', 'notes', 'sign', 'reminder', 'alert',
...
$gacl->add_acl(
    array(
        ...
        'clients'=>array('demo', 'med', 'docs', 'notes','trans', 'reminder', 'alert', 'disclosure', 'rx', 'amendment', 'lab'),
...
$gacl->add_acl(
    array(
        'clients'=>array('appt', 'demo', 'trans', 'notes'),
