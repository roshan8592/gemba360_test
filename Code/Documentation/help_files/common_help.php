...
<html>
    ...
    <body>
        <div class="container oe-help-container">
            ...
            <div class= "row">
                <p><?php echo xlt("All client interactions in OpenEMR are linked to encounters");?>.

                <p><?php echo xlt("Clicking on the + button on the client header panel opens the New Encounter Form");?>.

                <p><?php echo xlt("This form allows you to enter details of a visit or client interaction");?>.
            ...
            <div class= "row" id="visit_reason">
                ...
                <p><?php echo xlt("Also provides a short description of the visit in Client Reports");?>.
            </div>
            <div class= "row" id="link_issue">
                ...
                <p><?php echo xlt("Select an appropriate ICD/CPT code. This helps search for education material to give to the client for that particular problem");?>.
