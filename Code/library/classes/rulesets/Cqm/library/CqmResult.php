...
class CqmResult implements RsResultIF
{
    ...
    public $ipp; // Number of clients that pass filter (Initial client populaton)
    public $denominator; // Number of clients passes after denominator condition
    public $denom_exclusion; // Number of clients that are excluded
    public $denom_exception; // Number of clients that added into exception
    public $numerator; // Number of clients that pass target
    public $percentage; // Calculated percentage

    public function __construct($rowRule, $numeratorLabel, $populationLabel, $totalClients, $denominator, $denom_exclusion, $numerator, $percentage, $ipp, $denom_exception)
    {
        $this->rule = $rowRule;
