...
<script LANGUAGE="JavaScript">
 ...
 function send_sum(client_id,transaction_id) {
   if ( $('#send_sum_flag_' + client_id + '_' + transaction_id).prop('checked') ) {
     var mode = "add";
   }
   else {
     var mode = "remove";
 ...
 function send_sum_elec(client_id,transaction_id) {
   if ( $('#send_sum_elec_flag_' + client_id + '_' + transaction_id).prop('checked') ) {
     if ( !$('#send_sum_flag_' + client_id + '_' + transaction_id).prop('checked') ) {
       $('#send_sum_elec_flag_' + client_id + '_' + transaction_id).prop("checked", false);
 ...
 function provide_rec_pat(client_id,date_created) {
   if ( $('#provide_rec_pat_flag_' + client_id ).prop('checked') ) {
 ...
 function provide_sum_pat(client_id,encounter_id) {
   if ( $('#provide_sum_pat_flag_' + client_id + '_' + encounter_id).prop('checked') ) {
     var mode = "add";
   }
   else {
     var mode = "remove";
    ...
    <table class='text'>
                ...
                <tr>
                        ...
                        <td>
                            ...
                            <?php echo xlt('Client Requested Medical Records'); ?></option>
                            <option value='provide_sum_pat_amc' <?php echo ($rule == "provide_sum_pat_amc") ? "selected" : ""; ?>>
                            <?php echo xlt('Provide Records to Client for Visit'); ?></option>
                            </select>
                        </td>
                </tr>
