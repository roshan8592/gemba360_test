...
$USER_SPECIFIC_GLOBALS = array('default_top_pane',
    ...
    'ptkr_end_date',
    'checkout_roll_off',
    'client_birthday_alert',
    'client_birthday_alert_manual_off',
...
$GLOBALS_METADATA = array(
    ...
    'Appearance' => array(
        ...
        'default_top_pane' => array(
            ...
            array(
                ...
                '../new/new.php' => xl('Client Search/Add Screen'),
                '../../interface/main/finder/dynamic_finder.php' => xl('Client Finder Screen'),
                '../../interface/client_tracker/client_tracker.php?skip_timeout_reset=1' => xl('Client Flow Board'),
        ...
        'search_any_client' => array(
            xl('Search Client By Any Demographics'),
            array(
                'dual' => xl('Dual'),
                'comprehensive' => xl('Comprehensive'),
            ),
            'dual', // default
            xl('Search Client By Any Demographics, Dual additionally lets direct access to Client Finder, Comprehensive has collapsed input box')
        ),
        ...
        'full_new_client_form' => array(
            ...
            array(
                ...
                '4' => xl('Mandatory or specified fields only, use client validation Zend module'),
            ),
            '1',                              // default
            xl('Style of form used for adding new clients')
        ),

        'gbl_edit_client_form' => array(
            xl('Modify Client Form'),
            ...
            '0',                              // default
            xl('Validation mechanism for when modifying client demographics.')
        ),

        'client_search_results_style' => array(
            xl('Client Search Results Style'),
            array(
                '0' => xl('Encounter statistics'),
                '1' => xl('Mandatory and specified fields'),
            ),
            '0',                              // default
            xl('Type of columns displayed for client search results')
        ),
        ...
        'gbl_pt_list_page_size' => array(
            ...
            '10',
            xl('Number of clients to display per page in the client list.')
        ),

        'gbl_pt_list_new_window' => array(
            xl('Client List New Window'),
            'bool',                           // data type
            '0',                              // default = false
            xl('Default state of New Window checkbox in the client list.')
        ),

        'num_of_messages_displayed' => array(
            xl('Number of Messages Displayed in Client Summary'),
            'num',
            '3',
            xl('This is the number of messages that will be displayed in the messages widget in the client summary screen.')
        ),
    ...
    'Locale' => array(
        ...
        'translate_form_titles' => array(
            xl('Translate Client Note Titles'),
            'bool',                           // data type
            '1',                              // default = true
            xl('Are client note titles to be translated?')
        ),
        ...
        'age_display_limit' => array(
            ...
            'num',
            '3',
            xl('If YMD is selected for age display, switch to just Years when clients older than this value in years')
        ),
    ...
    'Features' => array(
        ...
        'omit_employers' => array(
            ...
            'bool',                           // data type
            '0',                              // default = false
            xl('Omit employer information in client demographics')
        ),
        ...
        'ignore_pnotes_authorization' => array(
            xl('Skip Authorization of Client Notes'),
            'bool',                           // data type
            '1',                              // default = true
            xl('Do not require client notes to be authorized')
        ),
        ...
        'gbl_mask_client_id' => array(
            xl('Mask for Client IDs'),
            'text',                           // data type
            '',                               // default
            xl('Specifies formatting for the external client ID.  # = digit, @ = alpha, * = any character.  Empty if not used.')
        ),
        ...
        'hide_billing_widget' => array(
            ...
            'bool',                           // data type
            '0',                              // default = false
            xl('This will hide the Billing Widget in the Client Summary screen')
        ),
        ...
        'force_billing_widget_open' => array(
            ...
            'bool',                           // data type
            '0',                              // default = false
            xl('This will force the Billing Widget in the Client Summary screen to always be open.')
        ),
        ...
        'allow_pat_delete' => array(
            xl('Allow Administrators to Delete Clients'),
            'bool',                           // data type
            '0',                              // default = false
            xl('Allow Administrators to Delete Clients')
    ...
    'Report' => array(
        ...
        'print_next_appointment_on_ledger' => array(
            ...
            'bool',                           // data type
            '1',                              // default = true
            xl('This Will Print the Next Appointment on the Bottom of the Client Ledger')
        ),

        'sales_report_invoice' => array(
            xl('Display Invoice Number or Client Name or Both in the Sales Report'),
            array(
                '0' => xl('Invoice Number'),
                '1' => xl('Client Name and ID'),
                '2' => xl('Client Name and Invoice'),
            ),
            '2',                              // default = 2
            xl('This will Display the Invoice Number in the Sales Report or the Client Name and ID or Client Name and Invoice Number.')
        ),

        'cash_receipts_report_invoice' => array(
            xl('Display Invoice Number or Client Name in the Cash Receipt Report'),
            array(
                '0' => xl('Invoice Number'),
                '1' => xl('Client Name'),
            ),
    ...
    'Billing' => array(
        ...
        'show_payment_history' => array(
            xl('Show all payment history in Client Ledger'),
            'bool',                           // data type
            '1',                              // default = true
            xl('Turn on to show all payment history in Client Ledger')
        ),
        ...
        'notes_to_display_in_Billing' => array(
            ...
            array(
                ...
                '2' => xl('Client Billing Note'),
                '3' => xl('All'),
            ),
            '3',
            xl('Display the Encounter Billing Note or Client Billing Note or Both in the Billing Screen.')
        ),
        ...
        'statement_appearance' => array(
            ...
            '1',                              // default = true
            xl('Client statements can be generated as plain text or with a modern graphical appearance.')
        ),
        ...
        'use_statement_print_exclusion' => array(
            ...
            'bool',                           // data type
            '0',                              // default = false
            xl('This will enable the Ability to Exclude Selected Client Statements from Printing.')
        ),
        ...
        'statement_bill_note_print' => array(
            xl('Print Client Billing Note'),
            'bool',                           // data type
            '0',                              // default = false
            xl('This will allow printing of the Client Billing Note on the statements.')
        ),
        ...
        'statement_message_to_client' => array(
    ...
    'E-Sign' => array(
        ...
        'esign_report_hide_empty_sig' => array(
            ...
            'bool',                           // data type
            '1',                              // default = false
            xl('This will hide empty e-sign logs on the client report')
        ),
    ...
    'Documents' => array(
        ...
        'client_id_category_name' => array(
            xl('Client ID Category Name'),
            'text',                           // data type
            'Client ID card',                // default
            xl('Optional category name for an ID Card image that can be viewed from the client summary page.')
        ),

        'client_photo_category_name' => array(
            xl('Client Photo Category Name'),
            'text',                           // data type
            'Client Photograph',             // default
            xl('Optional category name for photo images that can be viewed from the client summary page.')
        ),
    ...
    'Calendar' => array(
        ...
        'number_of_appts_to_show' => array(
            xl('Appointments - Client Summary - Number to Display'),
            'num',
            '10',
            xl('Number of Appointments to display in the Client Summary')
        ),
        ...
        'appt_recurrences_widget' => array(
            ...
            'bool',                           // data type
            '1',                              // default
            xl('Display the recurrent appointment widget in the client summary.')
        ),
        ...
        'num_past_appointments_to_show' => array(
            ...
            'num',                           // data type
            '0',                             // default = false
            xl('A positive number will show that many past appointments on a Widget in the Client Summary screen (a negative number will show the past appointments in descending order)')
        ),
        ...
        'auto_create_new_encounters' => array(
            ...
            xl('The appointment status changes and encounter creations are managed through the Client Tracker.')
        ),
        ...
        'disable_pat_trkr' => array(
            ...
            'bool',                           // data type
            '0',                              // default
            xl('Completely remove the ability to display the Client Flow Board.')
        ),
        ...
        'ptkr_visit_reason' => array(
            ...
            'bool',                           // data type
            '0',                              // default = false
            xl('When Checked, Visit Reason Will Show in Client Flow Board.')
        ),

        'ptkr_show_pid' => array(
            xl('Flow Board: Show Client ID'),
            'bool',                           // data type
            '1',                              // default = true
            xl('When Checked, Client ID Will Show in Client Flow Board.')
        ),
        ...
        'ptkr_show_encounter' => array(
            ...
            'bool',                           // data type
            '1',                              // default = true
            xl('When Checked, Client Encounter Number Will Show in Client Flow Board.')
        ),
        ...
        'ptkr_show_staff' => array(
            ...
            'bool',                           // data type
            '1',                              // default = true
            xl('When Checked, Last Staff to Update Board Will Show in Client Flow Board.')
        ),
        ...
        'ptkr_date_range' => array(
            ...
            'bool',                          // data type
            '1',                             // default = true
            xl('This Allows a Date Range to be Selected in Client Flow Board.')
        ),
        ...
        'ptkr_start_date'=> array(
            ...
            xl('This is the default Beginning date for the Client Flow Board. (only applicable if Allow Date Range in option above is Enabled)')
        ),
        ...
        'ptkr_end_date' => array(
            ...
            xl('This is the default Ending date for the Client Flow Board. (only applicable if Allow Date Range in option above is Enabled)')
        ),
        ...
        'pat_trkr_timer' => array(
            ...
            '0:20',                              // default
            xl('The screen refresh time in Seconds for the Client Flow Board Screen.')
        ),
        ...
        'drug_screen' => array(
            ...
            'bool',                           // data type
            '0',                              // default
            xl('Allow Client Flow Board to Select Clients for Drug Testing.')
        ),

        'drug_testing_percentage' => array(
            xl('Flow Board: Percentage of Clients to Drug Test'),
            'num',
            '33',                       // default
            xl('Percentage of Clients to select for Random Drug Testing.')
        ),

        'maximum_drug_test_yearly' => array(
            xl('Flow Board: Max tests per Client per year'),
            'num',
            '0',                       // default
            xl('Maximum number of times a Client can be tested in a year. Zero is no limit.')
        ),
    ...
    'Notifications' => array(
        ...
        'client_reminder_sender_name' => array(
            xl('Client Reminder Sender Name'),
            'text',                           // data type
            '',                               // default
            xl('Name of the sender for client reminders.')
        ),

        'client_reminder_sender_email' => array(
            xl('Client Reminder Sender Email'),
            'text',                           // data type
            '',                               // default
            xl('Email address of the sender for client reminders. Replies to client reminders will be directed to this address. It is important to use an address from your clinic\'s domain to avoid help prevent client reminders from going to junk mail folders.')
        ),
    ...
    'CDR' => array(
        ...
        'enable_cdr_prw' => array(
            xl('Enable Client Reminder Widget'),
            'bool',                           // data type
            '1',                               // default
            xl('Enable Client Reminder Widget')
        ),
        ...
        'pat_rem_clin_nice' => array(
            xl('Client Reminder Creation Processing Priority'),
            array(
                '' => xl('Default Priority'),
                '5' => xl('Moderate Priority'),
                '10' => xl('Moderate/Low Priority'),
            ...
            '',                               // default
            xl('Set processing priority for creation of Client Reminders (in full clinic mode).')
        ),
        ...
        'client_birthday_alert' => array(
            xl('Alert on client birthday'),
            array(
                '0' => xl('No alert'),
        ...
        'client_birthday_alert_manual_off' => array(
            xl('Client birthday alert requires turning off'),
            'bool',                           // data type
            '0',                              // default
            xl('Client birthday alert requires turning off')
        )
    ...
    'Logging' => array(
        ...
        'audit_events_client-record' => array(
            xl('Audit Logging Client Record'),
            'bool',                           // data type
            '1',                              // default
            xl('Enable logging of client record modifications.') . ' (' . xl('Note that Audit Logging needs to be enabled above') . ')'
        ),
    ...
    'Miscellaneous' => array(
        ...
        'default_chief_complaint' => array(
            ...
            'text',                           // data type
            '',
            xl('You may put text here as the default complaint in the New Client Encounter form.')
        ),
    ...
    'Portal' => array(
        ...
        'portal_onsite_two_enable' => array(
            xl('Enable Onsite Client Portal'),
            'bool',                           // data type
            '0',
            xl('Enable Onsite Client Portal')
        ),
        ...
        'portal_onsite_two_address' => array(
            xl('Onsite Client Portal Site Address'),
            'text',                           // data type
            'https://your_web_site.com/openemr/portal',
            xl('Website link for the Onsite Client Portal.')
        ),
        ...
        'enforce_signin_email' => array(
            ...
            'bool',                           // data type
            '1',
            xl('Client is required to enter their contact e-mail if present in Demographics Contact.')
        ),

        'portal_onsite_two_register' => array(
            xl('Allow Onsite New Client Registration Widget'),
            'bool',                           // data type
            '1',
            xl('Enable Onsite Client Portal new client to self register.')
        ),
        ...
        'allow_portal_appointments' => array(
            ...
            'bool',                           // data type
            '1',
            xl('Allow Onsite Client to make and view appointments online.')
        ),
        ...
        'allow_portal_chat' => array(
            ...
            'bool',                           // data type
            '1',
            xl('Allow Onsite Client to use Secure Chat Application.')
        ),

        'portal_two_ledger' => array(
            xl('Allow Onsite Client Ledger'),
            'bool',                           // data type
            '1',
            xl('Allow Onsite Client to view their accounting ledger online.')
        ),
        ...
        'portal_two_payments' => array(
            ...
            'bool',                           // data type
            '0',
            xl('Allow Onsite Client to make payments online.')
        ),

        'portal_two_pass_reset' => array(
            xl('Allow Onsite Clients to Reset Credentials'),
            'bool',                           // data type
            '0',
            xl('Client may change their logon from portal login dialog.')
        ),

        'portal_onsite_document_download' => array(
            xl('Enable Onsite Client Portal Document Download'),
            'bool',                           // data type
            '1',
            xl('Enables the ability to download documents in the Onsite Client Portal by the user.')
        ),

        'portal_offsite_enable' => array(
            xl('Enable Offsite Client Portal'),
            'bool',                           // data type
            '0',
            xl('Enable Offsite Client Portal.')
        ),
        'portal_offsite_providerid' => array(
            xl('Offsite Client Portal Provider ID'),
            'text',                           // data type
            '',
            xl('Offsite Client Portal Provider ID(Put Blank If not Registered).')
        ),

        'portal_offsite_username' => array(
            xl('Offsite Client Portal Username'),
            'text',                           // data type
            '',
            xl('Offsite Client Portal Username(Put Blank If not Registered).')
        ),

        'portal_offsite_password' => array(
            xl('Offsite Client Portal Password'),
            'pwd',                           // data type
            '',
            xl('Offsite Client Portal Password(Put Blank If not Registered).')
        ),

        'portal_offsite_address' => array(
            xl('Offsite Client Portal Site Address'),
            'text',                           // data type
            'https://ssh.mydocsportal.com/provider.php',
            xl('Offsite Https link for the Client Portal.')
        ),

        'portal_offsite_address_client_link' => array(
            xl('Offsite Client Portal Site Address (Client Link)'),
            'text',                           // data type
            'https://ssh.mydocsportal.com',
            xl('Offsite Https link for the Client Portal.(Client Link)')
        ),
    ...
    'Connectors' => array(
        ...
        'erx_newcrop_path_soap' => array(
            ...
            'text',
            'https://secure.newcropaccounts.com/v7/WebServices/Update1.asmx?WSDL;https://secure.newcropaccounts.com/v7/WebServices/Client.asmx?WSDL',
        ...
        'erx_default_client_country' => array(
            xl('NewCrop eRx Default Client Country'),
            array(
                '' => '',
                'US' => xl('USA'),
                'CA' => xl('Canada'),
            ...
            '',
            xl('Default Client Country sent to NewCrop eRx, only if client country is not set.'),
        ),
    ...
    'PDF' => array(
        ...
        'chart_label_type' => array(
            ...
            '1', // default
            xl('Avery Label type for printing client labels from popups in left nav screen'),
        ),
        ...
        'addr_label_type' => array(
            xl('Print Client Address Label'),
            'bool',                           // data type
            '1',                              // default = false
            xl('Select to print client address labels from popups in left nav screen.')
        ),
