    ...
    if ($formid) {
        ...
        sqlStatement(
            ...
            [
                ...
                (isset($_POST['form_client_instructions']) ? $_POST['form_client_instructions'] : ''),
                $pid,
                $encounter,
...
function sel_related(varname) {
    ...
    // Also note the controlling script here runs from interface/client_file/encounter/.
                ...
                <fieldset>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="form-group hidden">
                            <label for="form_data_ordered" class="control-label col-sm-3 oe-text-to-right"><?php echo xlt('Client Instructions'); ?></label>
                            <div class="col-sm-7">
                                <textarea rows='3' cols='35' name='form_client_instructions' wrap='virtual' class='form-control inputtext'>
                                    <?php echo text($row['client_instructions']); ?>
                                </textarea>
                            </div>
                            <div class="clearfix"></div>
                        </div>
