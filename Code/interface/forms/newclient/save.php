...
$normalurl = "client_file/encounter/encounter_top.php";
...
<script language='JavaScript'>
    ...
    my_left_nav.setClientEncounter(EncounterIdArray,EncounterDateArray,CalendarCategoryArray);
    top.restoreSession();
<?php if ($mode == 'new') { ?>
    ...
    w.location.href = '<?php echo "$rootdir/client_file/encounter/encounter_top.php"; ?>';
<?php } else { // not new encounter ?>
    // Always return to encounter summary page.
    window.location.href = '<?php echo "$rootdir/client_file/encounter/forms.php"; ?>';
