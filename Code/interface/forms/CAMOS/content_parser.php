...
function replace($pid, $enc, $content)
{
 //replace placeholders with values
    ...
    $query1 = sqlStatement(
        ...
        "t1.DOB, " .
        "t2.date " .
        "from client_data as t1 join form_encounter as t2 on " .
        "(t1.pid = t2.pid) " .
    ...
    $ret = preg_replace(
        array("/clientname/i","/clientage/i","/clientgender/i","/doctorname/i"),
...
function client_age($birthday, $date)
{
