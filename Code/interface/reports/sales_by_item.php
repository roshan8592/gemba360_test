...
function thisLineItem($client_id, $encounter_id, $rowcat, $description, $transdate, $qty, $amount, $irnumber = '')
{
    ...
    "WHERE p.pid = ? LIMIT 1", array($client_id));
  ...
  <td class="detail">
            <?php if ($GLOBALS['sales_report_invoice'] == 0 || $GLOBALS['sales_report_invoice'] == 2) { ?>
   <a href='../client_file/pos_checkout.php?ptid=<?php echo attr_url($client_id); ?>&enc=<?php echo attr_url($encounter_id); ?>'>
