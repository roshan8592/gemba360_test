...
namespace OpenEMR\Events\ClientFinder;

use OpenEMR\Events\AbstractBoundFilterEvent;
use OpenEMR\Events\BoundFilter;

/**
 * Event object for creating custom client filters for client finder
 *
 * @package OpenEMR\Events
 * @subpackage ClientFinder
 * @author Ken Chapple <ken@mi-squared.com>
 * @copyright Copyright (c) 2019 Ken Chapple <ken@mi-squared.com>
 */
class ClientFinderFilterEvent extends AbstractBoundFilterEvent
{
    /**
     * The customWhereFilter event occurs in the dynamic_finder_ajax.php script that generates
     * results for the client finder. Subscribe to this event and set a customWhereFilter to
     * alter the results of the client finder query
     */
    const EVENT_HANDLE = 'clientFinder.customFilter';

    /**
     * @var array
     *
     * Array of columns displayed on the UI of client finder
     */
    ...
    /**
     * ClientFinderFilterEvent constructor.
