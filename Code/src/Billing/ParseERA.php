...
class ParseERA
{
    public static function parse_era_2100(&$out, $cb)
    {
        if ($out['loopid'] == '2110' || $out['loopid'] == '2100') {
            ...
            // (charged amount - paid amount - client responsibility amount).
            ...
            $adjtotal = $out['amount_charged'] - $out['amount_approved'] - $out['amount_client'];
    ...
    public static function parse_era($filename, $cb)
    {
        ...
        while (true) {
            ...
            } else if ($segid == 'NM1' && $seg[1] == 'QC' && $out['loopid'] == '2100') { // QC = Client
