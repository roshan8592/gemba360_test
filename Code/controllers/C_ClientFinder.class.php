...
class C_ClientFinder extends Controller
{
    ...
    function __construct($template_mod = "general")
    {
        ...
        //// What should this be?????
        //////////////////////////////////
        $this->assign("CURRENT_ACTION", $GLOBALS['webroot']."/controller.php?" . "practice_settings&client_finder&");
        /////////////////////////////////
    ...
    /**
    * Function that will display a client finder widget, allowing
    *   the user to input search parameters to find a client id.
    */
    function find_action($form_id, $form_name, $pid = null)
    {
        ...
        return $this->fetch($GLOBALS['template_dir'] . "client_finder/" . $this->template_mod . "_find.html");
    }

    /**
    * Function that will take a search string, parse it out and return all clients from the db matching.
    ...
    */
    function find_action_process()
    {
        ...
        $sql = "SELECT CONCAT(lname, ' ', fname, ' ', mname) as name, DOB, pubpid, pid FROM client_data";
