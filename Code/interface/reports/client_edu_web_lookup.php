<?php
/**
 * Open websearch for client education materials
 *
 * @package   OpenEMR
...
<head>
    ...
    <title><?php echo xlt('Web Search'); ?> - <?php echo xlt('Client Education Materials'); ?></title>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="page-header">
                    <h2><?php echo  xlt('Web Search'); ?> - <?php echo xlt('Client Education Materials'); ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <form method='post' action='client_edu_web_lookup.php' id='theform' class='form-horizontal' onsubmit='return top.restoreSession()'>
                    <input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />
                    <div class="form-group">
                        <label for='form_lookup_at' class='control-label col-sm-2'><?php echo xlt('Client Resource'); ?></label>
                        <div class='col-sm-10'>
