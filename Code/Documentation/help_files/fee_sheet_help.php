    ...
    <body>
        <div class="container oe-help-container">
            ...
            <div class= "row" id="select_code">
                ...
                <p><?php echo xlt("The default has two buttons that is set for 'New Client' and 'Established' client"); ?>.
                <button  class="oe-no-float oe-inline"><?php echo xlt("New Client"); ?></button>
            ...
            <div class= "row" id="selected_codes">
                ...
                <p><i class="fa fa-exclamation-circle oe-text-orange" aria-hidden="true"></i> <strong><?php echo xlt("To display the copay amount it must have been entered in the client's insurance under Edit > Demographics"); ?>.</strong>
