<?php
 ...
 /////////////////////////////////////////////////////////////////////
 // This program exports client demographics on demand and sends
...
function mydie($msg)
{
 ...
 // This mess gets all the info for the client.
 //
 $insrow = array();
foreach (array('primary','secondary') as $value) {
 ...
 // Get primary care doc info.  If none was selected in the client
...
if ($row['providerID']) {
 ...
 // insurance subscriber if there is one, otherwise the client.
 //
if (trim($row['lname1'])) {
    Add($row['lname1']);
    Add($row['fname1']);
...
<title>Export Client Demographics</title>
</head>
<body>
<center>
<p>&nbsp;</p>
