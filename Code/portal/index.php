...
if (!(isset($GLOBALS['portal_onsite_two_enable'])) || !($GLOBALS['portal_onsite_two_enable'])) {
    echo xlt('Client Portal is turned off');
    exit;
}
...
<html>
<head>
    <title><?php echo xlt('Client Portal Login'); ?></title>
    <?php
...
<div class="container text-center">
    <?php if (isset($_SESSION['password_update']) || isset($_GET['password_update'])) {
      ...
      <div id="wrapper" class="centerwrapper" style="text-align:center;">
        ...
        <form action="get_client_info.php" method="POST" onsubmit="return process_new_pass()" >
        ...
        <form  class="form-inline" id="resetPass" action="" method="" >
            <div class="row">
                <div class="col-sm-10 col-md-offset-1 text-center">
                    <fieldset>
                        <legend class='bg-primary'><h3><?php echo xlt('Client Credentials Reset') ?></h3></legend>
                        <div class="well">
                        <div class="row">
    ...
    <form  class="form-inline text-center" action="get_client_info.php" method="POST" onsubmit="return process()">
        <div class="row">
                <div class="col-sm-12 text-center">
                    <fieldset>
                        <legend class="bg-primary"><h3><?php echo xlt('Client Portal Login'); ?></h3></legend>
                        <div class="well">
                        <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group inline">
...
function callServer(action, value, value2, last, first) {
    ...
    $.ajax({
        ...
        if (action == "cleanup") {
            ...
            var message = <?php echo xlj("Your new credentials have been sent. Check your email inbox and also possibly your spam folder. Once you log into your client portal feel free to make an appointment or send us a secure message. We look forward to seeing you soon."); ?>;
