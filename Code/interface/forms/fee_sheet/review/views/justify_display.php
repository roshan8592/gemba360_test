...
<script type="text/html" id="justify-display">
    <div data-bind="visible: $data.show">
        <div class="duplicate_warning" data-bind="visible: $data.duplicates().length>0">
            <div data-bind="event:{click: toggle_warning_details}" class="problem_warning" title="<?php echo xla('Click for more details') ?>"><?php echo xlt("Warning, client has ambiguous codes in the problems list!") ?></div>
