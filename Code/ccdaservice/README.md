# About
This module/service will provide the necessary template engine to create a Client Summary CCD.
CCD's can be generated from Client Portal Two or the Carecoordination Module.
## Prepare
