...
class NQF_0041_Denominator implements CqmFilterIF
{
    ...
    public function test(CqmClient $client, $beginDate, $endDate)
    {
        ...
        if (Helper::checkEncounter(Encounter::ENC_INFLUENZA, $client, $beginDate, $periodPlus89Days) ||
            Helper::checkEncounter(Encounter::ENC_INFLUENZA, $client, $periodMinus92Days, $endDate) ) {
            return true;
        }
