 ...
 * the x12 edi 271 eligibility report for a particular client
 *
 * @uses edih_271_codes()
        ...
        foreach ($trans[$i] as $seg) {
            ...
            if (strncmp('HL'.$de, $seg, 3) === 0) {
                ...
                if ($elem03 == '20') {                     // level code
                    ...
                    $loopid = '2000D';                      // client in 277CA
                    $cls = "sbr";
                    $sbr_nm1_html .= "<tr class='" . attr($cls) . "'><td colspan=4><b>Client</b></td></tr>".PHP_EOL;
                } elseif ($elem03 == '23') {
