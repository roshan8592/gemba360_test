...
if ($GLOBALS['full_new_client_form']) {
...
<body class="body_top" onload="javascript:document.new_client.fname.focus();">

<form name='new_client' method='post' action="new_client_save.php"
 onsubmit='return validate()'>
<input type="hidden" name="csrf_token_form" value="<?php echo attr(CsrfUtils::collectCsrfToken()); ?>" />

<span class='title'><?php echo xlt('Add Client Record'); ?></span>
...
<?php } ?>
 ...
 <tr>
  <td>
   <span class='bold'><?php echo xlt('Client Number'); ?>: </span>
  </td>
  <td>
 ...
 <tr>
  <td colspan='2'>
   &nbsp;<br>
   <input type='submit' name='form_create' value='<?php echo xla('Create New Client'); ?>' />
  </td>
  <td>
  </td>
 </tr>
...
<?php
if ($form_pubpid) {
    echo "alert(" . xlj('This client ID is already in use!') . ");\n";
}
?>
</script>
