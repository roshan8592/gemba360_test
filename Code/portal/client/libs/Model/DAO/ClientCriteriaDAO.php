...
/**
 * ClientCriteria allows custom querying for the Client object.
 *
 ...
 * @version 1.0
 */
class ClientCriteriaDAO extends Criteria
{
    ...
    public $AllowClientPortal_Equals;
    public $AllowClientPortal_NotEquals;
    public $AllowClientPortal_IsLike;
    public $AllowClientPortal_IsNotLike;
    public $AllowClientPortal_BeginsWith;
    public $AllowClientPortal_EndsWith;
    public $AllowClientPortal_GreaterThan;
    public $AllowClientPortal_GreaterThanOrEqual;
    public $AllowClientPortal_LessThan;
    public $AllowClientPortal_LessThanOrEqual;
    public $AllowClientPortal_In;
    public $AllowClientPortal_IsNotEmpty;
    public $AllowClientPortal_IsEmpty;
    public $AllowClientPortal_BitwiseOr;
    public $AllowClientPortal_BitwiseAnd;
