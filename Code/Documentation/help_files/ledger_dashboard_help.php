...
<html>
    ...
    <title><?php echo xlt("Client Ledger Help");?></title>
    </head>
    <body>
        <div class="container oe-help-container">
            <div>
                <center><h2><a name='entire_doc'><?php echo xlt("Client Ledger Help");?></a></h2></center>
            </div>
            <div class= "row">
                <div class="col-sm-12">
                    <p><?php echo xlt("Is a record of all financial transactions between the client and the practice");?>.
                    
                    <p><?php echo xlt("Click on the Ledger menu item in the navigation bar to to enter the Client Ledger page");?>.
                    ...
                    <p><?php echo xlt("The Billed Date/Payor column will show the date the line item was billed and the Payor - either insurance or client");?>.
                    ...
                    <p><?php echo xlt("The Billed Date/Payor column will show the date the line item payment was received and the Payor name - either insurance or client");?>.
                    
                    <p><?php echo xlt("The Type will Insurance or Client");?>.
