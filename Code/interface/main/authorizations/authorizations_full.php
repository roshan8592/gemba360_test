...
if ($authorize) {
    while (list($ppid,$client) = each($authorize)) {
        ...
        echo "<td valign=top><span class=bold>".xlt('Billing').
             ":</span><span class=text><br>" . $client{"billing"} . "</td>\n";
        echo "<td valign=top><span class=bold>".xlt('Transactions').
             ":</span><span class=text><br>" . $client{"transaction"} . "</td>\n";
        echo "<td valign=top><span class=bold>".xlt('Client Notes').
             ":</span><span class=text><br>" . $client{"pnotes"} . "</td>\n";
        echo "<td valign=top><span class=bold>".xlt('Encounter Forms').
             ":</span><span class=text><br>" . $client{"forms"} . "</td>\n";
        echo "</tr>\n";
        $count++;
    }
}
