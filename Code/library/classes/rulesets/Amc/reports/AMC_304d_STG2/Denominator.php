...
class AMC_304d_STG2_Denominator implements AmcFilterIF
{
    ...
    {
        //MEASURE STAGE 2: Number of unique clients who have had two or more office visits with the EP in the 24 months prior to the beginning of the EHR reporting period
        ...
        if (Helper::check(ClinicalType::ENCOUNTER, Encounter::ENC_OFF_VIS, $client, $beginDate_encounter, $endDate_encounter, $twoEncounter)) {
            return true;
        }
