...
//$whereto = 'paymentpanel';
 ...
 $result = getClientData($pid);

 $msgs = getPortalClientNotes($_SESSION['portal_username']);
 $msgcnt = count($msgs);
 $newcnt = 0;
foreach ($msgs as $i) {
...
$(function () {
    ...
    $("#reports").load("./report/portal_client_report.php?pid='<?php echo attr_url($pid) ?>'", {}, function () {});
    ...
    function showProfileModal() {
        var title = <?php echo xlj('Demographics Legend Red: Charted Values. Blue: Client Edits'); ?> + ' ';
        ...
        var params = {
            buttons: [
                ...
                {text: <?php echo xlj('Send for Review'); ?>, close: false, style: 'success', id: 'doneClientButton'}
                ],
            onClosed: 'reload',
            type: 'GET',
            url: webRoot + '/portal/client/clientdata?pid=' + encodeURIComponent(cpid) + '&user=' + encodeURIComponent(cuser)
        };
...
function editAppointment(mode,deid){
    ...
    <aside class="right-side">
                ...
                <div class="col-sm-6">
                    <div class="panel panel-primary collapse" id="downloadpanel">
                        ...
                        <div id="docsdownload" class="panel-body">
                            <div>
                                <span class="text"><?php echo xlt('Download all client documents');?></span>
                                <form name='doc_form' id='doc_form' action='./get_client_documents.php' method='post'>
        ...
        <!-- /.content -->
        <!--<div class="footer-main">Onsite Client Portal Beta v3.0 Copyright &copy By sjpadgett@gmail.com, 2016 All Rights Reserved and Recorded</div>-->
    </aside><!-- /.right-side -->
    </div><!-- ./wrapper -->
</body>
</html>
