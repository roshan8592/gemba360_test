<?php
/**
 * Download documents from OpenEMR to the client portal in a zip file(get_client_documents.php)
 *
 * This program is used to download client documents in a zip file in the Client Portal.
 ...
 */
    ...
    // get all the documents of the client
...
while ($file = sqlFetchArray($fres)) {
    ...
    header('Content-Disposition: attachment; filename="client_documents.zip"');
