...
function postcalendar_admin_categories($msg = '', $e = '', $args = array())
{
    ...
    unset($in);
    $in = array(_PC_CAT_CLIENT,_PC_CAT_PROVIDER,_PC_CAT_CLINIC,_PC_CAT_THERAPY_GROUP);
    $keys = array(TYPE_ON_CLIENT,TYPE_ON_PROVIDER,TYPE_ON_CLINIC,TYPE_ON_THERAPY_GROUP);
    $cat_type = array();
    foreach ($in as $k => $v) {
