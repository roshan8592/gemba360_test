...
<td align="left" class="forms" class="forms"><?php echo xlt('Client Name'); ?>:</td>
   ...
   <input type="hidden" name="client_name" value="<?php echo attr($client_name);?>">
        </td>
        ...
        <td class="forms">
            <label class="forms-data" > <?php if (is_numeric($pid)) {
                ...
                echo text($result['pid']);
                                        ...
                                        $client_id=$result['pid'];
                                        ?>
   </label>
    <input type="hidden" name="client_number" value="<?php echo attr($client_id);?>">
        </td>
  ...
  <td colspan='3' nowrap style='font-size:8pt'>
   &nbsp;
    ...
    <tr>
        <td align="left" class="forms"><?php echo xlt('Client History'); ?>:</td>
        <td colspan="3"><textarea name="client_history" rows="2" cols="60" wrap="virtual name"><?php echo text($obj{"client_history"});?></textarea></td>
