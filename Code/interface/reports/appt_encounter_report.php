...
if ($_POST['form_refresh']) {
    ...
    "LEFT OUTER JOIN forms AS f ON f.pid = fe.pid AND f.encounter = fe.encounter AND f.formdir = 'newclient' " .
...
<tbody>
    ...
    if ($res) {
        ...
        while ($row = sqlFetchArray($res)) {
            ...
            $bres = sqlStatement($query, array($client_id, $encounter));
            //
            ...
            $copays -= BillingUtilities::getClientCopay($client_id, $encounter);
         ...
         if (!$errmsg && $gcac_related_visit) {
           ...
           ******************************************************************/
            if ($gcac_related_visit) {
                 ...
                 "deleted = 0 AND formdir = 'LBFgcac'", array($client_id, $encounter));
