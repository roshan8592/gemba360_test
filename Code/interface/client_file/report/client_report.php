...
<html>
<head>
<title><?php echo xlt("Client Reports"); ?></title>
...
$arrOeUiSettings = array(
    'heading_title' => xl('Client Reports'),
...
<body class="body_top">
    <div id="container_div" class="<?php echo $oemr_ui->oeContainer();?>">
        <div id="client_reports"> <!-- large outer DIV -->
        <div class="row">
            <div class="col-sm-12">
        ...
        <form name='report_form' id="report_form" method='post' action='custom_report.php'>
            ...
            <div class="col-sm-12">
            <p> </p>
            <span class='title oe-report-section-header'><?php echo xlt('Client Report'); ?></span>&nbsp;&nbsp;

            <!--
            <a class="link_submit" href="full_report.php" onclick="top.restoreSession()">
            [<?php echo xlt('View Comprehensive Client Report'); ?>]</a>
            -->
            ...
            <table class="includes">
                <tr>
                    ...
                    <td class='text'>
                        ...
                        -->
                        <input type='checkbox' name='include_notes' id='include_notes' value="notes"><?php echo xlt('Client Notes'); ?><br>
            ...
            <table border="0" cellpadding="0" cellspacing="0" >
                ...
                $res = sqlStatement(
                    ...
                    "LEFT JOIN forms AS f ON f.pid = po.client_id AND f.formdir = 'procedure_order' AND " .
...
$(document).ready(function(){
    ...
    $("#genfullreport").click(function() { location.href='<?php echo "$rootdir/client_file/encounter/$returnurl";?>'; });
