...
function generate_x12_837I($pid, $encounter, &$log, $ub04id)
{
    ...
    if (!$claim->payerSequence()) {
        ...
        //SBR01 is either a P or S    SBR02 for care is always 18 "client"  SBR09 is always MA
    ...
    if (! $claim->isSelfOfInsured()) {
        ...
        $out .= "PAT" .
            ...
            "~\n";
        ++$edicount;
        $out .= "NM1" .       // Loop 2010CA Client may need this elsed in to the loop 2000C
            "*QC" .
            "*1" .
    ...
    // CL1 (Admission Type Code) (Admission Source Code) (Client Status Code)
