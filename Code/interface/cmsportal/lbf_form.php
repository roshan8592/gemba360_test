<?php
/**
 * LBF form handling for the WordPress Client Portal.
 *
 * @package   OpenEMR
...
// Look up the client in OpenEMR.
$ptid = lookup_openemr_client($result['post']['user']);
?>
<html>
<head>
...
function openClient() {
 myRestoreSession();
 opener.top.RTop.document.location.href = '../client_file/summary/demographics.php?set_pid=<?php echo attr($ptid); ?>';
}
...
<p>
<input type='button' value='<?php echo xla('Open Client'); ?>' onclick="openClient()" />
&nbsp;
