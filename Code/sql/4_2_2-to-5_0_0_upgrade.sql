...
#IfMissingColumn client_data imm_reg_status
...
ALTER TABLE `client_data` ADD COLUMN `imm_reg_status` TEXT;
#EndIf

#IfMissingColumn client_data imm_reg_stat_effdate
SET @group_name = (SELECT group_name FROM layout_options WHERE form_id='DEM' AND group_name LIKE '%Choices' LIMIT 1);
SET @backup_group_name = (SELECT group_name FROM layout_options WHERE field_id='hipaa_notice' AND form_id='DEM');
SET @seq = (SELECT MAX(seq) FROM layout_options WHERE group_name = IFNULL(@group_name,@backup_group_name) AND form_id='DEM');
...
ALTER TABLE `client_data` ADD COLUMN `imm_reg_stat_effdate` TEXT;
#EndIf

#IfMissingColumn client_data publicity_code
SET @group_name = (SELECT group_name FROM layout_options WHERE form_id='DEM' AND group_name LIKE '%Choices' LIMIT 1);
SET @backup_group_name = (SELECT group_name FROM layout_options WHERE field_id='hipaa_notice' AND form_id='DEM');
SET @seq = (SELECT MAX(seq) FROM layout_options WHERE group_name = IFNULL(@group_name,@backup_group_name) AND form_id='DEM');
...
ALTER TABLE `client_data` ADD COLUMN `publicity_code` TEXT;
#EndIf

#IfMissingColumn client_data publ_code_eff_date
SET @group_name = (SELECT group_name FROM layout_options WHERE form_id='DEM' AND group_name LIKE '%Choices' LIMIT 1);
SET @backup_group_name = (SELECT group_name FROM layout_options WHERE field_id='hipaa_notice' AND form_id='DEM');
SET @seq = (SELECT MAX(seq) FROM layout_options WHERE group_name = IFNULL(@group_name,@backup_group_name) AND form_id='DEM');
...
ALTER TABLE `client_data` ADD COLUMN `publ_code_eff_date` TEXT;
#EndIf

#IfMissingColumn client_data protect_indicator
SET @group_name = (SELECT group_name FROM layout_options WHERE form_id='DEM' AND group_name LIKE '%Choices' LIMIT 1);
SET @backup_group_name = (SELECT group_name FROM layout_options WHERE field_id='hipaa_notice' AND form_id='DEM');
SET @seq = (SELECT MAX(seq) FROM layout_options WHERE group_name = IFNULL(@group_name,@backup_group_name) AND form_id='DEM');
...
ALTER TABLE `client_data` ADD COLUMN `protect_indicator` TEXT;
#EndIf

#IfMissingColumn client_data prot_indi_effdate
SET @group_name = (SELECT group_name FROM layout_options WHERE form_id='DEM' AND group_name LIKE '%Choices' LIMIT 1);
SET @backup_group_name = (SELECT group_name FROM layout_options WHERE field_id='hipaa_notice' AND form_id='DEM');
SET @seq = (SELECT MAX(seq) FROM layout_options WHERE group_name = IFNULL(@group_name,@backup_group_name) AND form_id='DEM');
...
ALTER TABLE `client_data` ADD COLUMN `prot_indi_effdate` TEXT;
#EndIf
...
#IfNotColumnType client_data guardiansname TEXT
ALTER TABLE `client_data` MODIFY `guardiansname` TEXT;
#EndIf

#IfMissingColumn client_data guardiansname
ALTER TABLE client_data ADD COLUMN `guardiansname` TEXT;
#EndIf

#IfMissingColumn client_data guardianrelationship
ALTER TABLE `client_data` ADD COLUMN `guardianrelationship` TEXT;
...
#IfMissingColumn client_data guardiansex
ALTER TABLE `client_data` ADD COLUMN `guardiansex` TEXT;
...
#IfMissingColumn client_data guardianaddress
ALTER TABLE `client_data` ADD COLUMN `guardianaddress` TEXT;
...
#IfMissingColumn client_data guardiancity
ALTER TABLE `client_data` ADD COLUMN `guardiancity` TEXT;
...
#IfMissingColumn client_data guardianstate
ALTER TABLE `client_data` ADD COLUMN `guardianstate` TEXT;
...
#IfMissingColumn client_data guardianpostalcode
ALTER TABLE `client_data` ADD COLUMN `guardianpostalcode` TEXT;
...
#IfMissingColumn client_data guardiancountry
ALTER TABLE `client_data` ADD COLUMN `guardiancountry` TEXT;
...
#IfMissingColumn client_data guardianphone
ALTER TABLE `client_data` ADD COLUMN `guardianphone` TEXT;
...
#IfMissingColumn client_data guardianworkphone
ALTER TABLE `client_data` ADD COLUMN `guardianworkphone` TEXT;
...
#IfMissingColumn client_data guardianemail
ALTER TABLE `client_data` ADD COLUMN `guardianemail` TEXT;
...
#IfNotRow clinical_rules id cpoe_med_stage1_amc_alternative
	INSERT INTO `clinical_rules`(`id`, `pid`, `active_alert_flag`, `passive_alert_flag`, `cqm_flag`, `cqm_nqf_code`, `cqm_pqri_code`, `amc_flag`, `amc_code`, `client_reminder_flag`, `amc_2011_flag`, `amc_2014_flag`, `amc_code_2014`, `cqm_2011_flag`, `cqm_2014_flag`, `amc_2014_stage1_flag`, `amc_2014_stage2_flag`) VALUES ('cpoe_med_stage1_amc_alternative', 0, 0, 0, 0, '', '', 1, '170.304(a)', 0, 0, 1, '170.314(g)(1)/(2)–7', 0, 0, 1, 0);
...
INSERT INTO `list_options` (`list_id`, `option_id`, `title`, `seq`, `notes`, `activity`) VALUES ('page_validation', 'add_edit_event#theform', '/interface/main/calendar/add_edit_event.php', 60, '{form_client:{presence: {message: "Client Name Required"}}}', 1);
#EndIf
