...
class Communication extends ClinicalType
{
    ...
    const COUNS_NUTRITION = 'comm_couns_nutrition'; // Communication to client: counseling for nutrition
    const COUNS_PHYS_ACTIVITY = 'comm_couns_phys_activity'; // Communication to client: counseling for physical activity
    ...
    public function doClientCheck(RsClient $client, $beginDate = null, $endDate = null, $options = null)
    {
        // TODO Read from referrals to check for ditary consult?
        // TODO How to check for client communication?
        // for now, check for any encounter
        $encounters = getEncounters($client->id, $beginDate, $endDate);
