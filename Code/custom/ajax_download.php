...
$criteriaClients = getCombineClients($dataSheet, $reportID);
$clients = $criteriaClients[$ruleID];
...
if (count($clients)) {
    ...
    foreach ($clients as $client) {
        ...
        $fileName = mainQrdaCatOneGenerate($xml, $client, $ruleID, $provider_id);
        $files[] = $fileName;
    }
    ...
    echo xlt("FAILURE: No clients for measure") . " " . text($ruleID);
}
