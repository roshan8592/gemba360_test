...
$COMPARE_FUNCTION_HASH = array(
    ...
    'client' => 'compareAppointmentsByClientName',
    'pubpid' => 'compareAppointmentsByClientId',
...
$ORDERHASH = array(
    ...
    'client' => array( 'client', 'date', 'time' ),
    'pubpid' => array( 'pubpid', 'date', 'time' ),
    'date' => array( 'date', 'time', 'type', 'client' ),
    'time' => array( 'time', 'date', 'client' ),
    'type' => array( 'type', 'date', 'time', 'client' ),
    'comment' => array( 'comment', 'date', 'time', 'client' ),
    'status' => array( 'status', 'date', 'time', 'client' ),
    'completed' => array( 'completed', 'date', 'time', 'client' ),
    'trackerstatus' => array( 'trackerstatus', 'date', 'time', 'client' ),
);
...
function fetchEvents($from_date, $to_date, $where_param = null, $orderby_param = null, $tracker_board = false, $nextX = 0, $bind_param = null, $query_param = null)
{
    ...
    if ($query_param) {
        ...
        if ($tracker_board) {
            ...
            $tracker_joins = "LEFT OUTER JOIN client_tracker AS t ON t.pid = e.pc_pid AND t.apptdate = e.pc_eventDate AND t.appttime = e.pc_starttime AND t.eid = e.pc_eid " .
            "LEFT OUTER JOIN client_tracker_element AS q ON q.pt_tracker_id = t.id AND q.seq = t.lastseq " .
        ...
        "LEFT OUTER JOIN client_data AS p ON p.pid = e.pc_pid " .
...
function fetchAppointments($from_date, $to_date, $client_id = null, $provider_id = null, $facility_id = null, $pc_appstatus = null, $with_out_provider = null, $with_out_facility = null, $pc_catid = null, $tracker_board = false, $nextX = 0, $group_id = null, $client_name = null)
{
    $sqlBindArray = array();
    ...
    if ($client_name != null) {
        ...
        array_push($sqlBindArray, $client_name, $client_name);
    }
...
//Support for therapy group appointments added by shachar z.
function fetchNextXAppts($from_date, $client_id, $nextX = 1, $group_id = null)
{

    $appts = array();
    $nextXAppts = array();
    $appts = fetchAppointments($from_date, null, $client_id, null, null, null, null, null, null, false, $nextX, $group_id);
    if ($appts) {
...
function compareAppointmentsByClientName($appointment1, $appointment2)
{
...
function compareAppointmentsByClientId($appointment1, $appointment2)
{
