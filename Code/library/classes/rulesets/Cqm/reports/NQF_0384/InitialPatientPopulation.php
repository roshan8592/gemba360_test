...
/**
 *
 * CQM NQF 0384 Initial Client Population
 *
...
class NQF_0384_InitialClientPopulation implements CqmFilterIF
{
    ...
    public function test(CqmClient $client, $beginDate, $endDate)
    {
        ...
        $check_cancer = sqlQuery($cancerCheckQry, array($client->id, $beginDate, $endDate));
        if ($check_cancer['cnt'] > 0) {
            ...
            $check_radiotheraphy = sqlQuery($radiotheraphyQry, array( $beginDate, $endDate, $client->id));
