...
function thisLineItem($row, $codetype, $code)
{
    ...
    if ($_POST['form_csvexport']) {
        ...
        ?>
   <tr>
    <td class="detail"><?php echo text($row['client_name'  ]); ?></td>
...
<table border='0' cellpadding='1' cellspacing='2' width='98%'>
 <tr bgcolor="#dddddd">
  <td class="dehead"><?php echo xlt('Client') ?></td>
...
if ($_POST['form_refresh'] || $_POST['form_csvexport']) {
    ...
    $query = "SELECT po.client_id, po.encounter_id, po.date_ordered, " .
    "pd.pubpid, " .
    "CONCAT(pd.lname, ', ', pd.fname, ' ', pd.mname) AS client_name, " .
    ...
    "JOIN client_data AS pd ON pd.pid = po.client_id " .
    ...
    $query .= " ORDER BY pd.lname, pd.fname, pd.mname, po.client_id, " .
    ...
    while ($row = sqlFetchArray($res)) {
        ...
        foreach ($relcodes as $codestring) {
            ...
            "fe.date >= ?", array($client_id, $codetype, $code, $date_ordered.' 00:00:00'));
