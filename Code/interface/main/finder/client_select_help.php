...
<p>
If you want to change the number used to calculate a date a particular number of days from the last encounter, place the number in the search box before the search string.  For example, if you want to search for clients with the last name containing 'Smith' and calculate in the last column the date 21 days from their last visit, type 21Smith in the search box.
</p>
