    ...
    public function test(CqmClient $client, $beginDate, $endDate)
    {
        ...
        foreach ($this->getApplicableEncounters() as $encType) {
            ...
            foreach ($dates as $date) {
                ...
                // this is basically a check to see if the client's tobacco status has been evaluated in the two years previous to encounter.
                if (Helper::check(ClinicalType::CHARACTERISTIC, Characteristic::TOBACCO_USER, $client, $beginMinus24Months, $date) ||
                    Helper::check(ClinicalType::CHARACTERISTIC, Characteristic::TOBACCO_NON_USER, $client, $beginMinus24Months, $date) ) {
                    return true;
                }
            }
        }
