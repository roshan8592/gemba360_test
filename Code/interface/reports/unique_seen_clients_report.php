...
<span class='title'><?php echo xlt('Report'); ?> - <?php echo xlt('Unique Seen Clients'); ?></span>

<div id="report_parameters_daterange">
    <?php echo text(oeFormatShortDate($form_from_date)) ." &nbsp; " . xlt("to") . " &nbsp; ". text(oeFormatShortDate($form_to_date)); ?>
</div>

<form name='theform' method='post' action='unique_seen_clients_report.php' id='theform' onsubmit='return top.restoreSession()'>
