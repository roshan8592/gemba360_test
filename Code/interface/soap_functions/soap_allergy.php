...
/**
 * interface/soap_functions/soap_allergy.php Check current clients Allergy TTL
...
if ((array_key_exists('refresh', $_REQUEST)
    ...
    || $eRxSOAP->checkClientImportStatus(eRxSOAP::FLAG_ALLERGY_PRESS)
) {
    ...
    $eRxSOAP->updateClientImportStatus(eRxSOAP::FLAG_ALLERGY_IMPORT)
