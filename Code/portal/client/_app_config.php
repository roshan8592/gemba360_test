...
GlobalConfig::$ROUTE_MAP = array (
        ...
        'GET:clientdata' => array (
                'route' => 'Client.ListView'
        ),
        'GET:client/(:num)' => array (
                'route' => 'Client.SingleView',
                'params' => array (
                        'id' => 1
                )
        ),
        'GET:api/clientdata' => array (
                'route' => 'Client.Query'
        ),
        'POST:api/client' => array (
                'route' => 'Client.Create'
        ),
        'GET:api/client/(:num)' => array (
                'route' => 'Client.Read',
                'params' => array (
                        'id' => 2
                )
        ),
        'PUT:api/client/(:num)' => array (
                'route' => 'Client.Update',
                'params' => array (
                        'id' => 2
                )
        ),
        'DELETE:api/client/(:num)' => array (
                'route' => 'Client.Delete',
                'params' => array (
                        'id' => 2
                )
        ),
        'PUT:api/portalclient/(:num)' => array (
                'route' => 'PortalClient.Update',
                'params' => array (
                        'id' => 2
                )
        ),
        'GET:api/portalclient/(:num)' => array (
                'route' => 'PortalClient.Read',
                'params' => array (
                        'id' => 2
                )
        ),
