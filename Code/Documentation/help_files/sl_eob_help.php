    ...
    <body>
        <div class="container oe-help-container" id="home-div">
            ...
            <div class= "row" id="invoice-search-div">
                ...
                <p><?php echo xlt("The section labeled 'Invoice Search' is where you put in your search parameters. You can search by client name, chart number, encounter number or date of service, or any combination of these. You may also select whether you want to see all invoices, open invoices, or only invoices that are due (by the client). Click the 'Search' button to perform the search.")?>
                ...
                <br>
                <p><?php echo xlt("Upon a successful search you are presented with a list of invoices. You may click on one of the invoice numbers to open a second window, which is the data entry page for manual posting. You may also click on a client name if you want to enter a note that the front office staff will see when the client checks in, and you may select invoices to appear on client statements and print those statements.");?>
                ...
                <p><?php echo xlt("Pay attention to the 'Done with' checkboxes. After the insurances are marked complete then we will start asking the client to pay the remaining balance; if you fail to mark all of the insurances complete then the remaining amount will not be collected! Also if there is a balance that the client should pay, then set the due date appropriately, as this will affect the language that appears on client statements.");?>
