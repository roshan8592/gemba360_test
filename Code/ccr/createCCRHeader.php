...
global $pid;
           ...
           $e_client = $ccr->createElement('Client');
           $e_ccr->appendChild($e_client);

           //$e_ActorID = $ccr->createElement('ActorID', $row['client_id']);
           $e_ActorID = $ccr->createElement('ActorID', 'A1234'); // This value and ActorID in createCCRActor.php should be same.
           $e_client->appendChild($e_ActorID);
           ...
           $e_Text = $ccr->createElement('Text', 'client');
           $e_ActorRole->appendChild($e_Text);
           ...
           $e_Text = $ccr->createElement('Text', 'Summary of client information');
