...
function lab_results_messages($set_pid, $rid, $provider_id = "")
{
    ...
    if (!empty($result)) {
        foreach ($result as $user_detail) {
            ...
            // $thisauth = acl_check('clients', 'sign', $user_detail['username']);
