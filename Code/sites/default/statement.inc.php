<?php
/* This is a template for printing client statements and collection
...
{
    $titleres = getClientData($stmt['pid'], "fname,lname,DOB");
    //Author Daniel Pflieger - daniel@growlingflea.com
    ...
    <table style="width:100%;">
        <tr>
            ...
            if (empty(!$GLOBALS['statement_logo'])) {
                ...
                //if it does we put the client name and the service facility on a separate line.
                //Clients with long names cause formatting issues and it makes the statement look
...
// Billing location modified by Daniel Pflieger at Growlingflea Software
    ...
    // $stmt['level_closed'] <= 3 insurance 4 = client
    ...
    if ($GLOBALS['statement_message_to_client']) {
        $out .= "\n";
 ...
 ';
  ...
  <br /><br />"; // this is a form feed
    ...
    //[Your Clinic Name]             Client Name          2009-12-29
    //[Your Clinic Address]          Chart Number: 1848
    //[City, State Zip]              Insurance information on file
    //
    //
    //ADDRESSEE                      REMIT TO
    //Client Name                     [Your Clinic Name]
    //client address                  [Your Clinic Address]
    ...
    //
    //
    //Name: Client Name              Date: 2009-12-29     Due:   147.40
...
function create_statement($stmt)
{
    ...
    $out .= sprintf("%-30s %s %-s\n", $clinic_name, $stmt['client'], $stmt['today']);
...
// Billing location
 ...
 ';
    ...
    $out .= $label_sign .'  {ClientSignature}<br />';
    $out .="      </td><td style=width:2.0in;vertical-align:middle;'>";
    $practice_cards = $GLOBALS['OE_SITE_DIR']. "/images/visa_mc_disc_credit_card_logos_176x35.gif";
    if (file_exists($GLOBALS['OE_SITE_DIR']."/images/visa_mc_disc_credit_card_logos_176x35.gif")) {
