...
class C_FormVitals extends Controller
{
    ...
    function default_action()
    {
        ...
        // get the client's current age
        $client_data = getClientData($GLOBALS['pid']);
        $client_dob=$client_data['DOB'];
        $client_age = getClientAge($client_dob);
        $this->assign("client_age", $client_age);
        $this->assign("client_dob", $client_dob);
