...
function writeITLine($it_array)
{
    ...
    echo ctGenCBox($opt_line_no, $it_array, 'force_show', xl('Show this category on the client summary screen even if no issues have been entered for this category.'));
...
<head>
    ...
    <script type="text/javascript">
        ...
        function select_code(lino) {
            ...
            current_lino = lino;
            dlgopen('../client_file/encounter/find_code_dynamic.php', '_blank', 900, 600);
            return false;
        }
        ...
        function sel_cvxcode(e) {
            ...
            dlgopen('../client_file/encounter/find_code_dynamic.php?codetype=CVX', '_blank', 900, 600);
        }
        ...
        function select_clin_term_code(e) {
            ...
            dlgopen('../client_file/encounter/find_code_dynamic.php?codetype=' + <?php echo js_url(collect_codetypes("clinical_term", "csv")); ?>, '_blank', 900, 600);
        }
