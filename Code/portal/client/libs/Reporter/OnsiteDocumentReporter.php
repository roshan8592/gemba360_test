...
class OnsiteDocumentReporter extends Reporter
{
    ...
    public $CreateDate;
    public $DocType;
    public $ClientSignedStatus;
    public $ClientSignedTime;
    ...
    */
    static function GetCustomQuery($criteria)
    {
        $sql = "select
			...
			,`onsite_documents`.`client_signed_status` as ClientSignedStatus
			,`onsite_documents`.`client_signed_time` as ClientSignedTime
			...
			,`onsite_documents`.`client_signature` as ClientSignature
