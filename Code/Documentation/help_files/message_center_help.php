    ...
    <body>
        <div class="container oe-help-container">
            ...
            <div class= "row">
                ...
                <p><?php echo xlt("It lets you send messages and dated reminders to staff members, add client to the recall list and send SMS text messages to clients");?>.
            ...
            <div class= "row" id="messages">
                ...
                <p><?php echo xlt("Lets you send messages to staff members about client related matters");?>.
                ...
                <p><i class="fa fa-exclamation-circle oe-text-orange"  aria-hidden="true"></i> <strong><?php echo xlt("For those with administrative privileges an icon is displayed next to the My Messages caption") ?>.</strong>
                ...
                <p><?php echo xlt("Select a client by clicking on the client input box"); ?>.

                <p><?php echo xlt("It will bring up the Multi client finder  popup"); ?>.&nbsp;
                <i class="fa fa-exclamation-circle oe-text-orange"  aria-hidden="true"></i> <strong><?php echo xlt("New to openEMR 5.0.2"); ?></strong>

                <p><?php echo xlt("Clicking on either the Enter Name or Enter ID tab will bring up the search box which you can use to select a client"); ?>.
                ...
                <p><?php echo xlt("You can add multiple clients to the list"); ?>.

                <p><?php echo xlt("Click OK to import these clients into the client input box"); ?>.

                <p><?php echo xlt("Click the Clear button to clear the imported client names and start afresh"); ?>.
                ...
                <p><?php echo xlt("A new message can thus be sent to a single or multiple users and/or can be about a single or multiple clients"); ?>.
                ...
                <p><?php echo xlt("Clicking on the client's name will reveal the message"); ?>.
            ...
            <div class= "row" id="reminders">
                ...
                <p><?php echo xlt("It can be either linked to a client or just be a message addressed to another user(s)"); ?>.
                ...
                <p><?php echo xlt("The first section lets you either link this message to a client if so desired."); ?>.
                ...
                <p><i class="fa fa-exclamation-triangle oe-text-red" aria-hidden="true"></i> <strong><?php echo xlt("You need administrator privileges to increase the number of reminders to show"); ?>.</strong>
            ...
            <div class= "row" id="recalls">
                ...
                <p><?php echo xlt("This feature is used to add clients to a recall list, i.e those that need an appointment at a future date but the appointment has not yet been scheduled"); ?>.
                ...
                <p><?php echo xlt("Click on the Name text box on the left section to bring up the client finder pop-up"); ?>.

                <p><?php echo xlt("Search and select a client and click OK"); ?>.

                <p><?php echo xlt("If the client has any demographic data entered in openEMR it will automatically populate the relevant fields on the right sections"); ?>.

                <p><?php echo xlt("Fill in any missing details or edit existing information. This will be saved in the client's demographics page in openEMR"); ?>.

                <p><?php echo xlt("The last visit date will automatically be filled"); ?>.

                <p><?php echo xlt("If the client is being added to the recall list on the day of the visit it would reflect the current date"); ?>.

                <p><?php echo xlt("If the client is calling back to be added to the list the last visit may be in the remote past. Be aware that the 1,2,3 plus years are calculated and displayed on the Date box at the bottom of this section"); ?>.
                ...
                <p><?php echo xlt("This fully functional Recall Board included in the default install can be used to add clients to the recall list"); ?>.
                ...
                <p><?php echo xlt("The Name cell contains the name, date of birth, client ID and date of last visit"); ?>.

                <p><?php echo xlt("You can click on the client name to quickly access the client's chart"); ?>.
                ...
                <p><?php echo xlt("Checking the Postcards check box will let you print a postcard that can be mailed to a client"); ?>.

                <p><?php echo xlt("Labels can be printed either for one client or for all the selected clients"); ?>.

                <p><?php echo xlt("The Office: Phone cell lets you indicate a phone call was made"); ?>.

                <p><i class="fa fa-exclamation-circle oe-text-orange" aria-hidden="true"></i> <strong>
            ...
            <div class= "row" id="medex_communication_service">
                ...
                <p><?php echo xlt("Replies from clients are displayed directly in your EHR"); ?>.
                ...
                <p><?php echo xlt("It is also a subscription based service"); ?>.
            </div>
