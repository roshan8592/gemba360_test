...
<html>
<head>
    <title><?php echo xlt('Client Transactions');?></title>
...
<script type="text/javascript">
    ...
    function imdeleted() {
        top.restoreSession();
        location.href = '../../client_file/transaction/transactions.php';
    }
...
$arrOeUiSettings = array(
    'heading_title' => xl('Client Transactions'),
        ...
        <div class="row">
            <div class="col-sm-12 text">
                ...
                if ($result = getTransByPid($pid)) {
                    ...
                    ?>
                <span class="text"><i class="fa fa-exclamation-circle oe-text-orange"  aria-hidden="true"></i> <?php echo xlt('There are no transactions on file for this client.'); ?></span>
                    <?php
                }
                ?>
            </div>
