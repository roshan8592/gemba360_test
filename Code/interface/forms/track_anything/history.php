...
//---------------------------------------------
if ($fromencounter == 1) {
    echo "<td>&nbsp;&nbsp;&nbsp;<a class='css_button' href='".$GLOBALS['webroot'] . "/interface/client_file/encounter/$returnurl' onclick='top.restoreSession()'><span>".xlt('Back to encounter')."</span></a></td>";
}

if ($fromencounter == 0) {
    echo "<td>&nbsp;&nbsp;&nbsp;<a href='../../client_file/summary/demographics.php' ";
    echo " class='css_button' onclick='top.restoreSession()'>";
    echo "<span>" . xlt('Back to Client') . "</span></a></td>";
}
...
while ($myrow = sqlFetchArray($query)) {
    ...
    echo "<a href='../../client_file/encounter/encounter_top.php?set_encounter=" . attr_url($the_encounter) . "' target='RBot'>" . xlt('encounter') . " #" . text($the_encounter) . "</a>]";
    echo "</small>";
    echo "<table border='1'>";
