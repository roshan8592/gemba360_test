/**
 * backbone model definitions for Client Portal
 *
...
model.OnsiteDocumentModel = Backbone.Model.extend({
	...
	defaults: {
		...
		'createDate':new Date(),
		'docType': '',
		'clientSignedStatus': '0',
		'clientSignedTime': '0000-00-00',
...
/**
 * Client Backbone Model
 */
model.ClientModel = Backbone.Model.extend({
	urlRoot: 'api/client',
	idAttribute: 'id',
	id: '',
	title: '',
...
/**
 * Client Backbone Collection
 */
model.ClientCollection = model.AbstractCollection.extend({
	url: 'api/clientdata',
	model: model.ClientModel
});
/**
 * Portal Client Edit Backbone Model
 */
model.PortalClientModel = Backbone.Model.extend({
	urlRoot: 'api/portalclient',
	idAttribute: 'id',
	id: '',
	title: '',
	language: '',
...
/**
 * Portal Client Backbone Collection
 */
model.PortalClientCollection = model.AbstractCollection.extend({
	url: 'api/portalclientdata',
	model: model.PortalClientModel
});/**/
