...
function sel_related(varname) {
    ...
    rcvarname = varname;
    let url = '../client_file/encounter/find_code_dynamic.php';
    if (varname == 'form_diagnosis_code')
        url = '../client_file/encounter/find_code_dynamic.php?codetype=' + <?php echo js_url(collect_codetypes("diagnosis", "csv")); ?>;
