...
$clientPharmacy = $tData->clientPharmacyInfo($pid);
...
<div id="fields">
    ...
    <?php echo xlt("Client Default"); ?> <br>
    <input type = 'radio' name = "pharmacy" id = 'clientPharmacy' value="<?php print attr($clientPharmacy['pharmacy_id']) ?>" checked="checked">
    <?php
    if (!$clientPharmacy['name']) {
        print "<b>".xlt("Please set pharmacy in client\'s chart!")."</b><br> <br>";
    } else {
        print text($clientPharmacy['name']);
    }
    ?><br> <br>
