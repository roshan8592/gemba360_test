 ...
 * pid - client id to be used for all selected documents
 ...
 *
 * 2. To import collection of medical record files for a specific client:
 *    a. Save files in Scanner Directory
 *    b. For client nnn and category 'Client Records', access this script online with request parameters as:
 *       zutil.cli.doc_import?site=default&pid=nnn&category=Client+Records&limit=1000
 *
