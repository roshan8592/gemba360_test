...
<div class='well'>
    <div class="row">
        <div class="col-sm-3 col-md-3">
            <h4>
                <i class="icon-cogs"></i><?php echo xlt('Client Document Templates') ?>
            </h4>
        ...
        <div class="col-sm-3 col-md-3">
            ...
            <a class="btn btn-success btn-sm" href="<?php echo $GLOBALS['web_root'];?>/portal/client/onsiteactivityviews"><?php echo xlt('Review Audits') ?> »</a>
        </div>
        <div class="col-sm-3 col-md-3">
            <h4>
                <i class="icon-cogs"></i><?php echo xlt('Client Mail') ?>
            </h4>
            <a class="btn btn-success btn-sm" href="<?php echo $GLOBALS['web_root'];?>/portal/messaging/messages.php"><?php echo xlt('Mail') ?> »</a>
        </div>
        <div class="col-sm-3 col-md-3">
            <h4>
                <i class="icon-cogs"></i><?php echo xlt('Client Chat') ?>
            </h4>
        ...
        <div class="col-sm-3 col-md-3">
            ...
            <p>
            <a type="admin-signature" class="btn btn-primary btn-sm" href="#openSignModal" data-toggle="modal" data-backdrop="true" data-target="#openSignModal">
