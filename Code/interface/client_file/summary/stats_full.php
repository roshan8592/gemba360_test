...
// Get client's preferred language for the client education URL.
$tmp = getClientData($pid, 'language');
...
<title><?php echo xlt('Client Issues'); ?></title>
...
// Process click on diagnosis for client education popup.
...
function newEncounter() {
 ...
 top.restoreSession();
 location.href='../../forms/newclient/new.php?autoloaded=1&calenc=';
}
</script>
<script>
<?php
require_once("$include_root/client_file/erx_client_portal_js.php"); // jQuery for popups for eRx and client portal
?>
</script>
<?php
$arrOeUiSettings = array(
    ...
    'expandable' => true,
    'expandable_files' => array("stats_full_client_xpd", "external_data_client_xpd", "client_ledger_client_xpd"),//all file names need suffix _xpd
...
<body class="body_top client-medical-issues">
